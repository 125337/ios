...
+ (instancetype)shared {
    static WeChatRedEnvelopTaskManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[WeChatRedEnvelopTaskManager alloc] init];
    });
    return instance;
}
...
- (WeChatRedEnvelopParam *)popPendingParamBySendId:(NSString *)sendId {
    @synchronized (self.pendingParams) {
        WeChatRedEnvelopParam *p = self.pendingParams[sendId ?: @""];
...
- (WeChatRedEnvelopParam *)findPendingParamBySign:(NSString *)sign {
    ...
    @synchronized (self.pendingParams) {
        for (NSString *key in self.pendingParams) {
            WeChatRedEnvelopParam *p = self.pendingParams[key];
