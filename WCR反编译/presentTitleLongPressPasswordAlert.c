// presentTitleLongPressPasswordAlert @ 0111423c

/* Function Stack Size: 0x10 bytes */

void WCRefinePrivateFriendManager::presentTitleLongPressPasswordAlert(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (cfstringStruct *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar1,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,local_18,
               PTR_s_cancelTitleLongPressAuth_026aef90);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleTitleLongPressPassword__026aef98);
