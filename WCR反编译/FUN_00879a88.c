// FUN_00879a88 @ 00879a88

void FUN_00879a88(undefined8 param_1)

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    uVar5 = local_18;
    _objc_getAssociatedObject(local_18,&DAT_028cd88c);
    ...
    if ((uVar6 & 1) == 0) {
      ...
      if (uVar6 == 0) {
        ...
        _objc_retainAutoreleasedReturnValue();
        _objc_setAssociatedObject(uVar5,&DAT_028cd88c,puVar7,1);
        ...
        iVar1 = local_28;
        _objc_setAssociatedObject(local_18,&DAT_028cd88c,0,1);
        if ((local_31 & 1) != 0) {
          _objc_exception_rethrow();
                    /* WARNING: Does not return */
          pcVar2 = (code *)SoftwareBreakpoint(1,0x879e70);
          (*pcVar2)();
        }
        if (iVar1 == 0) {
          local_28 = 0;
          ...
          if (iVar8 == 0) {
                    /* WARNING: Does not return */
            pcVar2 = (code *)SoftwareBreakpoint(1,0x879f44);
            (*pcVar2)();
          }
        }
      }
