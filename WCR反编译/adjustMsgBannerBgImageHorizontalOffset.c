// adjustMsgBannerBgImageHorizontalOffset @ 01b9c728

/* Function Stack Size: 0x10 bytes */

void WCRefineMessageBannerBeautifyViewController::adjustMsgBannerBgImageHorizontalOffset
...

{
  ...
  if (bVar1) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgBannerBgImageOffsetXLight_026a07c8);
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgBannerBgImageOffsetXDark_026a07c0);
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMsgBannerBgImageHorizontal_026c0138);
