// adjustMsgBannerStaySeconds @ 01b92e30

/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefineMessageBannerBeautifyViewController::adjustMsgBannerStaySeconds
...

{
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)();
    local_38 = pcVar1;
    (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_showTextFieldWithMaxLen__0269e5e0,0xc);
    pcVar1 = local_38;
    if (local_30 <= 0.0) {
      local_68 = &::cf___;
    }
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMsgBannerStaySecondsInput__026bfff8);
