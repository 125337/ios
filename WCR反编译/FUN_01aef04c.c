// FUN_01aef04c @ 01aef04c

void FUN_01aef04c(double param_1,undefined8 param_2,double param_3,double param_4,undefined8 param_5
...
LAB_01aef34c:
    ...
    pcVar4 = local_a0;
    (*(code *)PTR__objc_msgSend_02578628)();
    if (pcVar4 == (cfstringStruct *)0x0) goto LAB_01aef34c;
    local_b0 = local_90;
    (*(code *)PTR__objc_msgSend_02578628)(local_90,PTR_s_objectAtIndexedSubscript__0269cc78,0);
    _objc_retainAutoreleasedReturnValue();
    bVar1 = true;
