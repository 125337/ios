// editCustomBullet @ 01ec6778

/* Function Stack Size: 0x10 bytes */

void WCRefineToDoListSettingsViewController::editCustomBullet(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    puVar3 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_toDoCardBulletCustomPending_026c71c0);
    _objc_retainAutoreleasedReturnValue();
    puVar4 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_toDoCardBulletCustomDone_026c71b8);
    _objc_retainAutoreleasedReturnValue();
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_confirmCustomBullet__026c7ad0);
