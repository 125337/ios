// validPathsFromArray: @ 019ec13c

/* Function Stack Size: 0x18 bytes */

ID WCRefineFontConvertViewController::validPathsFromArray_(ID param_1,SEL param_2,ID param_3)
        ...
        do {
          ...
          if ((uVar6 & 1) != 0) {
            ...
            if ((uVar4 != 0) &&
               (puVar2 = local_e0,
               (*(code *)PTR__objc_msgSend_02578628)
                         (local_e0,PTR_s_fileExistsAtPath__026ca630,local_130),
               ((ulong)puVar2 & 1) != 0)) {
