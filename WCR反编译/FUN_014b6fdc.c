// FUN_014b6fdc @ 014b6fdc

/* WARNING: Restarted to delay deadcode elimination for space: ram */

void FUN_014b6fdc(void)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(DAT_028e3660,PTR_s_setLocale__0269d1c0);
  (*(code *)PTR__objc_release_02578630)(puVar2);
  puVar2 = PTR__OBJC_CLASS___NSTimeZone_026ce360;
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR__OBJC_CLASS___NSTimeZone_026ce360,PTR_s_localTimeZone_0269f9d0);
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(DAT_028e3660,PTR_s_setTimeZone__0269f9d8);
  (*(code *)PTR__objc_release_02578630)(puVar2);
  (*(code *)PTR__objc_msgSend_02578628)
            (DAT_028e3660,PTR_s_setDateFormat__0269d1c8,&cf_yyyy_MM_ddHH_mm);
  return;
}
