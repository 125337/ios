// setNavigationHomeOnlineTextHorizontalOffset: @ 02071414

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setNavigationHomeOnlineTextHorizontalOffset_
...

{
  ...
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = &cf_tqqOnlineTextHorizontalOffset;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
