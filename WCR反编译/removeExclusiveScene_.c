// removeExclusiveScene: @ 01c4b220

/* Function Stack Size: 0x18 bytes */

void WCRefineNameplateSpecialUserDetailViewController::removeExclusiveScene_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_48,PTR_s_removeObject__0269d678,local_40);
  puVar2 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_draft_026b65e8);
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)();
