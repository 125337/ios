// adjustProfileStroke @ 01cdbd8c

/* Function Stack Size: 0x10 bytes */

void WCRefineProfileCardBeautifyViewController::adjustProfileStroke(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleProfileStrokeInput__026c38a0);
