// addDogModeWxids @ 01749c8c

/* Function Stack Size: 0x10 bytes */

void ThemeBoxAutoRedeemViewController::addDogModeWxids(ID param_1,SEL param_2)

{
  ...
  local_28 = pcVar1;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_themeBoxDogModeWxids_026a84f0);
  _objc_retainAutoreleasedReturnValue();
  local_a0 = pcVar1;
  ...
  if (pcVar2 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(pcVar2,PTR_s_setTextFieldDefaultText__0269fd98,local_b8);
    _objc_initWeak(auStack_50,local_18);
    local_80 = PTR___NSConcreteStackBlock_02578660;
    local_78 = 0xc2000000;
    local_74 = 0;
    local_70 = FUN_0174a038;
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_48,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx,local_18,
               PTR_s_alertConfirmDogModeWxids_026b4148);
