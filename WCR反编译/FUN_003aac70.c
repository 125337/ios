// FUN_003aac70 @ 003aac70

void FUN_003aac70(long param_1)

{
  ...
  FUN_003aa040();
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_setInlineDetailTemplate__026a2dd8);
  (*(code *)PTR__objc_release_02578630)(uVar2);
  puVar1 = PTR_WCRefineGroupManager_026ce2b8;
  (*(code *)PTR__objc_msgSend_02578628)(PTR_WCRefineGroupManager_026ce2b8,PTR_s_shared_0269cad0);
  _objc_retainAutoreleasedReturnValue();
  ...
  local_40 = param_1;
  if (param_1 != 0) {
    FUN_00368c14(param_1,&cf_updateInlineGroupDetail);
  }
