// adjustOffsetX @ 01881834

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAttachmentBeautifyViewController::adjustOffsetX(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgOffsetXLight_0269f5a8);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgOffsetXDark_0269f5a0);
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_stringWithFormat__0269cca8,&cf___0f___0f);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleOffsetXInput__026b6f88);
