// configurePKCOldSettings @ 01d81bb8

/* Function Stack Size: 0x10 bytes */

void WCRefineSearchSettingsViewController::configurePKCOldSettings(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_showFloatingCaptureButton_prompt_026c4c08,&cf_pkcOldSettingsVC,&cf_P);
LAB_01d81e18:
