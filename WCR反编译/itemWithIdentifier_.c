// itemWithIdentifier: @ 018854ec

/* Function Stack Size: 0x18 bytes */

ID WCRefineChatAttachmentViewController::itemWithIdentifier_(ID param_1,SEL param_2,ID param_3)
  ...
  if (local_138 != 0) {
    ...
    do {
      do {
        ...
        local_d0 = uVar5;
        (*(code *)PTR__objc_msgSend_02578628)
                  (uVar5,PTR_s_objectForKeyedSubscript__0269d098,_WCRChatAttachmentIDKey);
        _objc_retainAutoreleasedReturnValue();
        uVar3 = uVar5;
        (*(code *)PTR__objc_msgSend_02578628)();
