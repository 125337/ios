// FUN_007f424c @ 007f424c

void FUN_007f424c(byte param_1)

{
  ...
  if ((local_11 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_removeObjectForKey__0269d700,&cf_WCRefineToDoUnreadFocusAdjust);
  }
  else {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setObject_forKeyedSubscript__0269d248,puVar1,
               &cf_WCRefineToDoUnreadFocusAdjust);
    (*(code *)PTR__objc_release_02578630)(puVar1);
  }
