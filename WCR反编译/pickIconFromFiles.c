// pickIconFromFiles @ 01e151d8

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x10 bytes */

void WCRefineSuperFloatButtonConfigViewController::pickIconFromFiles(ID param_1,SEL param_2)
  ...
  if (pcVar1 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___UIAlertController_026ce178,
               PTR_s_alertControllerWithTitle_message_0269dc00,&cf_NeNb,0);
