// setNavigationHomeOnlineNicknameVerticalOffset: @ 02072504

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setNavigationHomeOnlineNicknameVerticalOffset_
...

{
  ...
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = &cf_nicknameVerticalOffset;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
