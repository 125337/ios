// menuFillColorHexDark @ 0160f268

/* Function Stack Size: 0x10 bytes */

ID WCRSuperFloatProfileStore::menuFillColorHexDark(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_currentValueForKey__026b1898,&cf_menuFillColorHexDark);
  ...
  if (((param_1 & 1) == 0) ||
    ...
    IVar3 = local_20;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_menuFillColorHex_026b18d8);
    _objc_retainAutoreleasedReturnValue();
    pcVar2 = local_30;
    local_38 = IVar3;
