// FUN_0071a640 @ 0071a640

void FUN_0071a640(long param_1)
  ...
  if (lVar3 == 0) {
    ...
    *(long *)(lVar3 + 0x18) = *(long *)(lVar3 + 0x18) + 1;
    ...
    if (lVar3 == 0) {
      ...
      local_50 = 0;
      lVar3 = local_30;
      FUN_00719b28(local_30,&local_50);
    ...
    if ((local_8c & 1) == 0) {
      if (599 < *(long *)(*(long *)(*(long *)(param_1 + 0x28) + 8) + 0x18)) {
        (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
        FUN_00719874(local_30,0,&cf_N_e);
      }
      local_40 = 0;
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
      FUN_007188ec(local_30,0,*(undefined8 *)(param_1 + 0x20),
