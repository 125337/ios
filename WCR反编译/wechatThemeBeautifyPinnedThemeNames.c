// wechatThemeBeautifyPinnedThemeNames @ 0209a430

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::wechatThemeBeautifyPinnedThemeNames(ID param_1,SEL param_2)
        ...
        do {
          ...
          if ((uVar5 & 1) != 0) {
            ...
            if ((uVar3 != 0) &&
               (puVar2 = local_d8,
               (*(code *)PTR__objc_msgSend_02578628)
                         (local_d8,PTR_s_containsObject__0269cbb8,local_128),
               ((ulong)puVar2 & 1) == 0)) {
