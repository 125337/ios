...
void ThemeBoxAirDropConsumedViewController::clearAll(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 == (char *)0x0) {
    ...
    local_30 = &cf__nzzhQ__uaS_U_Nq_T_X_;
    pcVar1 = local_28;
    _objc_alloc();
    (*(code *)PTR__objc_msgSend_02578628)();
    local_38 = pcVar1;
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nzz,local_18,
               PTR_s_confirmClearAll__026b3a60);
