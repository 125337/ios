// FUN_0060dfb4 @ 0060dfb4

void FUN_0060dfb4(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  lVar2 = local_30;
  FUN_006132ec(local_30,local_40,0);
...
LAB_0060e2a4:
    ...
    if (pcVar6 == (char *)0x0) {
      if (local_38 != 0) {
        ...
        if (local_50 != 0) goto LAB_0060e8f0;
      }
      local_50 = 0;
    }
    else {
      ...
      if (local_80 != (char *)0x0) {
        FUN_00613b50(local_28,local_80,0);
      }
      local_50 = 1;
...
LAB_0060e8f0:
    ...
    if (bVar1) {
      FUN_00613b50(local_28,local_60,local_61 & 1);
    }
    local_50 = (uint)bVar1;
    _objc_storeStrong(bVar1,&local_60,0);
    if (local_50 == 0) goto LAB_0060e2a4;
  }
