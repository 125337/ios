// profileAvatarRotationMode @ 020adc40

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::profileAvatarRotationMode(ID param_1,SEL param_2)

{
  ...
  if (2 < (long)local_38) {
    local_38 = (undefined *)((long)&MACH_HEADER.magic + 2);
  }
