// FUN_007f36b0 @ 007f36b0

void FUN_007f36b0(undefined8 param_1,byte param_2)
  ...
  if (local_b0 == 0) {
    ...
    if ((uVar2 & 1) != 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_b0,PTR_s_setBackgroundVideoActive__026a89c0,local_b1 & 1);
    }
    ...
    if (local_138 != 0) {
      ...
      do {
        do {
          ...
          FUN_007f36b0(local_c0,local_b1 & 1);
