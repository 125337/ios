// preselectMembers:inSessionSelectController: @ 01abe2fc

/* Function Stack Size: 0x20 bytes */

void WCRGroupListViewController::preselectMembers_inSessionSelectController_
    ...
    if (local_160 != 0) {
      ...
      do {
        do {
          ...
          pcVar2 = local_d8;
          (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_getContactByName__0269d178,local_f0);
          _objc_retainAutoreleasedReturnValue();
          local_138 = pcVar2;
          if (pcVar2 != (char *)0x0) {
