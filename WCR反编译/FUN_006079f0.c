// FUN_006079f0 @ 006079f0

void FUN_006079f0(ulong param_1,undefined8 param_2,undefined8 param_3)
    ...
    if ((uVar2 & 1) == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_removeSinkOverrideForSession__026a0be8,local_50);
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_presentSinkEditorForSession_isGr_026a0be0,local_50,1,local_18,local_28);
    }
  }
