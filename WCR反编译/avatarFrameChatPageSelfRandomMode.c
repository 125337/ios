// avatarFrameChatPageSelfRandomMode @ 020bb17c

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::avatarFrameChatPageSelfRandomMode(ID param_1,SEL param_2)

{
  ...
  if (local_30 == (undefined *)0x0) {
    puVar2 = local_28;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_28,PTR_s_objectForKey__0269e048,&cf_avatarFrameChatPageSelfRandom);
    _objc_retainAutoreleasedReturnValue();
    local_5c = 0;
    local_38 = puVar2;
