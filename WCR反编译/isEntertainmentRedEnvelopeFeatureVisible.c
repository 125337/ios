// isEntertainmentRedEnvelopeFeatureVisible @ 01534ca8

/* Function Stack Size: 0x10 bytes */

bool WCRefineTopBarProfileCardPresenter::isEntertainmentRedEnvelopeFeatureVisible
...

{
  ...
  local_80 = 0;
  _objc_storeStrong(&local_80,&cf_entertainment_red_envelop);
  local_81 = 1;
  local_88 = 0x5c70d3a9;
  ...
  if ((uVar1 & 1) != 0) {
    ...
    local_110 = 0;
    if (local_49 != false) {
      local_110 = (bool)((char)local_70[7] == '\x03');
    }
    local_dc = local_110;
  }
