// toggleMonitoring: @ 0091691c

/* Function Stack Size: 0x18 bytes */

void NavigationMonitorViewController::toggleMonitoring_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((uVar1 & 1) == 0) {
    ...
    (*(code *)PTR__objc_release_02578630)(puVar3);
    IVar2 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_navigationFloatingEnabled_026aa2b0);
    if ((IVar2 & 1) != 0) {
      puVar3 = PTR_LogFloatingBall_026cea78;
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_LogFloatingBall_026cea78,PTR_s_sharedNavigationInstance_026a9ee0);
