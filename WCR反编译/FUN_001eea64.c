// FUN_001eea64 @ 001eea64

void FUN_001eea64(void)

{
  ...
  local_30 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(puVar5,PTR_s_inputCornerBorderColorLight_026a0310);
  _objc_retainAutoreleasedReturnValue();
  local_d8 = local_30;
  local_38 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_inputCornerBorderColorDark_026a0318);
  _objc_retainAutoreleasedReturnValue();
  local_50[0] = local_d8;
