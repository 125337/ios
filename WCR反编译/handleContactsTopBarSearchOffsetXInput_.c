// handleContactsTopBarSearchOffsetXInput: @ 01b5523c

/* Function Stack Size: 0x18 bytes */

void WCRefineLayoutFunctionViewController::handleContactsTopBarSearchOffsetXInput_
...

{
  ...
  if (pcVar2 != (cfstringStruct *)0x0) {
    local_48 = 0.0;
    pcVar4 = local_38;
    FUN_01b546fc(pcVar2,local_38,&local_48);
    if (((ulong)pcVar4 & 1) == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
