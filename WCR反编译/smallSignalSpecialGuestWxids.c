// smallSignalSpecialGuestWxids @ 02183798

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::smallSignalSpecialGuestWxids(ID param_1,SEL param_2)

{
  ...
  local_c0 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_WCRefineSmallSignalSpecialGuestWxids);
  _objc_retainAutoreleasedReturnValue();
  local_c8 = param_1;
