// toggleAutoKick: @ 018b43ec

/* Function Stack Size: 0x18 bytes */

void WCRefineChatRoomManageViewController::toggleAutoKick_(ID param_1,SEL param_2,ID param_3)
  ...
  if ((uVar1 & 1) == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx,local_18,
               PTR_s_confirmEnableAutoKick_026b7aa8);
