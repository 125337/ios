// editAutoReplyRecentMinutes @ 01942e7c

/* Function Stack Size: 0x10 bytes */

void WCRefineDoNotDisturbSettingsViewController::editAutoReplyRecentMinutes(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handleAutoReplyRecentMinutesInpu_026b9710);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_showTextFieldWithMaxLen__0269e5e0,8);
  pcVar2 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)
  ...
  if (((ulong)pcVar2 & 1) != 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)();
    (*(code *)PTR__objc_msgSend_02578628)(puVar4,PTR_s_stringWithFormat__0269cca8,&cf__ld);
    _objc_retainAutoreleasedReturnValue();
