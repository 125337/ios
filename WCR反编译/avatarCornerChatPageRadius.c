// avatarCornerChatPageRadius @ 020b4da0

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::avatarCornerChatPageRadius(ID param_1,SEL param_2)

{
  ...
  pdVar4 = (dword *)PTR__OBJC_CLASS___NSNumber_026ce038;
  if (local_30 == (dword *)0x0) {
    IVar3 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_avatarCornerRadius_0269dfc0);
    (*(code *)PTR__objc_msgSend_02578628)(pdVar4,PTR_s_numberWithInteger__0269e080,IVar3);
    _objc_retainAutoreleasedReturnValue();
    pdVar1 = local_30;
    local_30 = pdVar4;
    ...
    _cmdString();
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(pdVar1,PTR_s_setObject_forKey__026ca9e8,pdVar4);
    (*(code *)PTR__objc_release_02578630)(SVar2);
