// navigationHomeOnlineNicknameTextColorDark @ 02071fc4

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::navigationHomeOnlineNicknameTextColorDark(ID param_1,SEL param_2)

{
  ...
  pcVar2 = &cf_nicknameTextColorDark;
