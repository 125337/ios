// voiceTranslateColorSelfDark @ 020df204

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::voiceTranslateColorSelfDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setVoiceTranslateColorSelfDark__026b9308,puVar2);
    puVar2 = local_40;
