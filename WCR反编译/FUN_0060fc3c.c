// FUN_0060fc3c @ 0060fc3c

/* WARNING: Removing unreachable block (ram,0x0061014c) */

void FUN_0060fc3c(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (((local_59 & 1) == 0) ||
    ...
    if (local_78[0] != (cfstringStruct *)0x0) {
      _objc_setAssociatedObject(local_78[0],&DAT_0232420c,0,3);
    }
    pcVar1 = local_30;
    (*(code *)PTR__objc_retain_02578638)();
    local_28 = pcVar1;
    ...
    pcVar1 = local_78[0];
    _objc_getAssociatedObject(local_78[0],&DAT_02324208);
    _objc_retainAutoreleasedReturnValue();
    ...
    if ((bool)local_81) {
      ...
      if (((ulong)pcVar1 & 1) == 0) {
        ...
        pcVar1 = local_78[0];
        _objc_getAssociatedObject(local_78[0],&DAT_0232420c);
        _objc_retainAutoreleasedReturnValue();
        local_90 = pcVar1;
...
LAB_0061003c:
          ...
          _objc_setAssociatedObject(local_78[0],&DAT_0232420c,local_90,3);
        }
        else {
