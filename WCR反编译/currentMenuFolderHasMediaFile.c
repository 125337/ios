// currentMenuFolderHasMediaFile @ 01b86ef4

/* Function Stack Size: 0x10 bytes */

bool WCRefineMenuBeautifyViewController::currentMenuFolderHasMediaFile(ID param_1,SEL param_2)

{
  ...
  local_c0 = param_2;
  local_b8 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_getCurrentMenuImageFolderPath_026bfda0);
    ...
    if (local_170 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          if (local_ec != 0) goto LAB_01b8720c;
