// clearHistoryTapped @ 01e3bd04

/* Function Stack Size: 0x10 bytes */

void WCRefineSvgColorSchemeHistoryViewController::clearHistoryTapped(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nzz,local_18,
             PTR_s_confirmClearHistory__026b7bb0);
