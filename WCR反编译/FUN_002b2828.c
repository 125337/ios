// FUN_002b2828 @ 002b2828

void FUN_002b2828(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if ((uVar1 & 1) == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(uVar3,PTR_s_setTransform__026caad0,auStack_128);
