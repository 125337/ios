// plusMenuBgColorDark @ 02169504

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::plusMenuBgColorDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    _objc_retainAutoreleasedReturnValue();
    local_40 = puVar3;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setPlusMenuBgColorDark__026b9418,puVar3);
    puVar3 = local_40;
