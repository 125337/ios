// showPatAutoBackDelayEditor @ 01a59764

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::showPatAutoBackDelayEditor(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handlePatAutoBackDelayInput__026bce68);
