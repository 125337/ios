// renderOfficialScheduleItems @ 01e85b84

/* Function Stack Size: 0x10 bytes */

void WCRefineToDoCardView::renderOfficialScheduleItems(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (puVar2,PTR_s_cardEntriesForBackend_dailyOnly__026c7108,1,puVar1);
  _objc_retainAutoreleasedReturnValue();
  local_c8 = puVar2;
