// FUN_000984f8 @ 000984f8

void FUN_000984f8(long param_1)
  ...
  if (lVar3 == 0) {
    ...
    *(long *)(lVar3 + 0x18) = *(long *)(lVar3 + 0x18) + 1;
    ...
    if (lVar3 == 0) {
      local_40 = 0;
      local_48 = 0;
      FUN_00097b88(local_30,&local_48);
    ...
    if ((local_74 & 1) == 0) {
      if (599 < *(long *)(*(long *)(*(long *)(param_1 + 0x28) + 8) + 0x18)) {
        (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
        FUN_0009792c(local_30,0,&cf_N_e);
      }
      local_34 = 0;
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
      FUN_00097344(local_30,0,*(undefined8 *)(param_1 + 0x20),
