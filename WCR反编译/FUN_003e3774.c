// FUN_003e3774 @ 003e3774

void FUN_003e3774(code *param_1,long param_2)

{
  ...
  if (((param_1 != (code *)0x0) && (param_2 != 0)) &&
    ...
    pcVar2 = param_1;
    _objc_getAssociatedObject(lVar4,param_1,&DAT_028ca438);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_release_02578630)();
    if (((pcVar2 == (code *)0x0) &&
        (_method_setImplementation(pcVar1,FUN_003e39fc), pcVar1 != (code *)0x0)) &&
       (pcVar1 != FUN_003e39fc)) {
      ...
      _objc_retainAutoreleasedReturnValue();
      _objc_setAssociatedObject(param_1,&DAT_028ca438,puVar3,1);
