// contactsEarliestAddedSectionCount @ 0212adc4

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::contactsEarliestAddedSectionCount(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_contactsEarliestAddedSectionCount);
  _objc_retainAutoreleasedReturnValue();
  ...
  if ((param_1 & 1) == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_28,PTR_s_setObject_forKey__026ca9e8,local_30,
               &cf_contactsEarliestAddedSectionCount);
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_class_0269cd60);
    (*(code *)PTR__objc_msgSend_02578628)();
  }
  local_38 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_integerValue_026ca750);
  if (((long)local_38 < 1) || (500 < (long)local_38)) {
    local_38 = (undefined *)((long)&MACH_HEADER.cpusubtype + 2);
  }
