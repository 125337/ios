// resetToolbarLayout @ 018ce8bc

/* Function Stack Size: 0x10 bytes */

void WCRefineChatToolbarViewController::resetToolbarLayout(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (0x4041800000000000,puVar1,PTR_s_setChatToolbarHeight__026b80e0);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (0x4059000000000000,local_28,PTR_s_setChatToolbarScalePercent__026b8128);
  ...
  FUN_018ca37c();
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__b_Y___);
