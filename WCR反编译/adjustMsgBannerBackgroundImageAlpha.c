// adjustMsgBannerBackgroundImageAlpha @ 01b9d6d4

/* Function Stack Size: 0x10 bytes */

void WCRefineMessageBannerBeautifyViewController::adjustMsgBannerBackgroundImageAlpha
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgBannerBgImageAlphaLight_026a07a8);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgBannerBgImageAlphaDark_026a07a0);
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_stringWithFormat__0269cca8,&cf___2f___2f);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleMsgBannerBackgroundImageAl_026c0180);
