// FUN_007bf7d0 @ 007bf7d0

void FUN_007bf7d0(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (((DAT_026f46b8 & 1) == 0) || (local_28 == 0)) {
    (*DAT_028ccd58)(local_18,local_20,local_28);
    local_38 = 1;
  }
  else {
    lVar1 = DAT_028cccc0;
    ...
    if ((local_40 == 0) ||
      ...
      (*DAT_028ccd58)(local_18,local_20,local_40);
    }
