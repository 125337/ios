// FUN_003b9574 @ 003b9574

void FUN_003b9574(long param_1)
  ...
  if (lVar1 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineTopBarProfileCardPresenter_026ce228,
               ...
               _WCRefineProfileCardActionIDAvatarFrame,lVar1);
    if (((ulong)puVar2 & 1) == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_4YPFhn_Sb);
    }
  }
