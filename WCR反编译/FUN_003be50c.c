// FUN_003be50c @ 003be50c

void FUN_003be50c(void)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  local_b8 = pcVar2;
  FUN_003612b8(pcVar2,&cf_allTopSessions);
  _objc_retainAutoreleasedReturnValue();
  pcVar3 = local_b8;
  local_c0 = pcVar2;
  FUN_003612b8(local_b8,&cf_topSessions);
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = local_c0;
  local_c8 = pcVar3;
  FUN_003934d0(local_c0,pcVar3);
  _objc_retainAutoreleasedReturnValue();
    ...
    if (local_158 != (char *)0x0) {
      ...
      do {
        do {
          ...
          local_e0 = *(undefined8 *)(local_118 + (long)local_160 * 8);
          puVar1 = local_d8;
          (*(code *)PTR__objc_msgSend_02578628)
