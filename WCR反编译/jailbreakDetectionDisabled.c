// jailbreakDetectionDisabled @ 0202dc74

/* Function Stack Size: 0x10 bytes */

bool WCRefineConfig::jailbreakDetectionDisabled(ID param_1,SEL param_2)

{
  ...
  FUN_0202de58((byte)puVar3 & 1);
  _objc_storeStrong(&local_30);
  _objc_storeStrong(&local_28,0);
  return (byte)puVar3 & 1;
}
