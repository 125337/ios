// FUN_008b4eac @ 008b4eac

void FUN_008b4eac(undefined8 param_1)

{
  ...
  if (local_20 == 0) {
    ...
    if (local_30 == 0) {
      uVar1 = local_20;
      FUN_008b5ddc(local_20,PTR_s_viewModel_0269d080);
      _objc_retainAutoreleasedReturnValue();
      uVar2 = local_30;
      local_30 = uVar1;
      (*(code *)PTR__objc_release_02578630)(uVar2);
    ...
    if ((local_30 == 0) ||
      ...
      uVar2 = local_30;
      FUN_008b5ddc(local_30,PTR_s_messageWrap_0269d070);
      _objc_retainAutoreleasedReturnValue();
      local_18 = uVar2;
    }
    local_24 = 1;
