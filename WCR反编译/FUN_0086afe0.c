// FUN_0086afe0 @ 0086afe0

void FUN_0086afe0(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
  ...
  if (local_168 != 0) {
    ...
    do {
      do {
        ...
        lVar3 = local_b0;
        (*DAT_028cd598)(local_b0,local_b8,local_d8,local_c8);
        _objc_retainAutoreleasedReturnValue();
        lVar1 = local_d0;
        local_d0 = lVar3;
        (*(code *)PTR__objc_release_02578630)(lVar1);
        if (local_d0 != 0) goto LAB_0086b208;
...
LAB_0086b208:
  ...
  FUN_00889684(*(undefined8 *)PTR__CGSizeZero_025782f8,*(undefined8 *)(PTR__CGSizeZero_025782f8 + 8)
               ,local_c0,local_d0,&cf_MMThemeManager_svgImageNamed_color);
  _objc_retainAutoreleasedReturnValue();
