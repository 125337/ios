// pixelateImage:scale: @ 0167ba68

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x20 bytes */

ID WCRSuperFloatCropViewController::pixelateImage_scale_
...

{
  ...
  if (local_40 != (undefined *)0x0) {
    ...
    if (puVar1 != (undefined *)0x0) {
      ...
      local_58 = puVar1;
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR__OBJC_CLASS___CIFilter_026ce8a0,PTR_s_filterWithName__026a7210,&cf_CIPixellate)
      ;
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (puVar1,PTR_s_setValue_forKey__0269d300,puVar2,&cf_inputScale);
