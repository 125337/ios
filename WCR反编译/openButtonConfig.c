// openButtonConfig @ 01e2bc88

/* Function Stack Size: 0x10 bytes */

void WCRefineSuperFloatSettingsViewController::openButtonConfig(ID param_1,SEL param_2)

{
  ...
  puVar1 = PTR_WCRefineSuperFloatButtonConfigViewController_026cee60;
  (*(code *)PTR__objc_msgSend_02578628)
