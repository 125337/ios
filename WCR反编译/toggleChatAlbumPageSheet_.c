// toggleChatAlbumPageSheet: @ 01f5180c

/* Function Stack Size: 0x18 bytes */

void WCRefineVersionController::toggleChatAlbumPageSheet_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((IVar4 & 1) == 0) {
    ...
    _WCRefineIsChatAlbumPageSheetSupportedByCurrentWeChat();
    if ((IVar4 & 1) == 0) {
