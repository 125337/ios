// morandiColorTapped: @ 018fd928

/* Function Stack Size: 0x18 bytes */

void WCRefineColorPickerController::morandiColorTapped_(ID param_1,SEL param_2,ID param_3)

{
  ...
  IVar1 = local_18;
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_morandiColors_026b88b8);
