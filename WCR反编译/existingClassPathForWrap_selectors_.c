// existingClassPathForWrap:selectors: @ 00f3f5d0

/* Function Stack Size: 0x20 bytes */

ID WCRefineEmoticonToolsHelper::existingClassPathForWrap_selectors_
      ...
      do {
        do {
          ...
          if (((ulong)pcVar3 & 1) != 0) {
            ...
            local_138 = pcVar3;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_b8,PTR_s_isReadableVideoAtPath__026ac1e0,pcVar3);
            pcVar3 = local_138;
            bVar1 = (IVar4 & 1) != 0;
            if (bVar1) {
              (*(code *)PTR__objc_retain_02578638)();
            ...
            if (local_d4 != 0) goto LAB_00f3f834;
          }
