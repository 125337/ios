// wcr_forwardVoiceFromMediaPath:fromViewController: @ 00fb4f48

/* Function Stack Size: 0x20 bytes */

void WCRefineHelper::wcr_forwardVoiceFromMediaPath_fromViewController_
...

{
  ...
  if ((lVar1 == 0) || (local_40 == (undefined *)0x0)) {
    ...
    if (((ulong)puVar3 & 1) == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showWeToastLoadingWithText__0269cea8,&cf_ck_Wl_N_
                );
      _objc_retainAutoreleasedReturnValue();
      local_50 = puVar2;
      FUN_00fae91c();
