// editSvgColorExcludeIconNames @ 01f36c44

/* Function Stack Size: 0x10 bytes */

void WCRefineUIBeautifyViewController::editSvgColorExcludeIconNames(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_alertConfirmSvgColorExcludeIconN_026c8968);
