// adjustVerticalOffset @ 00348734

/* Function Stack Size: 0x10 bytes */

void WCRefineHomeAvatarStripPickerBridge::adjustVerticalOffset(ID param_1,SEL param_2)

{
  ...
  if (bVar2) {
    ...
    if (((ulong)puVar5 & 1) != 0) {
      puVar5 = local_40;
      (*(code *)PTR__objc_msgSend_02578628)
                (local_40,PTR_s_objectForKeyedSubscript__0269d098,&cf_verticalOffset);
      _objc_retainAutoreleasedReturnValue();
      local_51 = 1;
      local_50 = puVar5;
      (*(code *)PTR__objc_msgSend_02578628)();
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_60,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_confirmVerticalOffset_026a2298);
    _objc_setAssociatedObject(local_18,PTR_s_adjustVerticalOffset_026a22a0,local_60,1);
