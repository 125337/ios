// momentsAutoCommentMaxPerSession @ 0205f410

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::momentsAutoCommentMaxPerSession(ID param_1,SEL param_2)

{
  ...
  if (200 < (long)local_98) {
    local_98 = section_000000b8.segname;
  }
  if ((long)local_98 < 2) {
    local_a0 = (char *)((long)&MACH_HEADER.magic + 1);
  }
  else {
    local_a0 = local_98;
  }
