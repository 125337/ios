// FUN_00607d50 @ 00607d50

void FUN_00607d50(ulong param_1,undefined8 param_2,undefined8 param_3)
    ...
    if ((uVar2 & 1) == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_removeLiftOverrideForSession__026a0bf8,local_50);
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_presentLiftEditorForSession_isGr_026a0bf0,local_50,1,local_18,local_28);
    }
  }
