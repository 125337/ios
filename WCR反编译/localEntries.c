// localEntries @ 01f13d14

/* Function Stack Size: 0x10 bytes */

ID WCRefineToDoStore::localEntries(ID param_1,SEL param_2)
    ...
    if (local_158 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          uVar5 = *(ulong *)(local_118 + (long)local_160 * 8);
          ...
          if ((uVar5 & 1) != 0) {
            IVar3 = local_b8;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_b8,PTR_s_entryFromLocalDict__026c8200,local_e0);
            _objc_retainAutoreleasedReturnValue();
