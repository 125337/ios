// videoCustomDurationEnabled @ 0203c2d8

/* Function Stack Size: 0x10 bytes */

bool WCRefineConfig::videoCustomDurationEnabled(ID param_1,SEL param_2)

{
  ...
  local_28 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_videoCustomDurationSeconds);
  _objc_retainAutoreleasedReturnValue();
