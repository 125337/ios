// redeemCode:weChat:completion: @ 0175e144

/* Function Stack Size: 0x28 bytes */

void ThemeProRedeemService::redeemCode_weChat_completion_
...

{
  ...
  if (lVar1 == 0) {
    ...
    if (lVar1 == 0) {
      if (local_70 != 0) {
        (**(code **)(local_70 + 0x10))(local_70,0,&cf__OSN_Nzz);
      }
      local_84 = 1;
    }
    else {
      ...
      local_a0 = local_90;
      (*(code *)PTR__objc_msgSend_02578628)
                (pcVar4,PTR_s_dataWithJSONObject_options_error_026a64a8,puVar3,0,&local_a0);
      _objc_retainAutoreleasedReturnValue();
      _objc_storeStrong(&local_90,local_a0);
      local_98 = pcVar4;
      (*(code *)PTR__objc_release_02578630)(puVar3);
      if ((local_90 == 0) && (local_98 != (cfstringStruct *)0x0)) {
        pcVar4 = local_98;
        FUN_0175de6c();
        _objc_retainAutoreleasedReturnValue();
        ...
        if ((((ulong)pcVar4 & 1) == 0) ||
           (pcVar4 = local_a8, (*(code *)PTR__objc_msgSend_02578628)(local_a8,PTR_s_length_0269cca0)
          ...
          FUN_0175e9a8();
          _objc_retainAutoreleasedReturnValue();
          (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_stringWithFormat__0269cca8,&cf_code___)
          ;
          _objc_retainAutoreleasedReturnValue();
          local_b8 = puVar3;
          (*(code *)PTR__objc_release_02578630)(pcVar4);
          ...
          local_c8 = puVar5;
          (*(code *)PTR__objc_msgSend_02578628)
                    (0x4024000000000000,puVar5,PTR_s_setTimeoutInterval__0269cae8);
          ...
          local_f0 = 0xc2000000;
          local_ec = 0;
          local_e8 = FUN_0175eb24;
          local_e0 = &DAT_02581b60;
          (*(code *)PTR__objc_retain_02578638)();
          local_d8 = lVar1;
          puVar6 = puVar5;
          (*(code *)PTR__objc_msgSend_02578628)
                    (puVar5,PTR_s_dataTaskWithRequest_completionHa_026a5f60,puVar3,&local_f8);
          _objc_retainAutoreleasedReturnValue();
          local_d0 = puVar6;
          (*(code *)PTR__objc_release_02578630)(puVar5);
