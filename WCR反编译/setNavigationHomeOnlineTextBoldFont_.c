// setNavigationHomeOnlineTextBoldFont: @ 02070c40

/* Function Stack Size: 0x14 bytes */

void WCRefineConfig::setNavigationHomeOnlineTextBoldFont_(ID param_1,SEL param_2,bool param_3)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = &cf_tqqOnlineTextBoldFont;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
