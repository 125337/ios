// showPatOtherAutoReplyContentEditor @ 01a5df78

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::showPatOtherAutoReplyContentEditor
...

{
  ...
  puVar3 = local_70;
  (*(code *)PTR__objc_msgSend_02578628)(local_70,PTR_s_patOtherAutoReplyCountMode_026a36a0);
  IVar1 = local_60;
  ...
  if (puVar3 == (undefined1 *)((long)&MACH_HEADER.magic + 1)) {
    ...
    _objc_retainAutoreleasedReturnValue();
    FUN_01a0aaac(IVar1,&cf_b_e,&cf_wcrPatOtherAutoReplyMultiSheet);
    local_101 = 0;
    local_102 = 0;
    local_103 = 0;
    ...
    _objc_retainAutoreleasedReturnValue();
    FUN_01a0aaac(IVar1,&cf_b_e,&cf_wcrPatOtherAutoReplySheet);
    (*(code *)PTR__objc_release_02578630)(puVar6);
    (*(code *)PTR__objc_release_02578630)(puVar5);
    (*(code *)PTR__objc_release_02578630)(puVar4);
    (*(code *)PTR__objc_release_02578630)(puVar2);
