// pickBackgroundFromPhotos @ 01aeda18

/* Function Stack Size: 0x10 bytes */

void WCRefineHomeAvatarStripSettingsViewController::pickBackgroundFromPhotos(ID param_1,SEL param_2)

{
  ...
  _objc_setAssociatedObject(puVar1,"hasBgVariant",local_60,1);
