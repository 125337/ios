// setRedEnvelopNotificationJumpDarkColor: @ 02057bb0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setRedEnvelopNotificationJumpDarkColor_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (pcVar4 == (cfstringStruct *)0x0) {
    _objc_storeStrong(&local_38,&cf_DDA0DD);
  }
  IVar2 = local_30;
  pcVar4 = local_38;
  SVar6 = local_20;
