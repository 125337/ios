// showImagePickerWithSourceType:type: @ 0187fb2c

/* Function Stack Size: 0x20 bytes */

void WCRefineChatAttachmentBeautifyViewController::showImagePickerWithSourceType_type_
...

{
  ...
  _objc_setAssociatedObject(local_50,"wcr_attach_type",local_48,1);
  (*(code *)PTR__objc_msgSend_02578628)
