// setToDoCardWebURLHistory: @ 021712f0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setToDoCardWebURLHistory_(ID param_1,SEL param_2,ID param_3)
  ...
  if (local_158 != 0) {
    ...
    do {
      do {
        ...
        if ((local_12c != 0) && (local_12c != 3)) goto LAB_02171608;
