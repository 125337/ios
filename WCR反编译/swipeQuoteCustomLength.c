// swipeQuoteCustomLength @ 020c62c4

/* Function Stack Size: 0x10 bytes */

double __thiscall
WCRefineConfig::swipeQuoteCustomLength(WCRefineConfig *this,ID param_1,SEL param_2)

{
  ...
  if (in_d0 <= 0.0) {
    ...
    puVar3 = PTR__OBJC_CLASS___NSNumber_026ce038;
    (*(code *)PTR__objc_msgSend_02578628)
              (0x404e000000000000,PTR__OBJC_CLASS___NSNumber_026ce038,
