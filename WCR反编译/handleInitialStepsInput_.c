// handleInitialStepsInput: @ 01def7b0

/* Function Stack Size: 0x18 bytes */

void WCRefineStepCountSettingsViewController::handleInitialStepsInput_
...

{
  ...
  _objc_retainAutoreleasedReturnValue();
  local_48 = puVar2;
  (*(code *)PTR__objc_msgSend_02578628)(puVar2,PTR_s_setStepCountInitial__026c5a20,local_40);
  puVar1 = local_48;
  (*(code *)PTR__objc_msgSend_02578628)(local_48,PTR_s_stepCountTargetModeEnabled_026a7ef8);
  if (((ulong)puVar1 & 1) == 0) {
LAB_01def944:
    ...
    puVar2 = local_48;
    (*(code *)PTR__objc_msgSend_02578628)(local_48,PTR_s_stepCountRandomEnabled_026a7f20);
    puVar1 = local_40;
    if (((ulong)puVar2 & 1) != 0) goto LAB_01def944;
    puVar2 = local_48;
    (*(code *)PTR__objc_msgSend_02578628)(local_48,PTR_s_stepCountTarget_026a7f38);
    if (puVar1 != puVar2) goto LAB_01def944;
