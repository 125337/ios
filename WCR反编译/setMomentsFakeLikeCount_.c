// setMomentsFakeLikeCount: @ 0205c144

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setMomentsFakeLikeCount_(ID param_1,SEL param_2,long_long param_3)

{
  ...
  if ((long)local_28 < 0x2711) {
    local_70 = local_28;
  }
  else {
    local_70 = &DAT_00002710;
  }
  if ((long)local_70 < 1) {
