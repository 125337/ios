// setChatAvatarProfileCardFunctionPageActionOrder: @ 0200a4f0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setChatAvatarProfileCardFunctionPageActionOrder_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineProfileCardActionCatalog_026ced78,
             PTR_s_normalizedOrderFromSavedOrder__026c3550,local_28);
