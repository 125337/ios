// FUN_008d59d8 @ 008d59d8

void FUN_008d59d8(undefined8 param_1)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    uVar2 = local_18;
    _objc_getAssociatedObject(local_18,DAT_026f4af8);
    ...
    _objc_setAssociatedObject(local_18,DAT_026f4af8,0,1);
    _objc_setAssociatedObject(local_18,DAT_026f4af0,0,0);
