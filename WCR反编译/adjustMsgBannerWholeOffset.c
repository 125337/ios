// adjustMsgBannerWholeOffset @ 01b94e5c

/* Function Stack Size: 0x10 bytes */

void WCRefineMessageBannerBeautifyViewController::adjustMsgBannerWholeOffset(ID param_1,SEL param_2)

{
  ...
  if (bVar1) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgBannerWholeOffsetX_026a0770);
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgBannerWholeOffsetY_026a0778);
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMsgBannerWholeOffsetInput__026c0058);
