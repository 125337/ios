// openChatSinkSessionPicker: @ 01b4ad30

/* Function Stack Size: 0x18 bytes */

void WCRefineLayoutFunctionViewController::openChatSinkSessionPicker_
...

{
  ...
  if (pcVar5 == (cfstringStruct *)0x0) {
    ...
    if (pcVar5 == (cfstringStruct *)0x0) {
      ...
      IVar6 = local_28;
      (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_chatSinkSelectedSessions_026bf568);
