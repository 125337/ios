// FUN_00594388 @ 00594388

byte FUN_00594388(undefined8 param_1,undefined8 param_2)
    ...
    if (local_1b0 != 0) {
      ...
      do {
        do {
          ...
          uVar6 = *(ulong *)(local_128 + local_1b8 * 8);
          local_138 = 0;
          local_f0 = uVar6;
          ...
          if ((uVar3 & 1) == 0) {
            uVar6 = local_f0;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_f0,PTR_s_valueForKeyPath__026a0b98,&cf_cellConfig_leftConfig_title);
            _objc_retainAutoreleasedReturnValue();
            uVar3 = local_138;
            local_138 = uVar6;
            (*(code *)PTR__objc_release_02578630)(uVar3);
          ...
          uVar3 = local_138;
          (*(code *)PTR__objc_msgSend_02578628)(local_138,PTR_s_isEqualToString__0269ccc8,local_c0);
          bVar1 = (uVar3 & 1) != 0;
          if (bVar1) {
            local_a9 = 1;
          }
          ...
          if (local_e4 != 0) goto LAB_005948f4;
