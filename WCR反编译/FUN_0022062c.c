// FUN_0022062c @ 0022062c

byte FUN_0022062c(undefined8 param_1)
  ...
  if (local_130 != 0) {
    ...
    do {
      do {
        ...
        local_c0 = uVar4;
        FUN_00221114();
        if ((((uVar4 & 1) != 0) && (uVar4 = local_c0, FUN_002208f8(), (uVar4 & 1) != 0)) &&
           (uVar4 = local_c0, FUN_002212d4(local_c0,3), (uVar4 & 1) != 0)) {
          local_a9 = 1;
          bVar1 = true;
          goto LAB_00220858;
        }
