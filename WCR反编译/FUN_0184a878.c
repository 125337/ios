// FUN_0184a878 @ 0184a878

/* WARNING: Restarted to delay deadcode elimination for space: stack */

void FUN_0184a878(long param_1)

{
  ...
  if (lVar5 == 0) {
            ...
            if (uVar3 == 0) {
              ...
              (*(code *)PTR__objc_msgSend_02578628)
                        (PTR_WCRefineAvatarFramePageOverlayHelper_026cefb0,
                         PTR_s_isReservedSpecialKey__026b6610,local_128);
              if (((ulong)puVar2 & 1) == 0) {
    ...
    if (puVar2 == (undefined *)0x0) {
      local_1c0 = &cf__nzzyrk_u7b;
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_count_0269cfe0);
      (*(code *)PTR__objc_msgSend_02578628)(local_1c0,PTR_s_stringWithFormat__0269cca8,&cf__b);
      _objc_retainAutoreleasedReturnValue();
      local_138 = local_1c0;
    }
