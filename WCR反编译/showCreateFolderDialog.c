// showCreateFolderDialog @ 01ce5ef8

/* Function Stack Size: 0x10 bytes */

void WCRefineProfileCardBeautifyViewController::showCreateFolderDialog(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_setTextFieldDefaultText__0269fd98,&::cf__);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,local_18,
             PTR_s_handleCreateFolderCancel__026b73d0);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_R_,local_18,
             PTR_s_handleCreateFolder__026b6f28);
