// confirmClearCurrentRemarks @ 01866408

/* Function Stack Size: 0x10 bytes */

void WCRefineBatchRemarkViewController::confirmClearCurrentRemarks(ID param_1,SEL param_2)

{
  ...
  if ((param_1 & 1) == 0) {
    ...
    if (IVar2 == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_HQb_YS);
    }
    else {
      IVar1 = local_18;
      (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_buildClearCurrentRemarkChanges_026b6b80);
      _objc_retainAutoreleasedReturnValue();
      local_28 = IVar1;
      ...
      if (IVar1 != 0) {
        ...
        local_58 = IVar2;
        (*(code *)PTR__objc_msgSend_02578628)
                  (puVar4,PTR_s_showAlertWithTitle_message_btnTi_0269d8f0,&cf_nxndYl,IVar3,&cf_Sm,0,
                   &cf_nxnd,&local_78);
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_S_MRblgYlSnd);
      }
