// testImagePrompt @ 017e7410

/* Function Stack Size: 0x10 bytes */

void WCRefineAISettingsViewController::testImagePrompt(ID param_1,SEL param_2)

{
  ...
  local_28 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_isImageProviderConfigured_0269d388);
  if (((ulong)puVar1 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_HQ_bS_MReuV_jWMn_);
    local_2c = 1;
  }
  else {
    ...
    if (pcVar2 != (char *)0x0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_38,PTR_s_setTextFieldDefaultText__0269fd98,&::cf___);
      (*(code *)PTR__objc_msgSend_02578628)
                (local_38,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,local_18,
                 PTR_s_cancelPresetTest_026b5550);
      (*(code *)PTR__objc_msgSend_02578628)
                (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_ub,local_18,
                 PTR_s_confirmImageTest_026b5580);
