// presentWxidFilterPrompt @ 0172319c

/* Function Stack Size: 0x10 bytes */

void ThemeBoxAirDropLogViewController::presentWxidFilterPrompt(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 == (char *)0x0) {
    ...
    if (((ulong)pcVar2 & 1) != 0) {
      pcVar3 = local_18;
      (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_filterWxidText_026b3ab0);
