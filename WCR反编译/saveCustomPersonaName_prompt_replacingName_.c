// saveCustomPersonaName:prompt:replacingName: @ 009afc10

/* Function Stack Size: 0x28 bytes */

bool WCRefineAIStore::saveCustomPersonaName_prompt_replacingName_
...

{
  ...
  if ((lVar2 == 0) ||
    ...
    IVar3 = local_f8;
    (*(code *)PTR__objc_msgSend_02578628)(local_f8,PTR_s_wcrIsPresetPersonaName__026aac58,local_120)
    ;
    if ((IVar3 & 1) == 0) {
      IVar3 = local_f8;
      (*(code *)PTR__objc_msgSend_02578628)(local_f8,PTR_s_customPersonas_026aac48);
      _objc_retainAutoreleasedReturnValue();
      IVar4 = IVar3;
      ...
      for (local_150 = 0; uVar1 = local_150, IVar3 = local_140,
        ...
        if ((local_134 != 0) && (local_134 != 4)) goto LAB_009b02cc;
      }
      local_48 = &cf_name;
      local_38 = local_120;
      local_40 = &cf_prompt;
