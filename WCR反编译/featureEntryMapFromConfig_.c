// featureEntryMapFromConfig: @ 01c8cf64

/* Function Stack Size: 0x18 bytes */

ID WCRefinePluginFeatureManagementViewController::featureEntryMapFromConfig_
  ...
  if (local_138 != 0) {
    ...
    do {
      do {
        ...
        if (lVar4 != 0) {
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_c8,PTR_s_setObject_forKeyedSubscript__0269d248,local_d0,local_118);
        }
