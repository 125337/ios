// floatingMetricSliderContainerForTag:min:max:value: @ 019bf284

/* WARNING: Removing unreachable block (ram,0x019bf8cc) */
/* Function Stack Size: 0x30 bytes */

ID WCRefineFloatingTabBarSettingsViewController::floatingMetricSliderContainerForTag_min_max_value_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_setContinuous__026b4d68,0);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_metricSliderChanged__026bab80,0x1000);
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_e8,PTR_s_setTag__026caa80,local_38 + 3000);
  puVar1 = local_e8;
  ...
  IVar3 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)
            (local_58,local_28,PTR_s_floatingMetricDisplayTextForTag__026bab88,local_38);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_e8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_floatingMetricValueButtonTapped__026bab90,0x40);
