// confirmClearRecentOnly: @ 01fb4520

/* Function Stack Size: 0x18 bytes */

void WCRefineWeAppRecordCleaner::confirmClearRecentOnly_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((local_30 == (cfstringStruct *)0x0) && (pcVar3 == (cfstringStruct *)0x0)) {
    ...
    pcVar2 = local_30;
    FUN_01fb49f8(local_30,pcVar3);
    FUN_01fb4ce0(local_30);
    FUN_01fb5248();
    puVar1 = PTR_WCRefineHelper_026ce000;
    if (pcVar2 == (cfstringStruct *)0x0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_fe);
    }
    else {
