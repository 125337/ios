// setHideThemeBoxGroupTopEnabled: @ 0208fbd0

/* Function Stack Size: 0x14 bytes */

void WCRefineConfig::setHideThemeBoxGroupTopEnabled_(ID param_1,SEL param_2,bool param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)();
  (*(code *)PTR__objc_msgSend_02578628)
            (local_18,PTR_s_setThemeBoxGroupTopMode__026c8e70,(local_21 & 1) != 0);
