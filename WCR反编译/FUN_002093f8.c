// FUN_002093f8 @ 002093f8

double FUN_002093f8(double param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                   undefined8 param_5)

{
  ...
  if (local_30 == 0) {
    ...
    if ((uVar2 & 1) != 0) {
      ...
      local_34 = (uint)(80.0 <= local_118);
      _objc_storeStrong(local_50,0);
      param_1 = local_118;
      if (local_34 != 0) goto LAB_00209814;
    }
    uVar2 = local_30;
    ...
    if (bVar1) {
      ...
      _CGRectGetWidth(local_150,uVar3,param_3,param_4);
      (*(code *)PTR__objc_release_02578630)(uVar2);
      local_88 = local_150;
    }
    local_28 = local_88;
