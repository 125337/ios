// restorePendingRemote @ 018f27d8

/* Function Stack Size: 0x10 bytes */

void WCRefineCloudBackupSettingsViewController::restorePendingRemote(ID param_1,SEL param_2)

{
  ...
  if (param_1 != 0) {
    ...
    local_40 = puVar4;
    (*(code *)PTR__objc_msgSend_02578628)
              (puVar1,PTR_s_downloadAndApplyBackupAtPath_com_026b8540,IVar2,&local_68);
