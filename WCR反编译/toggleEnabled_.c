// toggleEnabled: @ 01f9d344

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x18 bytes */

void WCRefineVoicePackSettingsViewController::toggleEnabled_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((uVar1 & 1) != 0) {
    local_78 = 0;
    _objc_storeStrong(&local_78,&cf_voice_pack);
    local_79 = 1;
    local_80 = 0x7b18c65d;
...
LAB_01f9d6b4:
      ...
      if (local_49 == false) goto LAB_01f9d6b4;
