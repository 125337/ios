// defaultIconForItemID: @ 010f9ec8

/* Function Stack Size: 0x18 bytes */

ID WCRefinePluginIconCatalog::defaultIconForItemID_(ID param_1,SEL param_2,ID param_3)
      ...
      do {
        do {
          ...
          if (((ulong)pcVar2 & 1) != 0) {
            pcVar2 = local_e0;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_e0,PTR_s_objectForKeyedSubscript__0269d098,&cf_icon);
            _objc_retainAutoreleasedReturnValue();
            pcVar4 = pcVar2;
            FUN_010f4f48();
            _objc_retainAutoreleasedReturnValue();
