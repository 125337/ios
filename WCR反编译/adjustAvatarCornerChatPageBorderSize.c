// adjustAvatarCornerChatPageBorderSize @ 0181e908

/* Function Stack Size: 0x10 bytes */

void WCRefineAvatarCornerBeautifyViewController::adjustAvatarCornerChatPageBorderSize
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)();
  (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_stringWithFormat__0269cca8,&cf___1f);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleAvatarCornerChatPageBorder_026b62b0);
