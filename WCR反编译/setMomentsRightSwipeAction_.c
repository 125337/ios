// setMomentsRightSwipeAction: @ 020518f0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setMomentsRightSwipeAction_(ID param_1,SEL param_2,long_long param_3)

{
  ...
  local_38 = local_28;
  if (((long)local_28 < 0) || (9 < (long)local_28)) {
    local_38 = 0;
  }
