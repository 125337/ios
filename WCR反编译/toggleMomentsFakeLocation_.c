// toggleMomentsFakeLocation: @ 01c0e91c

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x18 bytes */

void WCRefineMomentsViewController::toggleMomentsFakeLocation_(ID param_1,SEL param_2,ID param_3)

{
  ...
  local_78 = 0;
  _objc_storeStrong(&local_78,&cf_moments_fake_location);
  local_79 = 1;
  local_80 = 0xd7f19c35;
