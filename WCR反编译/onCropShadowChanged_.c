// onCropShadowChanged: @ 01671ee4

/* Function Stack Size: 0x18 bytes */

void WCRSuperFloatCropViewController::onCropShadowChanged_(ID param_1,SEL param_2,ID param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_setCropShadowAmount__026b2598);
  ...
  IVar2 = local_18;
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_shapeShadowValueLab_026b2650);
  _objc_retainAutoreleasedReturnValue();
