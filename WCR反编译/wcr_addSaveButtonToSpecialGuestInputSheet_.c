// wcr_addSaveButtonToSpecialGuestInputSheet: @ 01de2ed4

/* Function Stack Size: 0x18 bytes */

void WCRefineSmallSignalSettingsViewController::wcr_addSaveButtonToSpecialGuestInputSheet_
...

{
  ...
  if ((local_50 == 0) ||
    ...
    if (uVar1 == 0) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)(IVar2,PTR_s_wcr_findPageSheetProviderViewInV_026b3cb8);
      _objc_retainAutoreleasedReturnValue();
      local_68 = IVar2;
        ...
        if (IVar2 != 0) {
          ...
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_78,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_40,
                     PTR_s_handleSpecialGuestInputSave__026c5880,0x40);
