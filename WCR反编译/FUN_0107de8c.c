// FUN_0107de8c @ 0107de8c

void FUN_0107de8c(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (((uVar2 & 1) == 0) ||
    ...
    if ((uVar2 & 1) == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (DAT_028e3268,PTR_s_setObject_forKeyedSubscript__0269d248,local_e0,local_b8);
