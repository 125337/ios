// addSaveButtonToGlobalMappingNavigationBar: @ 01e69748

/* Function Stack Size: 0x18 bytes */

void WCRefineTextReplaceViewController::addSaveButtonToGlobalMappingNavigationBar_
  ...
  if (bVar2) {
    ...
    if (local_68 == 0) {
      ...
      if (bVar2) {
        ...
        FUN_01e67d6c();
        (*(code *)PTR__objc_msgSend_02578628)
                  (uVar14,uVar13,uVar15,uVar16,local_78,PTR_s_setContentEdgeInsets__0269ebd0);
        (*(code *)PTR__objc_msgSend_02578628)
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_78,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_40,
                   PTR_s_handleGlobalMappingSave__026c6d38,0x40);
