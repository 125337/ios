// FUN_0185b984 @ 0185b984

byte FUN_0185b984(undefined8 param_1,undefined8 param_2)

{
  ...
  if ((uVar2 == 0) || (local_20 == 0)) {
    ...
    FUN_0185bf38();
    if (((uVar2 & 1) == 0) &&
       (uVar2 = local_28, FUN_0185c058(), puVar1 = PTR_s_isInContactList__0269efe0, (uVar2 & 1) == 0
       )) {
      uVar2 = local_20;
