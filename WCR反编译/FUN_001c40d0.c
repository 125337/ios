// FUN_001c40d0 @ 001c40d0

void FUN_001c40d0(double param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  (*DAT_028c8c50)(local_18,local_20,local_28);
  ...
  if (((ulong)puVar1 & 1) != 0) {
    puVar1 = local_40[0];
    (*(code *)PTR__objc_msgSend_02578628)(local_40[0],PTR_s_menuMaxCountPerLine_026a0488);
    if (0 < (long)puVar1) {
      puVar1 = local_40[0];
      (*(code *)PTR__objc_msgSend_02578628)(local_40[0],PTR_s_menuMaxCountPerLine_026a0488);
      (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_setMaxCountPerLine__026a05b8,puVar1);
    }
    (*(code *)PTR__objc_msgSend_02578628)(local_40[0],PTR_s_menuWidth_026a0470);
    if (0.0 < param_1) {
      (*(code *)PTR__objc_msgSend_02578628)(local_40[0],PTR_s_menuWidth_026a0470);
