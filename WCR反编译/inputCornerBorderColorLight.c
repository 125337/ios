// inputCornerBorderColorLight @ 020cf8f0

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::inputCornerBorderColorLight(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar3;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setInputCornerBorderColorLight__026b8fd8,puVar3);
    puVar3 = local_40;
