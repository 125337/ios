// avatarCornerBorderColorDark @ 020b65a0

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::avatarCornerBorderColorDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setAvatarCornerBorderColorDark__026b62c0,puVar2);
    puVar2 = local_40;
