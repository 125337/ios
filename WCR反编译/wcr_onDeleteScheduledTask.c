// wcr_onDeleteScheduledTask @ 01bf6bb4

/* Function Stack Size: 0x10 bytes */

void WCRefineMomentsDraftListViewController::wcr_onDeleteScheduledTask(ID param_1,SEL param_2)

{
  ...
  _WCRMomentsScheduledDeleteTask(local_28);
