// FUN_0087ed34 @ 0087ed34

void FUN_0087ed34(undefined8 param_1)
  ...
  if (local_b8 == 0) {
    ...
    do {
      ...
      if (((puVar1 == (undefined *)0x0) ||
          (puVar1 = local_e8,
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_e8,PTR_s_containsString__0269d0b0,&cf_tableviewcell),
          ((ulong)puVar1 & 1) == 0)) ||
         (puVar2 = local_e0[0], FUN_008831b4(local_e0[0],&cf_gSDe), puVar1 = local_e0[0],
         ((ulong)puVar2 & 1) == 0)) {
