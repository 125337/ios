// prepareScreenshotFrameExportZipForRelativePaths:zipPathOut:tempDirOut: @ 01d752d4

/* Function Stack Size: 0x28 bytes */

bool WCRefineScreenshotFrameLibraryViewController::
     prepareScreenshotFrameExportZipForRelativePaths_zipPathOut_tempDirOut_
...

{
  ...
  if (uVar1 == 0) {
    ...
    puVar2 = local_100[0];
    (*(code *)PTR__objc_msgSend_02578628)
              (local_100[0],PTR_s_stringByAppendingPathComponent__026cab30,&cf_WCRefine_frames);
    _objc_retainAutoreleasedReturnValue();
    local_108 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)
