// smallSignalStopPopupInActiveChatEnabled @ 02183a6c

/* Function Stack Size: 0x10 bytes */

bool WCRefineConfig::smallSignalStopPopupInActiveChatEnabled(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,
             &cf_WCRefineSmallSignalStopPopupInActiveChatEnabled);
  _objc_retainAutoreleasedReturnValue();
