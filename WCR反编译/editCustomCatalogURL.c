// editCustomCatalogURL @ 01f59bec

/* Function Stack Size: 0x10 bytes */

void WCRefineVoiceCloneListViewController::editCustomCatalogURL(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
               PTR_s_handleCustomCatalogURLInput__026c94e0);
    (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_showTextFieldWithMaxLen__0269e5e0,300);
    pcVar1 = local_30;
