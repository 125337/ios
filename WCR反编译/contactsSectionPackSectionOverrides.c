// contactsSectionPackSectionOverrides @ 021264ec

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::contactsSectionPackSectionOverrides(ID param_1,SEL param_2)

{
  ...
  local_30 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_contactsSectionPackSectionOverrides);
  _objc_retainAutoreleasedReturnValue();
  ...
  if (((param_1 & 1) == 0) ||
    ...
    local_68 = 0xd0800000;
    local_64 = 0;
    local_60 = FUN_02126724;
    local_58 = &DAT_02579a30;
    local_48 = puVar2;
    (*(code *)PTR__objc_retain_02578638)();
    local_50 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar1,PTR_s_enumerateKeysAndObjectsUsingBloc_0269d670,&local_70);
    puVar2 = local_48;
