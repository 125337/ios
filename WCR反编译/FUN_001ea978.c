// FUN_001ea978 @ 001ea978

void FUN_001ea978(void)

{
  ...
  local_30 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(puVar5,PTR_s_searchCornerBorderColorLight_026a0288);
  _objc_retainAutoreleasedReturnValue();
  local_d8 = local_30;
  local_38 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_searchCornerBorderColorDark_026a0290);
  _objc_retainAutoreleasedReturnValue();
  local_50[0] = local_d8;
