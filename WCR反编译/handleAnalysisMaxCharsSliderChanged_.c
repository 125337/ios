// handleAnalysisMaxCharsSliderChanged: @ 017c04f8

/* Function Stack Size: 0x18 bytes */

void __thiscall
WCRefineAIFeatureViewController::handleAnalysisMaxCharsSliderChanged_
...

{
  ...
  IVar2 = local_18;
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_analysisMaxCharsValueButton_026b4dd0);
  _objc_retainAutoreleasedReturnValue();
