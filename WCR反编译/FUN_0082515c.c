// FUN_0082515c @ 0082515c

void FUN_0082515c(undefined8 param_1)

{
  ...
  uVar1 = local_b0;
  _objc_getAssociatedObject(local_b0,&DAT_028cd1f8);
  ...
  if (uVar1 == 0) {
    ...
    if (local_148 != 0) {
      ...
      do {
        do {
          ...
          uVar1 = local_b8;
          (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_objectForKey__0269e048,local_d0);
          _objc_retainAutoreleasedReturnValue();
          uVar3 = uVar1;
          (*(code *)PTR__objc_msgSend_02578628)();
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_d0,PTR_s_setHidden__026ca970,uVar3 & 0xffffffff);
          (*(code *)PTR__objc_release_02578630)(uVar1);
    ...
    _objc_setAssociatedObject(local_b0,&DAT_028cd1f8,0,1);
    local_c8 = 0;
  }
