// FUN_00729400 @ 00729400

void FUN_00729400(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  local_50[0] = uVar2;
  if (uVar2 == 0) {
    FUN_0072b104(local_28,0,&cf_elSeNOo_);
    local_54 = 1;
  }
  else {
    local_60 = 0;
    local_70 = 0;
    uVar2 = local_28;
    FUN_0072b3b8(local_28,&local_70);
    _objc_retainAutoreleasedReturnValue();
    ...
    if ((local_27c & 1) == 0) {
      FUN_0072b104(local_28,0,&cf_ck_WN_eN_);
      if (local_68 == 0) {
        local_190 = 0;
        uVar2 = local_50[0];
        (*(code *)PTR__objc_msgSend_02578628)
        ...
        if (uVar2 == 0) {
          FUN_0072b104(local_28,0,&cf_elS_u7bOo_);
          local_54 = 1;
        }
        else {
          ...
          if ((local_1a8 == (cfstringStruct *)0x0) ||
             ...
             ((ulong)pcVar5 & 1) == 0)) {
            FUN_0072b104(local_28,0,&cf_N_1Y___N_ec);
            local_54 = 1;
          }
          else {
            pcVar5 = local_1a8;
            ...
            if (local_1b8 == (cfstringStruct *)0x0) {
              FUN_0072b104(local_28,0,&cf_N_1Y_);
              local_54 = 1;
            }
            else {
              pcVar5 = local_1b8;
        ...
        if ((local_e0 == (cfstringStruct *)0x0) ||
          ...
          local_114 = 0x30;
          local_110 = FUN_007287cc;
          local_108 = FUN_00728820;
          local_120 = &local_128;
          (*(code *)PTR__objc_retain_02578638)();
          puVar4 = PTR__OBJC_CLASS___NSTimer_026ce210;
          local_100 = uVar2;
      ...
      FUN_0072a73c(local_28,0,local_50[0],local_78);
      local_54 = 1;
    }
