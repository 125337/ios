// presentImagePickerForUpload @ 01cad184

/* Function Stack Size: 0x10 bytes */

void WCRefinePluginTopViewController::presentImagePickerForUpload(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_setModalPresentationStyle__0269d2a8,0);
