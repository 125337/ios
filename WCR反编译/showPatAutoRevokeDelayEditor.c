// showPatAutoRevokeDelayEditor @ 01a59bb4

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::showPatAutoRevokeDelayEditor(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handlePatAutoRevokeDelayInput__026bce80);
