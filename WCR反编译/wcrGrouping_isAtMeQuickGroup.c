// wcrGrouping_isAtMeQuickGroup @ 00365c00

/* Function Stack Size: 0x10 bytes */

bool WCRGroupingSessionListViewController::wcrGrouping_isAtMeQuickGroup(ID param_1,SEL param_2)

{
  ...
  if (puVar3 == (undefined1 *)((long)&MACH_HEADER.magic + 3)) {
    ...
    local_2c = (bool)(puVar3 == section_00000068.segname + 8);
  }
