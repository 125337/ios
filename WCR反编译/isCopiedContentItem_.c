// isCopiedContentItem: @ 0093d31c

/* Function Stack Size: 0x18 bytes */

bool WCRClipboardCapture::isCopiedContentItem_(ID param_1,SEL param_2,ID param_3)

{
  ...
  pcVar2 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_isEqualToString__0269ccc8,_WCRClipboardItemTypeText);
  local_5c = 1;
  if (((ulong)pcVar2 & 1) == 0) {
    pcVar2 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)
