// FUN_01f66a4c @ 01f66a4c

void FUN_01f66a4c(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (lVar1 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (*(undefined8 *)(param_1 + 0x28),PTR_s_showResultTitle_message__026c94c8,&cf_Y_R1Y_,
               local_68);
  }
  else {
