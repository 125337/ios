// selectQRCodeFromPhotoLibrary @ 01f34af8

/* Function Stack Size: 0x10 bytes */

void WCRefineUIBeautifyViewController::selectQRCodeFromPhotoLibrary(ID param_1,SEL param_2)

{
  ...
  if (((ulong)puVar1 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_S_MRYN_ecvQ);
  }
  else {
    puVar1 = PTR__OBJC_CLASS___UIImagePickerController_026ce390;
    _objc_alloc_init();
