// openEditorForImage: @ 01d673ac

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x18 bytes */

void WCRefineScreenshotFrameLibraryViewController::openEditorForImage_
...

{
  ...
  if (local_c0 == 0) {
    (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_showToast__026b3a18,&cf_VGrR_1Y_);
    local_c4 = 1;
  }
  else {
    uVar1 = 9;
      ...
      do {
        do {
          if (*local_128 - lVar9 != 0) {
            _objc_enumerationMutation(*local_128 - lVar9,puVar3);
          }
