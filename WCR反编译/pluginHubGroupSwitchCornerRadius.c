// pluginHubGroupSwitchCornerRadius @ 020441fc

/* Function Stack Size: 0x10 bytes */

double __thiscall
WCRefineConfig::pluginHubGroupSwitchCornerRadius(WCRefineConfig *this,ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_pluginHubGroupSwitchCornerRadius);
  _objc_retainAutoreleasedReturnValue();
  ...
  if ((undefined *)param_1 == (undefined *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_28,PTR_s_setObject_forKey__026ca9e8,local_30,
               &cf_pluginHubGroupSwitchCornerRadius);
