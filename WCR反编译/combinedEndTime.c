// combinedEndTime @ 01eace60

/* Function Stack Size: 0x10 bytes */

ID WCRefineToDoItemEditViewController::combinedEndTime(ID param_1,SEL param_2)

{
  ...
  if (bVar1) {
    ...
    _objc_retainAutoreleasedReturnValue();
    IVar3 = param_1;
    (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_editingEndTime_026c75e0);
    _objc_retainAutoreleasedReturnValue();
    local_88 = IVar3;
    if (IVar3 == 0) {
      (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_endPicker_0269cfb8);
      _objc_retainAutoreleasedReturnValue();
      local_50 = param_1;
      (*(code *)PTR__objc_msgSend_02578628)();
      _objc_retainAutoreleasedReturnValue();
