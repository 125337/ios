// homeGroupingSubListBrowseMode @ 01ffeca8

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::homeGroupingSubListBrowseMode(ID param_1,SEL param_2)

{
  ...
  return (ulong)(puVar4 == (undefined1 *)((long)&MACH_HEADER.magic + 1));
}
