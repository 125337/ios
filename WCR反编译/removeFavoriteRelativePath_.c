// removeFavoriteRelativePath: @ 015b5534

/* Function Stack Size: 0x18 bytes */

void WCRefineVoicePackStore::removeFavoriteRelativePath_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (lVar1 != 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_setObject_forKeyedSubscript__0269d248,local_40,&cf_favorites);
