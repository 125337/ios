// FUN_001cb758 @ 001cb758

void FUN_001cb758(ulong param_1,undefined8 param_2)

{
  ...
  if ((bool)uVar1) {
    uVar6 = local_b0;
    _objc_getAssociatedObject(local_b0,&DAT_028c91ab);
    _objc_retainAutoreleasedReturnValue();
    bVar2 = uVar6 == 0;
    local_d1 = uVar1;
    local_d0 = uVar6;
  ...
  if (bVar2) {
    ...
    _objc_retainAutoreleasedReturnValue();
    _objc_setAssociatedObject(uVar3,&DAT_028c91ab,puVar4,1);
