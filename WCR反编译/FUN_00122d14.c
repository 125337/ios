// FUN_00122d14 @ 00122d14

void FUN_00122d14(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (**(ulong **)(param_1 + 0x40) < uVar1) {
    ...
    if (lVar4 != 0) {
      ...
      lVar4 = local_a0[0];
      FUN_001220d8(local_a0[0],*(undefined8 *)(param_1 + 0x30),*(undefined8 *)(param_1 + 0x38));
      _objc_retainAutoreleasedReturnValue();
