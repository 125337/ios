...
void WCRefineMessageSyncRule::saveRules_(ID param_1,SEL param_2,ID param_3)
  ...
  if (local_130 != 0) {
    ...
    do {
      do {
        ...
        uVar6 = *(ulong *)(local_108 + local_138 * 8);
        ...
        if ((uVar6 & 1) != 0) {
          IVar3 = local_b0;
          (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_normalizedRule__026ae5c0,local_d0);
          _objc_retainAutoreleasedReturnValue();
