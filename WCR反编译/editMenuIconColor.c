// editMenuIconColor @ 01e27b24

/* Function Stack Size: 0x10 bytes */

void WCRefineSuperFloatSettingsViewController::editMenuIconColor(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_setTitle__0269cef0,&cf_Vhr);
  IVar4 = local_18;
