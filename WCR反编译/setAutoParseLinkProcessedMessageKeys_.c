// setAutoParseLinkProcessedMessageKeys: @ 021515fc

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setAutoParseLinkProcessedMessageKeys_(ID param_1,SEL param_2,ID param_3)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)
            (IVar2,PTR_s_setObject_forKey__026ca9e8,puVar1,&cf_autoParseLinkProcessedMessageKeys);
