// setNavigationHomeOnlineNicknameHorizontalOffset: @ 0207234c

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setNavigationHomeOnlineNicknameHorizontalOffset_
...

{
  ...
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = &cf_nicknameHorizontalOffset;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
