// toggleFinderMyPageLock: @ 016f42bc

/* Function Stack Size: 0x18 bytes */

void SpecificPageLockViewController::toggleFinderMyPageLock_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((uVar2 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_setFinderMyPageLockEnabled__026b35a0,0);
  }
  else {
    IVar3 = local_18;
    ...
    if ((IVar3 & 1) == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showAlertWithTitle_message_btnTi_0269ccf0,
                 &cf_WCRefine,&cf_YN_ecuir_RRel_T_udkR,&cf_nx_,&PTR___NSConcreteGlobalBlock_02588430
                );
