// setTextColor @ 01ba88c4

/* Function Stack Size: 0x10 bytes */

void WCRefineMessageBlockSettingsViewController::setTextColor(ID param_1,SEL param_2)

{
  ...
  local_38 = pcVar4;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar4,PTR_s_messageBlockTextColor_026a4218);
  _objc_retainAutoreleasedReturnValue();
  local_c0 = pcVar4;
  ...
  pcVar4 = local_38;
  (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_messageBlockTextDarkColor_026a4210);
  _objc_retainAutoreleasedReturnValue();
  local_d8 = pcVar4;
  if (pcVar4 == (cfstringStruct *)0x0) {
    local_d8 = &cf_66CD00;
  ...
  local_80 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(puVar5,PTR_s_setTitle__0269cef0,&cf_beW_re_);
