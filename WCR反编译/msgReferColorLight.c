// msgReferColorLight @ 020d9e80

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::msgReferColorLight(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    _objc_retainAutoreleasedReturnValue();
    local_40 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setMsgReferColorLight__026b9200,puVar2);
    puVar2 = local_40;
