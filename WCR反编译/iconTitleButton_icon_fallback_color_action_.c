// iconTitleButton:icon:fallback:color:action: @ 01c3ab58

/* Function Stack Size: 0x38 bytes */

ID WCRefineNameplateLibraryViewController::iconTitleButton_icon_fallback_color_action_
...

{
  ...
  uVar2 = local_30;
  FUN_01c3adf0(0x4038000000000000,local_30,local_40,local_38);
  _objc_retainAutoreleasedReturnValue();
  local_58 = uVar2;
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_layoutFloatButton__026c1ac0,local_50);
  (*(code *)PTR__objc_msgSend_02578628)
