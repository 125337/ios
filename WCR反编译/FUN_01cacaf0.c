// FUN_01cacaf0 @ 01cacaf0

void FUN_01cacaf0(float param_1,long param_2)

{
  ...
  if ((double)param_1 <= 0.0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (0x3ff0000000000000,*(undefined8 *)(param_2 + 0x20),PTR_s_setAvatarScale__026c2f28);
  }
  else {
    (*(code *)PTR__objc_msgSend_02578628)
              ((double)param_1,*(undefined8 *)(param_2 + 0x20),PTR_s_setAvatarScale__026c2f28);
  }
