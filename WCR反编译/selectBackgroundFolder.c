// selectBackgroundFolder @ 0187e678

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAttachmentBeautifyViewController::selectBackgroundFolder(ID param_1,SEL param_2)

{
  ...
  IVar1 = local_b0;
  (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_msgAttachmentBasePath_026b6ea0);
  ...
  _objc_retainAutoreleasedReturnValue();
  local_c8 = puVar2;
  (*(code *)PTR__objc_msgSend_02578628)(puVar2,PTR_s_fileExistsAtPath__026ca630,local_c0);
  if (((ulong)puVar2 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)();
    local_150 = pcVar5;
    for (local_158 = 0; lVar8 = local_158, puVar2 = local_d8,
        (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_count_0269cfe0), lVar8 < (long)puVar2;
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR__OBJC_CLASS___NSString_026cdfe8,PTR_s_stringWithFormat__0269cca8,
                 &cf_selectAttachBgFolder__ld_);
      _objc_retainAutoreleasedReturnValue();
      local_168 = puVar3;
      _NSSelectorFromString();
      local_170 = puVar3;
      _objc_initWeak(auStack_178,local_b0);
      ppuVar6 = &local_1b0;
      local_1b0 = PTR___NSConcreteStackBlock_02578660;
      local_1a8 = 0xc2000000;
      local_1a4 = 0;
      local_1a0 = FUN_0187eeec;
      local_198 = &DAT_02581a90;
      ...
      _class_addMethod(IVar1,local_170,local_180,"v@:@");
      if ((IVar1 & 1) == 0) {
        IVar1 = local_b0;
        (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_class_0269cd60);
        _class_replaceMethod(IVar1,local_170,local_180,"v@:@");
      }
      (*(code *)PTR__objc_msgSend_02578628)
                (local_150,PTR_s_addBtnTitle_target_sel__0269d278,local_160,local_b0,local_170);
