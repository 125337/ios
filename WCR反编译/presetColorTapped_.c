// presetColorTapped: @ 018fd708

/* Function Stack Size: 0x18 bytes */

void WCRefineColorPickerController::presetColorTapped_(ID param_1,SEL param_2,ID param_3)

{
  ...
  IVar1 = local_18;
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_presetColors_026b8898);
