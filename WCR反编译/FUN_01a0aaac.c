// FUN_01a0aaac @ 01a0aaac

void FUN_01a0aaac(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if ((local_28 == 0) || (pcVar1 == (char *)0x0)) {
    ...
    if (lVar2 == 0) {
      _objc_storeStrong(&local_58,&cf_wcrAutoReplySheet);
    }
    pcVar1 = local_48;
    _objc_alloc();
    ...
    (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_initWithTitle__0269d2f8,local_e8);
    local_60 = pcVar1;
