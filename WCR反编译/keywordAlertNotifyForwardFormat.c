// keywordAlertNotifyForwardFormat @ 01fe0e18

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::keywordAlertNotifyForwardFormat(ID param_1,SEL param_2)

{
  ...
  if (((IVar3 & 1) == 0) ||
     (IVar3 = local_38, (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_length_0269cca0),
     IVar3 == 0)) {
    _objc_storeStrong(&local_38,local_30);
    IVar1 = local_28;
    IVar3 = local_38;
    SVar2 = local_20;
    _cmdString();
