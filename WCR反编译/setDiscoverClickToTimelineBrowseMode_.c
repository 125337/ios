// setDiscoverClickToTimelineBrowseMode: @ 02061388

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setDiscoverClickToTimelineBrowseMode_(ID param_1,SEL param_2,long_long param_3)

{
  ...
  if (((long)param_3 < 0) || (local_28 = param_3, 1 < (long)param_3)) {
    local_28 = 1;
  }
  local_20 = param_2;
  local_18 = param_1;
