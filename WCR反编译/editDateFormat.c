// editDateFormat @ 01ec6388

/* Function Stack Size: 0x10 bytes */

void WCRefineToDoListSettingsViewController::editDateFormat(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_confirmDateFormat_026c7ac0);
