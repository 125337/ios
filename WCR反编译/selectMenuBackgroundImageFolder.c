// selectMenuBackgroundImageFolder @ 01b85568

/* Function Stack Size: 0x10 bytes */

void WCRefineMenuBeautifyViewController::selectMenuBackgroundImageFolder(ID param_1,SEL param_2)

{
  ...
  if (pcVar6 == (char *)0x0) {
    ...
    for (local_170 = (undefined *)0x0; puVar3 = local_170, puVar4 = local_f0,
      ...
      local_1ac = 0;
      local_1a8 = FUN_01b85d24;
      local_1a0 = &DAT_02589c48;
      local_188 = puVar4;
      (*(code *)PTR__objc_retain_02578638)();
      local_198 = puVar3;
      _objc_retainBlock();
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_168,PTR_s_addBtnTitle_target_sel__0269d278,&cf_e_eN9Y,local_b0,
               PTR_s_showCreateMenuImageFolderDialog_026bfd48);
    (*(code *)PTR__objc_msgSend_02578628)
