// toggleMainFrameCornerEnabled: @ 01a79854

/* Function Stack Size: 0x18 bytes */

void WCRefineGlobalCornerSettingsViewController::toggleMainFrameCornerEnabled_
...

{
  ...
  local_30 = pcVar2;
  (*(code *)PTR__objc_msgSend_02578628)
            (pcVar2,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_zT_T,local_18,0);
  (*(code *)PTR__objc_msgSend_02578628)
