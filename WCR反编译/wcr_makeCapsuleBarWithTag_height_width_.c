// wcr_makeCapsuleBarWithTag:height:width: @ 01f91c00

/* Function Stack Size: 0x28 bytes */

ID WCRefineVoicePackPickerViewController::wcr_makeCapsuleBarWithTag_height_width_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_78 / 2.0,local_60,PTR_s_wcr_addFrostToFloatBar_cornerRad_026c98c8,local_88);
  puVar1 = local_88;
  ...
  (*(code *)PTR__objc_release_02578630)(puVar1);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_b8,PTR_s_setIdentifier__026a7358,&cf_wcrVPFloatBarWidth);
