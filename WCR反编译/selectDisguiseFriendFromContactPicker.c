// selectDisguiseFriendFromContactPicker @ 01cba98c

/* Function Stack Size: 0x10 bytes */

void WCRefinePrivateFriendViewController::selectDisguiseFriendFromContactPicker
...

{
  ...
  local_a8 = 0xc2000000;
  local_a4 = 0;
  local_a0 = FUN_01cbacbc;
  local_98 = &DAT_0257a7d0;
  _objc_copyWeak(auStack_90,auStack_48);
  (*(code *)PTR__objc_msgSend_02578628)
            (puVar2,PTR_s_presentOfficialContactPickerFrom_026ac950,IVar1,&cf__Ob_YS,puVar3,
             &local_b0);
