// FUN_00fc0ba8 @ 00fc0ba8

void FUN_00fc0ba8(undefined8 param_1)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = &cf_https___pan_baidu_com_s_15PaUoYLK3LRLevpfO7JmmQ_pwd_82qd;
  (*(code *)PTR__objc_msgSend_02578628)
            (&cf_https___pan_baidu_com_s_15PaUoYLK3LRLevpfO7JmmQ_pwd_82qd,
             PTR_s_stringByAddingPercentEncodingWit_0269d900);
  _objc_retainAutoreleasedReturnValue();
  local_68 = pcVar2;
  if (pcVar2 == (cfstringStruct *)0x0) {
    local_68 = &cf_https___pan_baidu_com_s_15PaUoYLK3LRLevpfO7JmmQ_pwd_82qd;
  }
