// homeCustomGroupNames @ 014bc8b8

/* Function Stack Size: 0x10 bytes */

ID WCRefineScheduledTask::homeCustomGroupNames(ID param_1,SEL param_2)
  ...
  if (local_140 != (undefined *)0x0) {
    ...
    do {
      do {
        ...
        local_c8 = lVar5;
        (*(code *)PTR__objc_msgSend_02578628)(lVar5,PTR_s_name_0269d828);
        _objc_retainAutoreleasedReturnValue();
        lVar3 = lVar5;
        FUN_014b5580();
        _objc_retainAutoreleasedReturnValue();
