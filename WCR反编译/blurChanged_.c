// blurChanged: @ 01a83104

/* Function Stack Size: 0x18 bytes */

void __thiscall
WCRefineGlobalPageBackgroundViewController::blurChanged_
...

{
  ...
  if (IVar3 != 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar2,PTR_s_updateValueButtonWithTag_inConta_026bd7a8,"ibswiftCore.dylib",uVar4);
    (*(code *)PTR__objc_release_02578630)(uVar4);
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_expandedScene_026bd750);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)((double)fVar5,puVar1,PTR_s_setBlur_forScene__026bd7b8);
    (*(code *)PTR__objc_release_02578630)(IVar2);
  }
