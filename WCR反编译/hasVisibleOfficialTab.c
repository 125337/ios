// hasVisibleOfficialTab @ 015206b8

/* Function Stack Size: 0x10 bytes */

bool WCRefineTelegramGroupingStore::hasVisibleOfficialTab(ID param_1,SEL param_2)
  ...
  if (local_130 != 0) {
    ...
    do {
      do {
        ...
        local_c8 = uVar5;
        (*(code *)PTR__objc_msgSend_02578628)(uVar5,PTR_s_tabId_026a8270);
        _objc_retainAutoreleasedReturnValue();
        uVar3 = uVar5;
        (*(code *)PTR__objc_msgSend_02578628)();
