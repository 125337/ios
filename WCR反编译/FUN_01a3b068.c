// FUN_01a3b068 @ 01a3b068

void FUN_01a3b068(undefined8 param_1)

{
  ...
  if (uVar2 == 0) {
    ...
    uVar3 = local_28;
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_uppercaseString_0269d6c8);
    _objc_retainAutoreleasedReturnValue();
    uVar2 = local_28;
    local_28 = uVar3;
    ...
    if (uVar2 == 8) {
      uVar3 = local_28;
      (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_substringToIndex__0269d6c0,6);
      _objc_retainAutoreleasedReturnValue();
      uVar2 = local_28;
      local_28 = uVar3;
      (*(code *)PTR__objc_release_02578630)(uVar2);
    ...
    if (uVar2 == 6) {
      ...
      local_38 = puVar1;
      (*(code *)PTR__objc_msgSend_02578628)
                (local_28,PTR_s_stringByTrimmingCharactersInSet__0269d0c0,puVar1);
      _objc_retainAutoreleasedReturnValue();
      uVar3 = uVar2;
      (*(code *)PTR__objc_msgSend_02578628)();
      (*(code *)PTR__objc_release_02578630)(uVar2);
