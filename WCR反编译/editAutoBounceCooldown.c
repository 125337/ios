// editAutoBounceCooldown @ 01de1374

/* Function Stack Size: 0x10 bytes */

void WCRefineSmallSignalSettingsViewController::editAutoBounceCooldown(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_stringWithFormat__0269cca8,&cf__lu);
    _objc_retainAutoreleasedReturnValue();
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
               PTR_s_handleAutoBounceCooldownInput__026c5850);
