// presentPhotoPicker @ 01aa15e0

/* Function Stack Size: 0x10 bytes */

void WCRGroupAvatarPickerCoordinator::presentPhotoPicker(ID param_1,SEL param_2)

{
  ...
  if (((ulong)puVar1 & 1) == 0) {
    ...
    IVar2 = local_28;
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_presenter_0269fb78);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)();
