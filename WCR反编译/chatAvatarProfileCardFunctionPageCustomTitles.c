// chatAvatarProfileCardFunctionPageCustomTitles @ 0200a96c

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::chatAvatarProfileCardFunctionPageCustomTitles(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineProfileCardActionCatalog_026ced78,
             PTR_s_normalizedCustomTitlesFromSavedT_026c3548,local_30);
  _objc_retainAutoreleasedReturnValue();
  local_38 = puVar3;
