// customTitleConfirm: @ 01ca5c64

/* Function Stack Size: 0x18 bytes */

void WCRefinePluginManagementViewController::customTitleConfirm_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (pcVar1 == (cfstringStruct *)0x0) {
    ...
    if (pcVar1 == (cfstringStruct *)0x0) {
      _objc_storeStrong(local_50,&cf_WCRefine);
    }
