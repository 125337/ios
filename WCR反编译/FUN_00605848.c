// FUN_00605848 @ 00605848

void FUN_00605848(ulong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (uVar2 == 0) {
    ...
    if (((ulong)puVar1 & 1) == 0) {
      ...
      puVar1 = local_70;
      (*(code *)PTR__objc_msgSend_02578628)(local_70,PTR_s_redEnvelopSkipGroupList_026a5ff0);
      _objc_retainAutoreleasedReturnValue();
      puVar4 = puVar1;
      (*(code *)PTR__objc_msgSend_02578628)();
      local_e8 = puVar4;
      ...
      if ((uVar2 & 1) == 0) {
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_70,PTR_s_setRedEnvelopSkipGroupList__026a6008,local_78);
        (*(code *)PTR__objc_msgSend_02578628)
                  (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__sQNbdk__S);
      }
      else {
        puVar1 = local_78;
