// exportPaths: @ 019a84c8

/* Function Stack Size: 0x18 bytes */

void WCRefineFileManagerViewController::exportPaths_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (puVar4 == (undefined1 *)0x0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_lgS_QveN);
  }
  else {
    puVar4 = local_d0;
    (*(code *)PTR__objc_msgSend_02578628)(local_d0,PTR_s_count_0269cfe0);
    if ((puVar4 == (undefined1 *)((long)&MACH_HEADER.magic + 1)) && ((local_d1 & 1) == 0)) {
      (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_shareItemsAtPaths__026ba778,local_d0);
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_exportPathsAsZip__026ba780,local_d0);
    }
  }
