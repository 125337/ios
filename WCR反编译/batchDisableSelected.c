// batchDisableSelected @ 01b39d4c

/* Function Stack Size: 0x10 bytes */

void WCRefineKeywordAlertKeywordsViewController::batchDisableSelected(ID param_1,SEL param_2)

{
  ...
  if (param_1 != 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(puVar4,PTR_s_stringWithFormat__0269cca8,&cf___P_u);
    _objc_retainAutoreleasedReturnValue();
