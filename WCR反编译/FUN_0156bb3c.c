// FUN_0156bb3c @ 0156bb3c

byte FUN_0156bb3c(undefined8 param_1)

{
  ...
  if (local_20 == 0) {
    ...
    if (lVar1 == 0) {
      ...
      _objc_retainAutoreleasedReturnValue();
      local_38 = puVar3;
      (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_avatarFrameSpecialUserEnabled_0269e028);
      if (((ulong)puVar3 & 1) == 0) {
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_38,PTR_s_setAvatarFrameSpecialUserEnabled_026b06d8,1);
      }
      puVar3 = PTR__OBJC_CLASS___NSMutableOrderedSet_026ce340;
      puVar4 = local_38;
      (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_avatarFrameSpecialUserList_0269e030);
      _objc_retainAutoreleasedReturnValue();
      local_78 = puVar4;
      ...
      if (((ulong)puVar3 & 1) == 0) {
        ...
        _objc_retainAutoreleasedReturnValue();
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_38,PTR_s_setAvatarFrameSpecialUserList__026b06e0);
        (*(code *)PTR__objc_release_02578630)(puVar3);
      }
      _CFNotificationCenterGetDarwinNotifyCenter();
      _CFNotificationCenterPostNotification();
      puVar3 = PTR_WCRefineAvatarFrameSpecialUserDetailViewController_026ceda8;
      _objc_alloc();
      (*(code *)PTR__objc_msgSend_02578628)();
