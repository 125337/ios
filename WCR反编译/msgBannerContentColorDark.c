// msgBannerContentColorDark @ 020eaa20

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::msgBannerContentColorDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setMsgBannerContentColorDark__026c01c0,puVar2);
    puVar2 = local_40;
