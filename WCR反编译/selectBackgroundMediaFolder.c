// selectBackgroundMediaFolder @ 01aecbfc

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x10 bytes */

void WCRefineHomeAvatarStripSettingsViewController::selectBackgroundMediaFolder
...

{
  ...
  if (pcVar2 != (char *)0x0) {
    ...
    IVar3 = local_28;
    local_40 = pcVar2;
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_backgroundMediaFolders_026be538);
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_e__PgeN9Y,local_28,
               PTR_s_createBackgroundMediaFolder_026be548);
    (*(code *)PTR__objc_msgSend_02578628)
