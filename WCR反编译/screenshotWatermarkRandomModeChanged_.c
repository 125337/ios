// screenshotWatermarkRandomModeChanged: @ 017ff42c

/* Function Stack Size: 0x18 bytes */

void WCRefineAssistFunctionViewController::screenshotWatermarkRandomModeChanged_
...

{
  ...
  local_38 = puVar2;
  (*(code *)PTR__objc_msgSend_02578628)
            (puVar2,PTR_s_setScreenshotWatermarkRandomMode_026b5a88,local_30);
  if (local_30 == 1) {
