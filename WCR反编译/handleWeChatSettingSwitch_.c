// handleWeChatSettingSwitch: @ 01d7cf0c

/* Function Stack Size: 0x18 bytes */

void WCRefineSearchSettingsViewController::handleWeChatSettingSwitch_
                  ...
                  if ((uVar3 & 1) != 0) {
                    ...
                    if (uVar3 != 0) {
                      ...
                      if ((uVar3 & 1) != 0) {
                        uVar4 = local_98;
                        (*(code *)PTR__objc_msgSend_02578628)
                                  (local_98,PTR_s_objectForKeyedSubscript__0269d098,&cf_settingKey);
                        _objc_retainAutoreleasedReturnValue();
                        uVar3 = local_40;
                        local_40 = uVar4;
                        (*(code *)PTR__objc_release_02578630)(uVar3);
