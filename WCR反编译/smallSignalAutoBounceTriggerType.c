// smallSignalAutoBounceTriggerType @ 02181f90

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::smallSignalAutoBounceTriggerType(ID param_1,SEL param_2)

{
  ...
  local_28 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_WCRefineSmallSignalAutoBounceTriggerType);
  _objc_retainAutoreleasedReturnValue();
  local_30 = param_1;
  if (param_1 == 0) {
    local_40 = 0;
  ...
  if ((local_30 == 0) ||
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar1,PTR_s_setObject_forKey__026ca9e8,puVar2,
               &cf_WCRefineSmallSignalAutoBounceTriggerType);
