...
void WCRefineFakeLocationHistoryStore::saveItems_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (lVar2 == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_removeObjectForKey__0269d700,&cf_wcr_fakeLocationHistory);
  }
  else {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_setObject_forKeyedSubscript__0269d248,local_28,
               &cf_wcr_fakeLocationHistory);
  }
  (*(code *)PTR__objc_msgSend_02578628)
