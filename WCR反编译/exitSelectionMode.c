// exitSelectionMode @ 01eed5ec

/* Function Stack Size: 0x10 bytes */

void WCRefineToDoHTMLRepositoryViewController::exitSelectionMode(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_setSelectionMode__026c7ea8,0);
  IVar1 = param_1;
