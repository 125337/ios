// FUN_00610904 @ 00610904

byte FUN_00610904(long param_1,undefined8 param_2,byte param_3,undefined8 *param_4,
...

{
  ...
  if (pcVar1 == (cfstringStruct *)0x0) {
    ...
    if ((local_30 == 0) || (local_30 == 1)) {
      ...
      if (((ulong)pcVar1 & 1) == 0) {
        ...
        if (((ulong)pcVar1 & 1) == 0) {
          ...
          _objc_storeStrong(&local_a0,local_1e8);
          (*(code *)PTR__objc_release_02578630)(pcVar1);
          pcVar1 = local_80;
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_80,PTR_s_avatarFrameChatPageOtherNightPat_0269df28);
          ...
          _objc_storeStrong(&local_a8,local_200);
          (*(code *)PTR__objc_release_02578630)(pcVar1);
          local_b0 = local_80;
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_80,PTR_s_avatarFrameChatPageOtherRandomMo_0269df48);
          ...
          _objc_storeStrong(&local_a0,local_190);
          (*(code *)PTR__objc_release_02578630)(pcVar1);
          pcVar1 = local_80;
          (*(code *)PTR__objc_msgSend_02578628)
          ...
          _objc_storeStrong(&local_a8,local_1a8);
          (*(code *)PTR__objc_release_02578630)(pcVar1);
          local_b0 = local_80;
          (*(code *)PTR__objc_msgSend_02578628)
    ...
    pcVar2 = local_38;
    FUN_00611dc4(local_38,local_a0,local_a8);
    _objc_retainAutoreleasedReturnValue();
    pcVar1 = local_a0;
    local_a0 = pcVar2;
    (*(code *)PTR__objc_release_02578630)(pcVar1);
    ...
    if (local_78 != (undefined8 *)0x0) {
      ...
      local_2b0 = pcVar1;
      if (pcVar1 == (cfstringStruct *)0x0) {
        local_2b0 = *(cfstringStruct **)PTR____NSArray0___02578280;
      }
      _objc_retainAutorelease();
      *local_78 = local_2b0;
      (*(code *)PTR__objc_release_02578630)(pcVar1);
