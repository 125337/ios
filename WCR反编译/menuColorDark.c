// menuColorDark @ 020ec2d0

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::menuColorDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    _objc_retainAutoreleasedReturnValue();
    local_40 = puVar3;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setMenuColorDark__026bfd38,puVar3);
    puVar3 = local_40;
