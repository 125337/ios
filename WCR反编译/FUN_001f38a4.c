// FUN_001f38a4 @ 001f38a4

void FUN_001f38a4(void)

{
  ...
  local_30 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(puVar5,PTR_s_toolbarCornerBorderColorLight_026a0358);
  _objc_retainAutoreleasedReturnValue();
  local_d8 = local_30;
  local_38 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_toolbarCornerBorderColorDark_026a0360);
  _objc_retainAutoreleasedReturnValue();
  local_50[0] = local_d8;
