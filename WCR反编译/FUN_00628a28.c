// FUN_00628a28 @ 00628a28

void FUN_00628a28(ulong param_1,undefined8 param_2,undefined8 param_3)
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if (uVar4 != 0) {
        ...
        if (local_14c != 0) goto LAB_00629624;
      }
      uVar3 = local_148;
        ...
        if (local_3f0 != 0) {
          ...
          do {
            do {
              ...
              if (local_14c != 0) goto LAB_006295f4;
...
LAB_006290d4:
      ...
      if (local_14c == 0) goto LAB_006290d4;
    }
    ...
    if (local_2b0 != 0) {
      ...
      do {
        do {
          ...
          if (local_14c != 0) goto LAB_00628e98;
...
LAB_00628e98:
    ...
    if (local_14c == 0) goto LAB_00628c5c;
  }
