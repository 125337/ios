// wcrGrouping_tableView:heightForFooterInSection: @ 0039bf70

/* Function Stack Size: 0x20 bytes */

double __thiscall
WCRefineHomeSessionGroupingHook::wcrGrouping_tableView_heightForFooterInSection_
...

{
  ...
  if (bVar2) {
    ...
    if (bVar2) goto LAB_0039c168;
  }
  puVar1 = PTR_s_wcrGrouping_tableView_heightForF_026a28e0;
  IVar4 = local_20;
  (*(code *)PTR__objc_msgSend_02578628)
