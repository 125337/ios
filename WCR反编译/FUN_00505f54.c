// FUN_00505f54 @ 00505f54

void FUN_00505f54(undefined8 param_1,undefined8 param_2,byte param_3)

{
  ...
  local_20 = param_2;
  local_18 = param_1;
  (*DAT_028cafc0)(param_1,param_2,param_3 & 1);
  ...
  if (((ulong)puVar2 & 1) != 0) {
    puVar1 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_enabled_0269db80);
    local_58 = 0;
    if (((ulong)puVar1 & 1) != 0) {
      puVar1 = local_30;
      (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_titleLongPressLockEnabled_026a4638);
  ...
  if (((local_58 & 1) != 0) || (((ulong)puVar2 & 1) != 0)) {
