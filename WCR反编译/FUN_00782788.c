// FUN_00782788 @ 00782788

byte FUN_00782788(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if ((local_6c & 1) == 0) {
    lVar4 = local_20;
    (*DAT_028cc9e8)(local_20,local_28,local_30,local_38);
