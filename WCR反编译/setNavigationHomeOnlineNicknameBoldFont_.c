// setNavigationHomeOnlineNicknameBoldFont: @ 02071944

/* Function Stack Size: 0x14 bytes */

void WCRefineConfig::setNavigationHomeOnlineNicknameBoldFont_(ID param_1,SEL param_2,bool param_3)
