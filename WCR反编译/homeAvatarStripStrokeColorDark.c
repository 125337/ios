// homeAvatarStripStrokeColorDark @ 02160438

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::homeAvatarStripStrokeColorDark(ID param_1,SEL param_2)

{
  ...
  if ((IVar2 & 1) != 0) {
    ...
    if (bVar1) goto LAB_02160610;
  }
  puVar3 = PTR__OBJC_CLASS___UIColor_026cdf78;
  (*(code *)PTR__objc_msgSend_02578628)
            (0x3fd6666666666666,0x3ff0000000000000,PTR__OBJC_CLASS___UIColor_026cdf78,
