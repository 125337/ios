// sliderContainerForTag:min:max:value: @ 01e1d6ac

/* WARNING: Removing unreachable block (ram,0x01e1dd9c) */
/* Function Stack Size: 0x30 bytes */

ID WCRefineSuperFloatSettingsViewController::sliderContainerForTag_min_max_value_
...

{
  ...
  local_d9 = local_38 == (undefined *)0x11941 || local_38 == &DAT_00011950;
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_setContinuous__026b4d68,local_d9);
  ...
  _objc_retainAutoreleasedReturnValue();
  local_e8 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_setThumbImage_forState__026b4d78,puVar1,0);
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_setThumbImage_forState__026b4d78,local_e8,1);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_sizeSliderChanged__026c5f00,0x1000);
  if ((local_d9 & 1) != 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
               PTR_s_sizeSliderEnded__026c5f08,0x40);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
               PTR_s_sizeSliderEnded__026c5f08,0x80);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
               PTR_s_sizeSliderEnded__026c5f08,0x100);
  }
  ...
  local_f0 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_setTag__026caa80,local_38 + 0x167c4);
  puVar1 = local_f0;
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(local_f0,PTR_s_setTextColor__026caa98);
  (*(code *)PTR__objc_release_02578630)(puVar1);
  IVar3 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)
            (local_58,local_28,PTR_s_sliderDisplayTextForTag_value__026c5ef8,local_38);
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(local_f0,PTR_s_setText__026caa88);
  (*(code *)PTR__objc_release_02578630)(IVar3);
  (*(code *)PTR__objc_msgSend_02578628)(local_f0,PTR_s_setUserInteractionEnabled__026caad8,0);
  (*(code *)PTR__objc_msgSend_02578628)(local_90,PTR_s_addSubview__026ca4c0,local_f0);
  puVar1 = local_90;
