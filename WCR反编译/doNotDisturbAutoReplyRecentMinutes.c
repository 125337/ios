// doNotDisturbAutoReplyRecentMinutes @ 01ff45a8

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::doNotDisturbAutoReplyRecentMinutes(ID param_1,SEL param_2)

{
  ...
  if ((long)local_60 < 2) {
    local_60 = (undefined *)((long)&MACH_HEADER.magic + 1);
  }
  _objc_storeStrong(&local_30);
  _objc_storeStrong(&local_28,0);
  return (long_long)local_60;
}
