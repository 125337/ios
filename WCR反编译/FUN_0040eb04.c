// FUN_0040eb04 @ 0040eb04

void FUN_0040eb04(undefined8 param_1)

{
  ...
  if (uVar1 == 0) {
    ...
    if (local_280 != 0) {
      ...
      do {
        do {
          ...
          uVar6 = *(ulong *)(local_1a8 + local_288 * 8);
          local_170 = uVar6;
          (*(code *)PTR__objc_msgSend_02578628)
                    (uVar6,PTR_s_componentsSeparatedByCharactersI_0269d1a8,local_158);
          _objc_retainAutoreleasedReturnValue();
          ...
          local_2d0 = uVar6;
          (*(code *)PTR__objc_msgSend_02578628)
                    (uVar6,PTR_s_countByEnumeratingWithState_obje_0269cd58,auStack_208,auStack_128,
                     0x10);
          if (local_2d0 != 0) {
            lVar7 = *local_1f8;
            local_2d8 = 0;
            do {
              do {
                if (*local_1f8 - lVar7 != 0) {
                  _objc_enumerationMutation(*local_1f8 - lVar7,uVar6);
                }
                lVar8 = *(long *)(local_200 + local_2d8 * 8);
                local_1c8 = lVar8;
                FUN_0040494c();
                _objc_retainAutoreleasedReturnValue();
                local_210 = lVar8;
                ...
                if (lVar8 != 0) {
                  (*(code *)PTR__objc_msgSend_02578628)
                            (local_1c0,PTR_s_addObject__0269d180,local_210);
                }
              ...
              local_2d0 = uVar6;
              (*(code *)PTR__objc_msgSend_02578628)
                        (uVar6,PTR_s_countByEnumeratingWithState_obje_0269cd58,auStack_208,
                         auStack_128,0x10);
              local_2d8 = 0;
            } while (local_2d0 != 0);
          }
          ...
          puVar2 = local_1c0;
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_1c0,PTR_s_componentsJoinedByString__0269d140,&cf_space_s_);
          _objc_retainAutoreleasedReturnValue();
    ...
    pcVar3 = local_168;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_168,PTR_s_componentsJoinedByString__0269d140,&cf_newline_s_);
    _objc_retainAutoreleasedReturnValue();
    pcVar4 = pcVar3;
    FUN_0040494c();
    _objc_retainAutoreleasedReturnValue();
