// setThemeBoxOperateViewAlpha @ 01c2061c

/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefineMomentsViewController::setThemeBoxOperateViewAlpha
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleThemeBoxOperateViewAlphaIn_026c1498);
