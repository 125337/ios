// clearInlineHTMLEditor @ 01efb21c

/* Function Stack Size: 0x10 bytes */

void WCRefineToDoListWebSettingsViewController::clearInlineHTMLEditor(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR__OBJC_CLASS___UIAlertController_026ce178,
             PTR_s_alertControllerWithTitle_message_0269dc00,&cf_nzz,&cf_nx_nzzS_MR_hVQ_TNORdNxN_0);
