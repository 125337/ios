// setHomeGroupingChatRoomDefaultName: @ 020043f0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setHomeGroupingChatRoomDefaultName_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (pcVar4 == (cfstringStruct *)0x0) {
    _objc_storeStrong(&local_38,&cf__J);
  }
  IVar2 = local_30;
  pcVar4 = local_38;
  SVar5 = local_20;
