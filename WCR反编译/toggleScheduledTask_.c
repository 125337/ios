// toggleScheduledTask: @ 018a9c6c

/* Function Stack Size: 0x18 bytes */

void WCRefineChatRoomFunctionViewController::toggleScheduledTask_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((uVar1 & 1) == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx,local_18,
               PTR_s_confirmEnableScheduledTask_026b7828);
