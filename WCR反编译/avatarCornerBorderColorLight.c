// avatarCornerBorderColorLight @ 020b6290

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::avatarCornerBorderColorLight(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar3;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setAvatarCornerBorderColorLight__026b62b8,puVar3);
    puVar3 = local_40;
