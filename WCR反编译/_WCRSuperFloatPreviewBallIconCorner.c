// _WCRSuperFloatPreviewBallIconCorner @ 01639d7c

void _WCRSuperFloatPreviewBallIconCorner(undefined8 param_1)

{
  ...
  if (((ulong)puVar1 & 1) == 0) {
    ...
    FUN_01639cc4();
    _objc_retainAutoreleasedReturnValue();
    pcVar2 = &cf_previewBallIconCorner_;
    local_48 = puVar1;
