// setAvatarFrameSpecialUserConfigs: @ 020beccc

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setAvatarFrameSpecialUserConfigs_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (((uVar3 & 1) == 0) ||
     ...
     uVar3 == 0)) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_removeObjectForKey__0269d700,&cf_avatarFrameSpecialUserConfigs);
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_class_0269cd60);
    (*(code *)PTR__objc_msgSend_02578628)();
    local_34 = 1;
  }
    ...
    if (puVar2 == (undefined *)0x0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (IVar1,PTR_s_setObject_forKey__026ca9e8,puVar2,&cf_avatarFrameSpecialUserConfigs);
