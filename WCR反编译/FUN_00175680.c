// FUN_00175680 @ 00175680

void FUN_00175680(long param_1)
  ...
  if (lVar3 == 0) {
    ...
    *(long *)(lVar3 + 0x18) = *(long *)(lVar3 + 0x18) + 1;
    ...
    if (lVar3 == 0) {
      local_40 = 0;
      local_48 = 0;
      FUN_00174c1c(local_30,&local_48);
      _objc_unsafeClaimAutoreleasedReturnValue();
      _objc_storeStrong(&local_40,local_48);
      _objc_storeStrong(*(long *)(*(long *)(param_1 + 0x28) + 8) + 0x28,local_40);
    ...
    if ((local_74 & 1) == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
      FUN_001744e4(local_30,0,*(undefined8 *)(*(long *)(*(long *)(param_1 + 0x28) + 8) + 0x28));
      local_34 = 1;
    }
  }
