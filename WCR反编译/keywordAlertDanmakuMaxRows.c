// keywordAlertDanmakuMaxRows @ 01fdd3d8

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::keywordAlertDanmakuMaxRows(ID param_1,SEL param_2)

{
  ...
  puVar1 = local_28;
  if (((long)local_38 < 1) || (5 < (long)local_38)) {
    local_38 = (undefined *)((long)&MACH_HEADER.magic + 3);
    puVar4 = PTR__OBJC_CLASS___NSNumber_026ce038;
    (*(code *)PTR__objc_msgSend_02578628)
