// WCRefineToDo_tableView:willBeginEditingRowAtIndexPath: @ 007f70a8

/* Function Stack Size: 0x20 bytes */

void WCRefineToDoHook::WCRefineToDo_tableView_willBeginEditingRowAtIndexPath_
...

{
  ...
  if (((IVar2 & 1) == 0) || (local_28 != local_38)) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_WCRefineToDo_tableView_willBegin_026a88a0,local_28,local_30);
  }
  else {
    IVar3 = local_28;
    ...
    if (IVar4 != IVar3) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (IVar1,PTR_s_WCRefineToDo_tableView_willBegin_026a88a0,IVar2);
