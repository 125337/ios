// handleChatSinkValueButtonTapped: @ 01b49ebc

/* Function Stack Size: 0x18 bytes */

void WCRefineLayoutFunctionViewController::handleChatSinkValueButtonTapped_
...

{
  ...
  IVar3 = local_18;
  local_38 = pcVar1;
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_chatSinkValueForTarget__026bf530,local_30);
    ...
    if (local_30 == 0xb) {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_58,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
                 PTR_s_handleChatRoomSinkInput__026bf558);
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_58,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
                 PTR_s_handlePrivateChatSinkInput__026bf560);
    }
