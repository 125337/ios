// FUN_000f5fa0 @ 000f5fa0

void FUN_000f5fa0(undefined8 param_1,undefined8 param_2)
    ...
    if (local_168 != 0) {
      ...
      do {
        do {
          ...
          if ((uVar6 & 1) != 0) {
            uVar6 = local_d8;
            _objc_getAssociatedObject(local_d8,&DAT_028c83aa);
            _objc_retainAutoreleasedReturnValue();
            local_121 = 1;
            bVar1 = uVar6 != 0;
            local_120 = uVar6;
    ...
    if (local_d0 == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (puVar3,PTR_s_initWithTarget_action__026ca718,local_b0,
                 PTR_s_WCRefine_onChatTopBarSearchButto_0269e940);
      local_130 = puVar3;
      (*(code *)PTR__objc_msgSend_02578628)
      ...
      _objc_retainAutoreleasedReturnValue();
      _objc_setAssociatedObject(puVar3,&DAT_028c83aa,puVar4,1);
