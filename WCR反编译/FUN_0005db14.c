// FUN_0005db14 @ 0005db14

byte FUN_0005db14(undefined8 param_1)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    if (local_68 == 0x7fffffffffffffff) {
      ...
      _objc_retainAutoreleasedReturnValue();
      local_70 = uVar2;
      (*(code *)PTR__objc_msgSend_02578628)(uVar2,PTR_s_caseInsensitiveCompare__0269db48,&cf__wcrmy)
      ;
      if (uVar2 == 0) {
        ...
        if (((ulong)puVar1 & 1) == 0) {
          (*(code *)PTR__objc_msgSend_02578628)
                    (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__g_T_uy__YS);
        }
        else {
          puVar1 = local_98;
          (*(code *)PTR__objc_msgSend_02578628)(local_98,PTR_s_isLocked_0269db88);
          if (((ulong)puVar1 & 1) == 0) {
            (*(code *)PTR__objc_msgSend_02578628)
                      (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_y__YS_>f_y);
          }
          else {
            uVar2 = local_78;
