// packOrderMutable @ 0107da48

/* Function Stack Size: 0x10 bytes */

ID WCRefineLocalEmoticonStore::packOrderMutable(ID param_1,SEL param_2)

{
  ...
  if (DAT_028e3260 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_objectForKeyedSubscript__0269d098,&cf_packOrder);
    _objc_retainAutoreleasedReturnValue();
    ...
    _objc_storeStrong(&DAT_028e3260,local_80);
    if (bVar1) {
