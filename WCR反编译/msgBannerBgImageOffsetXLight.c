// msgBannerBgImageOffsetXLight @ 020e53c0

/* Function Stack Size: 0x10 bytes */

double __thiscall
WCRefineConfig::msgBannerBgImageOffsetXLight(WCRefineConfig *this,ID param_1,SEL param_2)

{
  ...
  if (puVar3 == (undefined *)0x0) {
    puVar3 = PTR_s_msgBannerBgImageOffsetX_026ca368;
