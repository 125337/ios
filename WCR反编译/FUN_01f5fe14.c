// FUN_01f5fe14 @ 01f5fe14

/* WARNING: Type propagation algorithm not settling */

void FUN_01f5fe14(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (pcVar1 == (char *)0x0) {
    ...
    if (lVar6 != 0) {
      ...
      if (((ulong)pcVar1 & 1) != 0) {
        pcVar7 = &cf_wcrVCSheetDestructive_;
        _NSSelectorFromString();
        uVar5 = local_50;
        ppuVar8 = &local_e8;
