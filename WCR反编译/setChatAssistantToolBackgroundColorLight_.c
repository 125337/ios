// setChatAssistantToolBackgroundColorLight: @ 0210caa4

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setChatAssistantToolBackgroundColorLight_(ID param_1,SEL param_2,ID param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_setObject_forKey__026ca9e8,local_38,
             &cf_chatAssistantToolBackgroundColorLight);
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_class_0269cd60);
  (*(code *)PTR__objc_msgSend_02578628)();
