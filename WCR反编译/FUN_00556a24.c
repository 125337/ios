// FUN_00556a24 @ 00556a24

void FUN_00556a24(undefined8 param_1)

{
  ...
  local_38 = pcVar1;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_momentsFakeLikeCount_026a4e70);
  if ((long)pcVar1 < 1) {
    ...
    if (((ulong)pcVar1 & 1) == 0) {
      pcVar1 = &cf_WCRefineMomentsFakeLikeAdditionsCache;
      FUN_00557784(&cf_WCRefineMomentsFakeLikeAdditionsCache,local_50);
      _objc_retainAutoreleasedReturnValue();
      local_68 = pcVar1;
      ...
      if (pcVar1 == (cfstringStruct *)0x0) {
        pcVar1 = local_38;
        (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_momentsFakeLikeCount_026a4e70);
        FUN_0054cb60();
        _objc_retainAutoreleasedReturnValue();
        local_70 = pcVar1;
        FUN_00557a74(&cf_WCRefineMomentsFakeLikeAdditionsCache,local_50,pcVar1);
