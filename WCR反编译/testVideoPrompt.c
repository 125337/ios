// testVideoPrompt @ 017e7eec

/* Function Stack Size: 0x10 bytes */

void WCRefineAISettingsViewController::testVideoPrompt(ID param_1,SEL param_2)

{
  ...
  local_28 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_isVideoProviderConfigured_0269d390);
  if (((ulong)puVar1 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_HQ_bS_MR_jWMn_);
    local_2c = 1;
  }
  else {
    ...
    if (pcVar2 != (char *)0x0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_ub,local_18,
                 PTR_s_confirmVideoTest_026b5588);
