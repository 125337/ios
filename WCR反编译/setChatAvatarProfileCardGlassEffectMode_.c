// setChatAvatarProfileCardGlassEffectMode: @ 0200bcfc

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setChatAvatarProfileCardGlassEffectMode_
...

{
  ...
  if (((long)param_3 < 0) || (local_28 = param_3, 3 < (long)param_3)) {
    local_28 = 0;
  }
  local_20 = param_2;
  local_18 = param_1;
