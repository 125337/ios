// lineMatchesKeyword: @ 0091143c

/* Function Stack Size: 0x18 bytes */

bool LogViewerViewController::lineMatchesKeyword_(ID param_1,SEL param_2,ID param_3)

{
  ...
  IVar1 = local_b8;
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_activeKeywordTokens_026aa1e8);
    ...
    if (lVar3 == 0) {
      ...
      if (local_150 != 0) {
        ...
        do {
          ...
          local_150 = IVar1;
          (*(code *)PTR__objc_msgSend_02578628)
                    (IVar1,PTR_s_countByEnumeratingWithState_obje_0269cd58,auStack_120,auStack_a8,
                     0x10);
          local_158 = 0;
        } while (local_150 != 0);
      }
