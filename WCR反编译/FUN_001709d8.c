// FUN_001709d8 @ 001709d8

void FUN_001709d8(long param_1)
  ...
  if (lVar3 == 0) {
    ...
    *(long *)(lVar3 + 0x18) = *(long *)(lVar3 + 0x18) + 1;
    ...
    if (lVar3 == 0) {
      ...
      local_50 = 0;
      lVar3 = local_30;
      FUN_0016fdac(local_30,&local_50);
      _objc_unsafeClaimAutoreleasedReturnValue(lVar3);
      _objc_storeStrong(&local_48,local_50);
      _objc_storeStrong(*(long *)(*(long *)(param_1 + 0x28) + 8) + 0x28,local_48);
    ...
    if ((local_8c & 1) == 0) {
      if (599 < *(long *)(*(long *)(*(long *)(param_1 + 0x20) + 8) + 0x18)) {
        (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
        FUN_0016f790(local_30,0,&cf_N_e);
      }
      local_40 = 0;
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_invalidate_026ca758);
      FUN_0016f4d8(local_30,0,*(undefined8 *)(*(long *)(*(long *)(param_1 + 0x28) + 8) + 0x28));
      local_40 = 1;
    }
  }
