// FUN_01b21ff8 @ 01b21ff8

void FUN_01b21ff8(ulong param_1)

{
  ...
  if (param_1 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (param_1,PTR_s_respondsToSelector__026ca818,PTR_s_getContactList_contactType__026a2fc8
              );
    if ((param_1 & 1) == 0) {
      puVar1 = *(undefined **)PTR____NSArray0___02578280;
      (*(code *)PTR__objc_retain_02578638)();
      ...
      if (local_398 != (undefined *)0x0) {
        ...
        do {
          do {
            ...
            local_3d8 = puVar2;
            (*(code *)PTR__objc_msgSend_02578628)
                      (puVar2,PTR_s_countByEnumeratingWithState_obje_0269cd58,auStack_2a0,
                       auStack_150,0x10);
              ...
              do {
                do {
                  if (*local_290 - lVar8 != 0) {
                    _objc_enumerationMutation(*local_290 - lVar8,puVar2);
                  }
                  uVar6 = local_1e0;
                  puVar3 = local_1f0;
                  ...
                  (*(code *)PTR__objc_msgSend_02578628)(uVar6,puVar3,uVar10 & 0xffffffff,uVar5);
                  _objc_retainAutoreleasedReturnValue();
                  puVar3 = PTR__OBJC_CLASS___NSArray_026cdfe0;
                  local_2a8 = uVar6;
                  (*(code *)PTR__objc_msgSend_02578628)
                  ...
                  if ((uVar6 & 1) == 0) {
                    ...
                    local_440 = uVar6;
                    (*(code *)PTR__objc_msgSend_02578628)
                              (uVar6,PTR_s_countByEnumeratingWithState_obje_0269cd58,auStack_2f0,
                               auStack_1d0,0x10);
                    if (local_440 != 0) {
                      lVar9 = *local_2e0;
                      local_448 = 0;
                      do {
                        do {
                          ...
                          local_2b0 = uVar10;
                          if ((uVar10 != 0) && (FUN_01b2fe8c(), (uVar10 & 1) != 0)) {
                            uVar10 = local_2b0;
                            FUN_01b22b28(local_2b0,PTR_s_m_nsUsrName_0269d638);
                            _objc_retainAutoreleasedReturnValue();
                            local_2f8 = uVar10;
                            ...
                            if ((uVar10 == 0) ||
                               ((uVar10 = local_2f8,
                                (*(code *)PTR__objc_msgSend_02578628)
                                          (local_2f8,PTR_s_hasSuffix__0269d018,&cf__chatroom),
                                (uVar10 & 1) == 0 ||
                                (puVar3 = local_200,
                                (*(code *)PTR__objc_msgSend_02578628)
