// toggleTopAction @ 01ceced0

/* Function Stack Size: 0x10 bytes */

void WCRefineProfileCardFunctionPageViewController::toggleTopAction(ID param_1,SEL param_2)
  ...
  if ((param_1 == 0) ||
     ((*(code *)PTR__objc_msgSend_02578628)
                (param_1,PTR_s_respondsToSelector__026ca818,
                 PTR_s_setContact_sessionTop_sync__026a2ed8), (param_1 & 1) == 0)) {
    (*(code *)PTR__objc_msgSend_02578628)
    ...
    IVar3 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_currentStateForActionID__026c3a58,_WCRefineProfileCardActionIDTop);
    IVar5 = local_28;
    puVar4 = PTR_s_setContact_sessionTop_sync__026a2ed8;
    bVar2 = ((byte)IVar3 ^ 1) & 1;
    IVar3 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_contact_026a0d10);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(IVar5,puVar4,IVar3,bVar2,1);
