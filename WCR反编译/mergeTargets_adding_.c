// mergeTargets:adding: @ 014b8e60

/* Function Stack Size: 0x20 bytes */

ID WCRefineScheduledTask::mergeTargets_adding_(ID param_1,SEL param_2,ID param_3,ID param_4)
    ...
    do {
      do {
        if (*local_1d0 - lVar3 != 0) {
          _objc_enumerationMutation(*local_1d0 - lVar3,uVar2);
        }
