// editKeywordAlertNotifyForwardSession: @ 01b3f1b8

/* Function Stack Size: 0x18 bytes */

void WCRefineKeywordAlertViewController::editKeywordAlertNotifyForwardSession_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handleKeywordAlertNotifyForwardS_026bf168);
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_showTextFieldWithMaxLen__0269e5e0,0x80);
  pcVar2 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)
