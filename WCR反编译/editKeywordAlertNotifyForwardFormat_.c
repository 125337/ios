// editKeywordAlertNotifyForwardFormat: @ 01b3f550

/* Function Stack Size: 0x18 bytes */

void WCRefineKeywordAlertViewController::editKeywordAlertNotifyForwardFormat_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handleKeywordAlertNotifyForwardF_026bf178);
