// existingBytesPathFromObject:selectors: @ 00f4146c

/* Function Stack Size: 0x20 bytes */

ID WCRefineEmoticonToolsHelper::existingBytesPathFromObject_selectors_
      ...
      do {
        do {
          ...
          if ((IVar3 & 1) == 0) {
            IVar4 = local_b8;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_b8,PTR_s_stringValueFromObject_key__026abfe0,local_c8,local_e0);
          ...
          IVar4 = local_b8;
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_b8,PTR_s_fileExistsWithBytesAtPath__026ac1d8,local_130);
          IVar3 = local_130;
          bVar1 = (IVar4 & 1) != 0;
          if (bVar1) {
            (*(code *)PTR__objc_retain_02578638)();
          ...
          if (local_d4 != 0) goto LAB_00f41718;
