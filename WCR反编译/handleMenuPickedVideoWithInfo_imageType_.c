// handleMenuPickedVideoWithInfo:imageType: @ 01b8b6d8

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x20 bytes */

void WCRefineMenuBeautifyViewController::handleMenuPickedVideoWithInfo_imageType_
...

{
  ...
  if ((local_d0 == 0) ||
    ...
    if (bVar1) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_b0,PTR_s_copyMenuBackgroundImageFromURL_f_026bfe48,local_1b8,local_c8);
    }
    ...
    if (local_200 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          if (local_13c != 3) goto LAB_01b8ba68;
...
LAB_01b8ba68:
    ...
    if (local_e0 == (cfstringStruct *)0x0) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (puVar3,PTR_s_stringWithFormat__0269cca8,&cf_wcr_longmenu_________);
      _objc_retainAutoreleasedReturnValue();
      local_148 = puVar3;
