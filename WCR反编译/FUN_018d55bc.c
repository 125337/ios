// FUN_018d55bc @ 018d55bc

void FUN_018d55bc(undefined8 param_1)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setSeparatorStyle__026a20b0,1);
  uVar6 = 0;
  uVar3 = 0;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_20,PTR_s_setAccessibilityIdentifier__0269ebc0,&cf_WCRChatToolbarSystemTable);
  puVar2 = local_20;
