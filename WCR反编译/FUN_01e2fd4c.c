// FUN_01e2fd4c @ 01e2fd4c

/* WARNING: Type propagation algorithm not settling */

void FUN_01e2fd4c(undefined8 param_1,ulong param_2,undefined8 param_3)

{
  ...
  local_38 = &cf_wcr_sf_catalog_;
  uVar2 = local_30[0];
  (*(code *)PTR__objc_msgSend_02578628)(local_30[0],PTR_s_hasPrefix__0269d320,&cf_wcr_sf_catalog_);
  uVar1 = local_30[0];
  if ((uVar2 & 1) == 0) {
    local_3c = 1;
  }
    ...
    if (1 < uVar1) {
      ...
      (*(code *)PTR__objc_release_02578630)(uVar2);
      (*(code *)PTR__objc_msgSend_02578628)
                (local_18,PTR_s_showCatalogActionsForGroup_item__026c63a0,uVar4,uVar5);
    }
    local_3c = (uint)(1 >= uVar1);
