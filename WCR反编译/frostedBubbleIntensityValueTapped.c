// frostedBubbleIntensityValueTapped @ 01f2ea90

/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefineUIBeautifyViewController::frostedBubbleIntensityValueTapped
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)();
  local_30[0] = pcVar2;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar2,PTR_s_showTextFieldWithMaxLen__0269e5e0,5);
  pcVar2 = local_30[0];
  ...
  (*(code *)PTR__objc_release_02578630)(puVar1);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30[0],PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,local_18,
             PTR_s_alertCancel_026b2910);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30[0],PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_confirmFrostedBubbleIntensityInp_026c87c8);
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_setCurrentAlert__026aa348,local_30[0]);
