// FUN_002b2b04 @ 002b2b04

void FUN_002b2b04(undefined8 param_1)

{
  ...
  if (local_b8 == 0) {
    ...
    if ((uVar3 & 1) != 0) {
      ...
      local_d8[0] = uVar4;
      FUN_002b3020(uVar4,0x7fffffffffffffff);
      uVar3 = local_d8[0];
      ...
      if (local_bc != 0) goto LAB_002b2fc0;
    }
    uVar3 = local_b8;
    ...
    if ((uVar3 == 0) ||
       (uVar4 = local_e0, FUN_002b3020(uVar3,local_e0,0x7fffffffffffffff), uVar3 = local_e0,
       local_e8 = uVar4, uVar4 == 0x7fffffffffffffff)) {
      ...
      if (local_1a8 != 0) {
        ...
        do {
          do {
            ...
            uVar6 = *(ulong *)(local_128 + local_1b0 * 8);
            local_f0 = uVar6;
            FUN_002b2b04();
            _objc_retainAutoreleasedReturnValue();
            local_138 = uVar6;
            ...
            if (local_bc != 0) goto LAB_002b2f5c;
