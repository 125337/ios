// FUN_0073f8a0 @ 0073f8a0

void FUN_0073f8a0(undefined8 param_1)

{
  ...
  if (ppuVar1 == (undefined **)0x0) {
    ...
    if (((ulong)puVar3 & 1) == 0) {
      puVar3 = local_50;
      FUN_0073fdc0(local_50,local_58);
      if (((ulong)puVar3 & 1) == 0) {
        local_140 = local_50;
      }
      else {
      ...
      if (puVar2 == (undefined *)0x0) {
        ...
        for (local_88 = (undefined *)0x0; local_88 < local_78; local_88 = local_88 + 1) {
          puVar3 = local_70;
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_70,PTR_s_objectAtIndexedSubscript__0269cc78,local_88);
          _objc_retainAutoreleasedReturnValue();
          local_90 = puVar3;
          FUN_0073fdc0(puVar3,local_58);
          if (((ulong)puVar3 & 1) == 0) {
            ...
            if (local_80 == (undefined *)0x0) {
              ...
              if (local_88 != (undefined *)0x0) {
                ...
                puVar2 = local_70;
                (*(code *)PTR__objc_msgSend_02578628)
                          (local_70,PTR_s_subarrayWithRange__0269d848,0,local_88);
                _objc_retainAutoreleasedReturnValue();
