// FUN_000f166c @ 000f166c

void FUN_000f166c(undefined8 param_1,ulong param_2,byte param_3)

{
  ...
  local_31 = param_3;
  local_30 = param_2;
  _objc_getAssociatedObject(local_28,&DAT_028c83a5);
  ...
  if ((uVar2 & 1) == 0) {
    ...
    if (local_e8 == local_30) {
      ...
      local_69 = bVar1;
      _objc_setAssociatedObject(uVar2,&DAT_028c83a7,local_f8,1);
      if ((local_69 & 1) != 0) {
