// showProfileBgFolderSelector @ 01ce5620

/* Function Stack Size: 0x10 bytes */

void WCRefineProfileCardBeautifyViewController::showProfileBgFolderSelector(ID param_1,SEL param_2)

{
  ...
  local_b8 = param_2;
  local_b0 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_getWCRefineBackgroundBasePath_026c39f8);
  ...
  for (local_154 = 0; puVar5 = (undefined *)(long)local_154, puVar1 = local_e8,
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_b0,PTR_s_addDynamicMethodForSelector_fold_026b2fa8,puVar5,local_160);
    (*(code *)PTR__objc_msgSend_02578628)
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_150,PTR_s_addBtnTitle_target_sel__0269d278,&cf_R_eeN9Y,local_b0,
