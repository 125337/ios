// setDisableChatAtMePromptEnabled: @ 02090578

/* Function Stack Size: 0x14 bytes */

void WCRefineConfig::setDisableChatAtMePromptEnabled_(ID param_1,SEL param_2,bool param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_removeObjectForKey__0269d700,&cf_abTestChatAtMeReminderEnabled);
