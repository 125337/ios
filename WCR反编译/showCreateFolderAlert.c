// showCreateFolderAlert @ 01f25afc

/* Function Stack Size: 0x10 bytes */

void WCRefineTouchTrailViewController::showCreateFolderAlert(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_R_,local_18,
             PTR_s_confirmCreateFolderFromAlert_026b3128);
