// exportSelectedWatermarks @ 01fb1db0

/* Function Stack Size: 0x10 bytes */

void WCRefineWatermarkLibraryViewController::exportSelectedWatermarks(ID param_1,SEL param_2)

{
  ...
  lVar2 = *(long *)(param_1 + (long)_selectedWatermarksForExport);
  local_20 = param_2;
  local_18 = param_1;
