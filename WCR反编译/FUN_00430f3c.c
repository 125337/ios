// FUN_00430f3c @ 00430f3c

void FUN_00430f3c(undefined8 param_1,undefined8 param_2)
  ...
  if ((uVar2 == 0) || (uVar2 = local_38[0], FUN_0040a974(), (uVar2 & 1) == 0)) {
    ...
    if (((ulong)puVar3 & 1) == 0) {
      ...
      if (((ulong)puVar3 & 1) == 0) {
        ...
        puVar3 = local_48;
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_48,PTR_s_keywordAutoReplyGroupMessagesEna_026a35e0);
        uVar2 = local_38[0];
        if (((ulong)puVar3 & 1) == 0) {
          (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setOn__0269dc80,0);
          (*(code *)PTR__objc_msgSend_02578628)
          ...
          FUN_00430b58(1,uVar2,uVar4 & 0xffffffff);
          puVar3 = PTR_WCRefineHelper_026ce000;
          uVar2 = local_20;
          (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_isOn_0269d560);
          pcVar1 = &cf__;
          if ((uVar2 & 1) == 0) {
            pcVar1 = &cf__sQdk_JvsQ_VY;
          }
