// availablePersonaNameFrom: @ 009b2280

/* Function Stack Size: 0x18 bytes */

ID WCRefineAIStore::availablePersonaNameFrom_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (puVar2 == (undefined *)0x0) {
    _objc_storeStrong(&local_d0,&cf_bvN);
  }
  ...
  IVar3 = local_b8;
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_allPersonas_026aac80);
  _objc_retainAutoreleasedReturnValue();
  local_158 = IVar3;
  ...
  if (((ulong)puVar4 & 1) == 0) {
    ...
    for (local_130 = 2; puVar2 = PTR__OBJC_CLASS___NSString_026cdfe8, local_130 < 100;
      ...
      if (local_124 != 0) goto LAB_009b2684;
    }
