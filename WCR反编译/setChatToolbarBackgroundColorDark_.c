// setChatToolbarBackgroundColorDark: @ 021116a0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setChatToolbarBackgroundColorDark_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (bVar1) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (DAT_02323c70,0x3fd3333333333333,PTR__OBJC_CLASS___UIColor_026cdf78,
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_setObject_forKeyedSubscript__0269d248,puVar3,
             &cf_chatToolbarBackgroundColorDark);
