// FUN_003e42c0 @ 003e42c0

void FUN_003e42c0(undefined8 param_1)
      ...
      do {
        do {
          ...
          if ((uVar5 & 1) == 0) {
            uVar5 = local_d8;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_d8,PTR_s_respondsToSelector__026ca818,PTR_s_UTF8String_026a2e68);
            if ((uVar5 & 1) != 0) {
              uVar3 = local_d8;
              (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_description_026ca5f8);
              _objc_retainAutoreleasedReturnValue();
              uVar5 = local_120;
              local_120 = uVar3;
            ...
            _objc_storeStrong(&local_120,local_d8);
          }
          if ((local_120 != 0) && (uVar5 = local_120, FUN_003e3ed8(), (uVar5 & 1) == 0)) {
