// autoScrollMinVelocitySliderChanged: @ 01a4f5e4

/* Function Stack Size: 0x18 bytes */

void WCRefineGeneralFunctionViewController::autoScrollMinVelocitySliderChanged_
...

{
  ...
  local_68 = (double)(long)(fVar4 / 50.0) * 50.0;
  if (local_68 <= 100.0) {
    local_68 = 100.0;
  }
  if (local_68 <= 2000.0) {
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)
            (IVar1,PTR_s_updateAutoScrollValueLabelInCont_026bcb68,uVar3,0x17322);
  (*(code *)PTR__objc_release_02578630)(puVar2);
