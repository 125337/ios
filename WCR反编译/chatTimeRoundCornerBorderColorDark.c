// chatTimeRoundCornerBorderColorDark @ 020d7698

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::chatTimeRoundCornerBorderColorDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar3;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setChatTimeRoundCornerBorderColo_026b9188,puVar3);
    puVar3 = local_40;
