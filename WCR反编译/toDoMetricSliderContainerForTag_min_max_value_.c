// toDoMetricSliderContainerForTag:min:max:value: @ 01ebf234

/* WARNING: Removing unreachable block (ram,0x01ebf884) */
/* Function Stack Size: 0x30 bytes */

ID WCRefineToDoListSettingsViewController::toDoMetricSliderContainerForTag_min_max_value_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_toDoMetricSliderChanged__026c7890,0x1000);
  ...
  IVar3 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)
            (local_58,local_28,PTR_s_toDoMetricDisplayTextForTag_valu_026c7888,local_38);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_e8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_toDoMetricValueButtonTapped__026c7898,0x40);
