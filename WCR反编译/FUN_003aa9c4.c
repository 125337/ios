// FUN_003aa9c4 @ 003aa9c4

void FUN_003aa9c4(long param_1)

{
  ...
  pcVar1 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_inlineDetailTemplate_026a2dd0);
  _objc_retainAutoreleasedReturnValue();
  pcVar3 = pcVar1;
  ...
  local_68 = 0xc2000000;
  local_64 = 0;
  local_60 = FUN_003aac70;
  local_58 = &DAT_0257c948;
  uVar2 = *(undefined8 *)(param_1 + 0x20);
  (*(code *)PTR__objc_retain_02578638)();
  local_50 = uVar2;
  _objc_copyWeak(auStack_48,param_1 + 0x28);
  FUN_003aa428(&cf_9eQ,&cf_N_uN,pcVar1,0x40,&local_70);
