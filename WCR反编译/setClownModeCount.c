// setClownModeCount @ 0174bc44

/* Function Stack Size: 0x10 bytes */

void ThemeBoxAutoRedeemViewController::setClownModeCount(ID param_1,SEL param_2)

{
  ...
  local_28 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_themeBoxRedeemedCount_026b4098);
  ...
  if (pcVar2 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_48,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx,local_18,
               PTR_s_alertConfirmClownModeCount_026b4188);
