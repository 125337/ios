// FUN_00728f3c @ 00728f3c

void FUN_00728f3c(void)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineScreenshotWatermarkProcessor_026ce900,PTR_s_wcr_bootstrapIfNeeded_026a75b0)
  ;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (puVar1,PTR_s_addObserverForName_object_queue__026ca4b0,
             ...
             &PTR___NSConcreteGlobalBlock_0257f568);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (puVar1,PTR_s_addObserverForName_object_queue__026ca4b0,
             ...
             &PTR___NSConcreteGlobalBlock_0257f588);
  _objc_unsafeClaimAutoreleasedReturnValue(puVar3);
  (*(code *)PTR__objc_release_02578630)(puVar2);
  (*(code *)PTR__objc_release_02578630)(puVar1);
  return;
