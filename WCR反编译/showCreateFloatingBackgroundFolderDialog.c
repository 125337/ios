// showCreateFloatingBackgroundFolderDialog @ 019c4670

/* Function Stack Size: 0x10 bytes */

void WCRefineFloatingTabBarSettingsViewController::showCreateFloatingBackgroundFolderDialog
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_R_,local_18,
             PTR_s_handleCreateFloatingBackgroundFo_026bacd8);
