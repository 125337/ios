// handleContactsRecentAddedSectionDaysInput: @ 01a67188

/* Function Stack Size: 0x18 bytes */

void WCRefineGeneralFunctionViewController::handleContactsRecentAddedSectionDaysInput_
...

{
  ...
  if (pcVar2 != (cfstringStruct *)0x0) {
    ...
    if (pcVar2 == (cfstringStruct *)0x7fffffffffffffff) {
      ...
      puVar5 = (undefined1 *)((long)&local_40[-0x73].field3_0x18 + 6);
      if (puVar5 != (undefined1 *)0x0 && 0xe41 < (long)local_40) {
        puVar5 = (undefined1 *)0xe42;
        local_40 = (cfstringStruct *)0xe42;
      }
      bVar1 = false;
    }
    else {
