// FUN_008b2e78 @ 008b2e78

/* WARNING: Removing unreachable block (ram,0x008b2fac) */

void FUN_008b2e78(ulong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                 undefined8 param_5)

{
  ...
  FUN_008b4e10();
  if (((ulong)puVar2 & 1) == 0) {
    (*DAT_028cdfc0)(local_28,local_30,local_38,local_40,local_48);
    local_58 = 1;
    goto LAB_008b378c;
  }
  FUN_008c0c98();
  if (((ulong)puVar2 & 1) != 0) {
    ...
    if ((local_59 & 1) != 0) {
      ...
      pcVar1 = (code *)SoftwareBreakpoint(1,0x8b2f9c);
      (*pcVar1)();
    }
    local_58 = 1;
    goto LAB_008b378c;
...
LAB_008b3720:
      ...
      if ((lVar5 == 0) && (local_b0 != 0)) {
        ...
        lVar5 = local_70;
        (*(code *)PTR__objc_msgSend_02578628)(local_70,PTR_s_count_0269cfe0);
        if (lVar5 == 0) goto LAB_008b3720;
        (*DAT_028cdfc0)(local_28,local_30,local_70,local_40,local_48);
        local_58 = 1;
      }
    }
