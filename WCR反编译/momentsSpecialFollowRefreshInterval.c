// momentsSpecialFollowRefreshInterval @ 021655a8

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::momentsSpecialFollowRefreshInterval(ID param_1,SEL param_2)

{
  ...
  if ((long)local_78 < 1) {
    local_78 = (undefined *)((long)&segment_command_00000020.vmaddr + 4);
  }
  _objc_storeStrong(&local_30);
  _objc_storeStrong(&local_28,0);
  return (long_long)local_78;
}
