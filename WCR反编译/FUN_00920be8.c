// FUN_00920be8 @ 00920be8

void FUN_00920be8(undefined8 param_1,undefined8 param_2,byte param_3)

{
  ...
  uVar1 = local_18;
  pcVar2 = &cf_swizzled_viewDidDisappear_;
  local_21 = param_3;
  local_20 = param_2;
  _NSSelectorFromString(&cf_swizzled_viewDidDisappear_);
    ...
    if (((ulong)puVar3 & 1) == 0) {
      ...
      if ((long)puVar3 < 1) {
        ...
        if (((ulong)puVar3 & 1) == 0) {
          ...
          _objc_retainAutoreleasedReturnValue();
          local_38 = puVar3;
          (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_logWithFormat__026aa3c0,&cf_U_);
