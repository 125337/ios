// FUN_0032c9d0 @ 0032c9d0

void FUN_0032c9d0(void)

{
  ...
  local_88 = &cf_BrandContactsViewController;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR__OBJC_CLASS___NSArray_026cdfe0,PTR_s_arrayWithObjects_count__0269cc70,&local_88,0xe
            );
