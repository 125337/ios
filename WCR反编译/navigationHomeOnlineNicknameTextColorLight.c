// navigationHomeOnlineNicknameTextColorLight @ 02071cc8

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::navigationHomeOnlineNicknameTextColorLight(ID param_1,SEL param_2)

{
  ...
  pcVar2 = &cf_nicknameTextColorLight;
