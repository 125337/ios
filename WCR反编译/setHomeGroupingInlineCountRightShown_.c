// setHomeGroupingInlineCountRightShown: @ 01ffd6f4

/* Function Stack Size: 0x14 bytes */

void WCRefineConfig::setHomeGroupingInlineCountRightShown_(ID param_1,SEL param_2,bool param_3)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)
            (IVar1,PTR_s_setObject_forKey__026ca9e8,puVar2,&cf_homeGroupingInlineRightDisplayMode);
  (*(code *)PTR__objc_release_02578630)(puVar2);
