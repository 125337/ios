// addAirDropSaveButtonToPageSheetNav:action: @ 01742524

/* Function Stack Size: 0x20 bytes */

void ThemeBoxAirDropViewController::addAirDropSaveButtonToPageSheetNav_action_
...

{
  ...
  if (bVar2) {
    ...
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(IVar5,PTR_s_findPageSheetProviderViewInView__026b3fa8);
    _objc_retainAutoreleasedReturnValue();
    local_70 = IVar5;
    ...
    if (local_70 == 0) {
      ...
      if (bVar2) {
        ...
        _objc_retainAutoreleasedReturnValue();
        local_80 = puVar7;
        (*(code *)PTR__objc_msgSend_02578628)(puVar7,PTR_s_setTitle_forState__026caab8,&cf_OX_);
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_80,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_40,local_58,0x40);
