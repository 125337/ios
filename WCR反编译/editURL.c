...
void WCRefineToDoListWebSettingsViewController::editURL(ID param_1,SEL param_2)

{
  ...
  local_20 = param_2;
  local_18 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_setPendingKey__026aebd8,&cf_url);
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    local_30 = pcVar1;
    (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_showTextFieldWithMaxLen__0269e5e0,500);
    pcVar1 = local_30;
