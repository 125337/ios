// FUN_01f8d2c0 @ 01f8d2c0

void FUN_01f8d2c0(long param_1)
    ...
    if ((*(byte *)(param_1 + 0x38) & 1) != 0) {
      ...
      if (lVar2 != 0) {
        ...
        if (bVar1) {
          ...
          (*(code *)PTR__objc_msgSend_02578628)();
          (*(code *)PTR__objc_release_02578630)(lVar2);
          (*(code *)PTR__objc_msgSend_02578628)(local_58[0],PTR_s_setDelegate__026ca910,local_28);
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_28,PTR_s_setPreviewPlayer__026c9520,local_58[0]);
          uVar5 = *(undefined8 *)(param_1 + 0x28);
          (*(code *)PTR__objc_msgSend_02578628)(uVar5,PTR_s_absolutePath_026ae300);
          _objc_retainAutoreleasedReturnValue();
