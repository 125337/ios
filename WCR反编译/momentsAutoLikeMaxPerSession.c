// momentsAutoLikeMaxPerSession @ 0205e900

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::momentsAutoLikeMaxPerSession(ID param_1,SEL param_2)

{
  ...
  if (500 < (long)local_98) {
    local_98 = &section_000001a8.reserved3;
  }
  if ((long)local_98 < 2) {
    local_a0 = (dword *)((long)&MACH_HEADER.magic + 1);
  }
  else {
    local_a0 = local_98;
  }
