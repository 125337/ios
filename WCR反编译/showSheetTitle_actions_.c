// showSheetTitle:actions: @ 017d7a64

/* WARNING: Type propagation algorithm not settling */
/* Function Stack Size: 0x20 bytes */

void WCRefineAISettingsViewController::showSheetTitle_actions_
...

{
  ...
  if ((local_d0 == (char *)0x0) || (pcVar3 == (char *)0x0)) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_setSheetActions__026b4f18,local_c8[0]);
    pcVar2 = local_d0;
    _objc_alloc();
    (*(code *)PTR__objc_msgSend_02578628)();
    ...
    if (local_168 != 0) {
      ...
      do {
        do {
          ...
          local_f8 = *(ulong *)(local_130 + local_170 * 8);
          pcVar2 = local_d8;
          _objc_alloc();
          uVar5 = local_f8;
          ...
          (*(code *)PTR__objc_msgSend_02578628)(local_f8,PTR_s_title_0269d250);
          _objc_retainAutoreleasedReturnValue();
          (*(code *)PTR__objc_msgSend_02578628)(IVar6,PTR_s_wcrTuneSheetItem_title__026b4f20,pcVar2)
          ;
          (*(code *)PTR__objc_release_02578630)(uVar5);
          uVar5 = local_f8;
          (*(code *)PTR__objc_msgSend_02578628)(local_f8,PTR_s_highlighted_026b4f28);
          if (((uVar5 & 1) != 0) &&
             (pcVar3 = local_140,
             (*(code *)PTR__objc_msgSend_02578628)
                       (local_140,PTR_s_respondsToSelector__026ca818,PTR_s_setTitleColor__0269ee18),
             pcVar2 = local_140, puVar4 = PTR_s_setTitleColor__0269ee18, ((ulong)pcVar3 & 1) != 0))
          {
            FUN_017d7f60();
            _objc_retainAutoreleasedReturnValue();
