// wcr_openInvitedMembers: @ 01556a44

/* Function Stack Size: 0x18 bytes */

void WCRefineTopBarProfileCardPresenter::wcr_openInvitedMembers_(ID param_1,SEL param_2,ID param_3)

{
  ...
  puVar3 = local_28;
  _objc_getAssociatedObject(local_28,DAT_028c5f18);
