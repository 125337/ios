// wcrGrouping_tableView:viewForFooterInSection: @ 0039cad0

/* Function Stack Size: 0x20 bytes */

ID WCRefineHomeSessionGroupingHook::wcrGrouping_tableView_viewForFooterInSection_
...

{
  ...
  if (bVar2) {
    ...
    if (bVar2) goto LAB_0039ccd0;
  }
  puVar1 = PTR_s_wcrGrouping_tableView_viewForFoo_026a2910;
  IVar4 = local_20;
  (*(code *)PTR__objc_msgSend_02578628)
