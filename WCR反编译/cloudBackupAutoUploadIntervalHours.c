// cloudBackupAutoUploadIntervalHours @ 0218f0dc

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::cloudBackupAutoUploadIntervalHours(ID param_1,SEL param_2)

{
  ...
  if (local_30 == (undefined *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___NSNumber_026ce038,PTR_s_numberWithInt__0269d810,0x18);
    _objc_retainAutoreleasedReturnValue();
    puVar3 = local_30;
    local_30 = puVar2;
