// FUN_0023ac78 @ 0023ac78

void FUN_0023ac78(undefined8 param_1,undefined8 param_2,byte param_3)
    ...
    if ((uVar4 & 1) == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_removeSinkOverrideForSession__026a0be8,local_48[0]);
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_refreshActiveChatLayoutForSessio_026a0bd8,local_48[0]);
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__b_YNl);
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineChatIndentOverrideHelper_026ce408,
                 PTR_s_presentSinkEditorForSession_isGr_026a0be0,local_48[0],local_21 & 1,local_18,
                 local_20);
    }
  }
