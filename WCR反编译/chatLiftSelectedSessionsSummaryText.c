// chatLiftSelectedSessionsSummaryText @ 01b4dfe4

/* Function Stack Size: 0x10 bytes */

ID WCRefineLayoutFunctionViewController::chatLiftSelectedSessionsSummaryText(ID param_1,SEL param_2)

{
  ...
  local_c0 = param_2;
  local_b8 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_chatLiftSelectedSessions_026bf5d0);
