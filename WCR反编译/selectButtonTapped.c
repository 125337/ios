// selectButtonTapped @ 01b60a68

/* Function Stack Size: 0x10 bytes */

void WCRefineLocalEmoticonLibraryViewController::selectButtonTapped(ID param_1,SEL param_2)

{
  ...
  if ((local_40 != (cfstringStruct *)0x0) && (pcVar2 != (cfstringStruct *)0x0)) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___NSNumber_026ce038,PTR_s_numberWithInteger__0269e080,0x24f768);
    _objc_retainAutoreleasedReturnValue();
