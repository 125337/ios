// adjustProfileBgOffsetY @ 01cdd958

/* Function Stack Size: 0x10 bytes */

void WCRefineProfileCardBeautifyViewController::adjustProfileBgOffsetY(ID param_1,SEL param_2)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)();
  (*(code *)PTR__objc_msgSend_02578628)(puVar4,PTR_s_stringWithFormat__0269cca8,&cf___1f___1f);
  _objc_retainAutoreleasedReturnValue();
