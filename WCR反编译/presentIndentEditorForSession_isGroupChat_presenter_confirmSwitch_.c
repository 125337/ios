// presentIndentEditorForSession:isGroupChat:presenter:confirmSwitch: @ 00eceea8

/* WARNING: Type propagation algorithm not settling */
/* Function Stack Size: 0x2c bytes */

void WCRefineChatIndentOverrideHelper::
     presentIndentEditorForSession_isGroupChat_presenter_confirmSwitch_
...

{
  ...
  if ((pcVar1 == (char *)0x0) ||
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_indentSummaryForSession_isGroupC_026ab5b8,local_28,local_29 & 1);
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar1,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,IVar3,
               PTR_s_alertCancelIndent_026ab5c8);
    pcVar1 = local_60;
    IVar3 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_class_0269cd60);
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar1,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,IVar3,
               PTR_s_alertConfirmIndent__026ab5d0);
