// previewCustomIDConfirm: @ 01ca3bf0

/* Function Stack Size: 0x18 bytes */

void WCRefinePluginManagementViewController::previewCustomIDConfirm_
...

{
  ...
  if (pcVar1 == (cfstringStruct *)0x0) {
    ...
    if (pcVar1 != (cfstringStruct *)0x0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_18,PTR_s_showErrorAlert_message__026c2da8,&::cf_eQ,&cf_eQgHev);
      (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_setCurrentAlert__026aa348,0);
    }
