// FUN_01e52474 @ 01e52474

void FUN_01e52474(double param_1,long param_2)

{
  ...
  if ((pcVar2 == (cfstringStruct *)0x0) || (param_1 == 0.0)) {
    local_50 = 0.0;
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__b_YVW);
  }
  else if ((param_1 < 1.0) || (local_50 = param_1, 16.0 < param_1)) {
    local_50 = 0.0;
    (*(code *)PTR__objc_msgSend_02578628)
