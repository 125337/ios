// alertConfirmReceipt: @ 018c38e4

/* Function Stack Size: 0x18 bytes */

void WCRefineChatTimeViewController::alertConfirmReceipt_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (pcVar1 == (cfstringStruct *)0x0) {
    ...
    if ((local_40 != (cfstringStruct *)0x0) &&
      ...
      _objc_storeStrong(&local_38,local_a8);
      (*(code *)PTR__objc_release_02578630)(pcVar1);
    }
    _objc_storeStrong(&local_40,0);
    pcVar1 = local_18;
    _objc_getAssociatedObject(local_18,PTR_s_alertConfirmReceipt__026b7df8);
    _objc_retainAutoreleasedReturnValue();
    local_60[0] = pcVar1;
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar1,PTR_s_isEqualToString__0269ccc8,&cf_chatTimeMyReceipt);
    if (((ulong)pcVar1 & 1) == 0) {
      pcVar1 = local_60[0];
      (*(code *)PTR__objc_msgSend_02578628)
                (local_60[0],PTR_s_isEqualToString__0269ccc8,&cf_chatTimeOtherReceipt);
      if (((ulong)pcVar1 & 1) != 0) {
