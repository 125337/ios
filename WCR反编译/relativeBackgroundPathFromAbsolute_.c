// relativeBackgroundPathFromAbsolute: @ 01aeb530

/* Function Stack Size: 0x18 bytes */

ID WCRefineHomeAvatarStripSettingsViewController::relativeBackgroundPathFromAbsolute_
...

{
  ...
  if ((((ulong)pcVar2 & 1) == 0) ||
    ...
    if (((ulong)pcVar3 & 1) == 0) {
      ...
      pcVar3 = local_30;
      local_48 = IVar4;
      (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_hasPrefix__0269d320,IVar4);
      pcVar2 = local_30;
      if (((ulong)pcVar3 & 1) == 0) {
        (*(code *)PTR__objc_retain_02578638)();
        local_18 = &::cf___;
