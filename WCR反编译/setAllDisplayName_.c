// setAllDisplayName: @ 01086b30

/* Function Stack Size: 0x18 bytes */

void WCRefineLocalEmoticonStore::setAllDisplayName_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (bVar1) {
    _objc_storeStrong(&local_30,&cf_hQ);
  }
  uVar4 = local_30;
  ...
  if (((uVar4 & 1) != 0) ||
     (uVar4 = local_30,
     (*(code *)PTR__objc_msgSend_02578628)
               (local_30,PTR_s_isEqualToString__0269ccc8,&cf___ungrouped__), (uVar4 & 1) != 0)) {
    _objc_storeStrong(&local_30,&cf_hQ);
  }
  uVar4 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_isEqualToString__0269ccc8,&cf_hQ);
  bVar1 = (uVar4 & 1) == 0;
  if (bVar1) {
    local_80 = local_30;
  ...
  _objc_storeStrong(&DAT_028e3288,local_80);
  if (bVar1) {
