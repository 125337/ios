// exportSelectedFrames @ 01d74954

/* Function Stack Size: 0x10 bytes */

void WCRefineScreenshotFrameLibraryViewController::exportSelectedFrames(ID param_1,SEL param_2)

{
  ...
  lVar2 = *(long *)(param_1 + (long)_selectedExportPaths);
  local_20 = param_2;
  local_18 = param_1;
  ...
  if (lVar2 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_showToast__026b3a18,&cf_ck_W_Q_);
    uVar3 = *(undefined8 *)(local_18 + (long)_selectedExportPaths);
