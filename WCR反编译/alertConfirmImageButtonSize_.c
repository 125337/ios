// alertConfirmImageButtonSize: @ 016de8c0

/* Function Stack Size: 0x18 bytes */

void __thiscall
RepeatEnhanceViewController::alertConfirmImageButtonSize_
...

{
  ...
  if (pcVar1 != (cfstringStruct *)0x0) {
    ...
    (*(code *)PTR__objc_release_02578630)(puVar3);
    _WCRefineInvalidateRepeatEnhanceCellCaches();
