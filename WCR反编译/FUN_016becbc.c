// FUN_016becbc @ 016becbc

byte FUN_016becbc(undefined8 param_1)
    ...
    if (local_160 != 0) {
      ...
      do {
        do {
          ...
          local_118 = uVar5;
          (*(code *)PTR__objc_msgSend_02578628)(uVar5,PTR_s_isEqualToString__0269ccc8,&cf_lS);
          bVar1 = true;
          if ((uVar5 & 1) == 0) {
            uVar5 = local_118;
            (*(code *)PTR__objc_msgSend_02578628)
          ...
          if (local_c8 != 0) goto LAB_016befd4;
