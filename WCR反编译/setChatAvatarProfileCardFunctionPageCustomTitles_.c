// setChatAvatarProfileCardFunctionPageCustomTitles: @ 0200ab90

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setChatAvatarProfileCardFunctionPageCustomTitles_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineProfileCardActionCatalog_026ced78,
             PTR_s_normalizedCustomTitlesFromSavedT_026c3548,local_28);
