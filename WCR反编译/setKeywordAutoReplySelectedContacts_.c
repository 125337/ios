// setKeywordAutoReplySelectedContacts: @ 01fe6fe8

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setKeywordAutoReplySelectedContacts_(ID param_1,SEL param_2,ID param_3)
  ...
  if (local_140 != 0) {
    ...
    do {
      do {
        ...
        uVar6 = *(ulong *)(local_118 + local_148 * 8);
        local_e0 = uVar6;
