// FUN_01a14fec @ 01a14fec

void FUN_01a14fec(long param_1)
    ...
    if (local_158 != 0) {
      ...
      do {
        do {
          ...
          if (local_cc != 0) goto LAB_01a15204;
...
LAB_01a15204:
    ...
    if (pcVar2 != (cfstringStruct *)0x0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_c8,PTR_s_savePendingRuleWithReplyText_rep_026bb7f8,&cf___,&cf___,0,local_d8,0
                );
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)
