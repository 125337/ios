// FUN_009204e8 @ 009204e8

void FUN_009204e8(undefined8 param_1,undefined8 param_2,byte param_3)

{
  ...
  uVar1 = local_18;
  pcVar2 = &cf_swizzled_viewWillAppear_;
  local_21 = param_3;
  local_20 = param_2;
  _NSSelectorFromString(&cf_swizzled_viewWillAppear_);
