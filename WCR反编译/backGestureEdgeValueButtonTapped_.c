// backGestureEdgeValueButtonTapped: @ 01a4f84c

/* Function Stack Size: 0x18 bytes */

void WCRefineGeneralFunctionViewController::backGestureEdgeValueButtonTapped_
  ...
  if (bVar1) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleBackGestureEdgeWidthInput__026bcb80);
