// autoReplySanitizedMultiItems: @ 00fa5ef4

/* Function Stack Size: 0x18 bytes */

ID WCRefineHelper::autoReplySanitizedMultiItems_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (((uVar1 & 1) == 0) ||
     ...
     puVar2 = PTR__OBJC_CLASS___NSMutableArray_026ce088, uVar1 == 0)) {
