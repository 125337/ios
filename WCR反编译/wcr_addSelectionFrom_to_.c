// wcr_addSelectionFrom:to: @ 016974b8

/* Function Stack Size: 0x20 bytes */

void WCRWordSegPickerController::wcr_addSelectionFrom_to_
...

{
  ...
  if ((param_3 != 0x7fffffffffffffff) && (param_4 != 0x7fffffffffffffff)) {
    ...
    if (!bVar1) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (IVar2,PTR_s_addIndexesInRange__026abda8,param_4,(local_e0 - param_4) + 1);
      (*(code *)PTR__objc_release_02578630)(IVar2);
