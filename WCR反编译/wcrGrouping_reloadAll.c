// wcrGrouping_reloadAll @ 0037fe10

/* WARNING: Removing unreachable block (ram,0x00380364) */
/* WARNING: Removing unreachable block (ram,0x00380344) */
/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefineHomeSessionGroupingHook::wcrGrouping_reloadAll
...

{
  ...
  if ((param_1 & 1) == 0) {
    (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_wcrGrouping_reloadAll_026a2a10);
  }
  else {
    IVar4 = local_28;
    _WCRGroupingState();
    ...
    if ((((IVar4 & 1) == 0) && ((IVar6 & 1) == 0)) && ((bVar1 && ((local_58 & 1) == 0)))) {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_28,PTR_s_wcrGrouping_scheduleRefreshForTr_026a28a0,&cf_reloadAll);
    }
