// pluginWithIdentifier: @ 01775154

/* Function Stack Size: 0x18 bytes */

ID WCRefinePluginHubManager::pluginWithIdentifier_(ID param_1,SEL param_2,ID param_3)

{
  ...
  IVar2 = local_b8;
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_currentPluginsSnapshot_026b4458);
