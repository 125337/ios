// openWatermarkOpacitySettingForIndex: @ 017ff988

/* Function Stack Size: 0x18 bytes */

void __thiscall
WCRefineAssistFunctionViewController::openWatermarkOpacitySettingForIndex_
...

{
  ...
  if (pcVar4 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___NSString_026cdfe8,PTR_s_stringWithFormat__0269cca8,
               &cf_handleWatermarkOpacityConfirm_ld_);
    _objc_retainAutoreleasedReturnValue();
    puVar3 = puVar2;
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___NSString_026cdfe8,PTR_s_stringWithFormat__0269cca8,
               &cf_handleWatermarkOpacityCancel_ld_);
    _objc_retainAutoreleasedReturnValue();
    puVar6 = puVar2;
    _NSSelectorFromString();
    (*(code *)PTR__objc_release_02578630)(puVar2);
