// setNavigationHomeOnlineIconColorDark: @ 02070138

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setNavigationHomeOnlineIconColorDark_(ID param_1,SEL param_2,ID param_3)

{
  ...
  pcVar2 = &cf_tqqOnlineIconColorDark;
  local_30 = IVar1;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
  lVar3 = local_28;
