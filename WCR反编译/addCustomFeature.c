// addCustomFeature @ 01c937a0

/* Function Stack Size: 0x10 bytes */

void WCRefinePluginFeatureManagementViewController::addCustomFeature(ID param_1,SEL param_2)
  ...
  if (pcVar1 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,local_18,
               PTR_s_cancelAddCustomFeatureName_026c2bb0);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&::cf_N,local_18,
               PTR_s_handleAddCustomFeatureNameInput__026c2bb8);
