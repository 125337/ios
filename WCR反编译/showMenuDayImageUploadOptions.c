// showMenuDayImageUploadOptions @ 01b864e8

/* Function Stack Size: 0x10 bytes */

void WCRefineMenuBeautifyViewController::showMenuDayImageUploadOptions(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar1,PTR_s_addBtnTitle_target_sel__0269d278,&cf_NvQbVGr_,local_18,
               PTR_s_selectMenuDayImageFromPhotoLibra_026bfd68);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_NeNbVGr_,local_18,
               PTR_s_selectMenuDayImageFromFiles_026bfd70);
    (*(code *)PTR__objc_msgSend_02578628)
