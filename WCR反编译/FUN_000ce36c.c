// FUN_000ce36c @ 000ce36c

dword * FUN_000ce36c(undefined8 param_1)

{
  ...
  local_38 = pdVar1;
  (*(code *)PTR__objc_msgSend_02578628)(pdVar1,PTR_s_repeatChatSinkEnabled_0269e7f0);
  if (((ulong)pdVar1 & 1) == 0) {
    local_28 = (dword *)0x0;
    local_48 = 1;
  }
    ...
    if ((uVar2 & 1) == 0) {
      ...
      pdVar1 = local_38;
      local_50 = uVar2;
      (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_repeatChatSinkSessionOverrides_0269e818);
      _objc_retainAutoreleasedReturnValue();
      uVar2 = local_50;
      local_58 = pdVar1;
      ...
      if (((ulong)pdVar1 & 1) == 0) {
        ...
        if ((uVar2 & 1) == 0) {
          ...
          if (local_88 == 0) {
            ...
            local_150 = local_38;
            if (local_88 == 2) {
              (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_repeatChatRoomSink_0269e820);
            }
            else {
              (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_repeatPrivateChatSink_0269e828);
            }
            local_90 = local_150;
            if ((long)local_150 < 0) {
              local_90 = (dword *)0x0;
