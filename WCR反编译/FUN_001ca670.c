// FUN_001ca670 @ 001ca670

void FUN_001ca670(ulong param_1,undefined8 param_2)

{
  ...
  if ((bool)uVar1) {
    uVar4 = local_18;
    _objc_getAssociatedObject(local_18,&DAT_028c91a7);
    _objc_retainAutoreleasedReturnValue();
    bVar2 = uVar4 == 0;
    local_39 = uVar1;
    local_38 = uVar4;
  ...
  if (bVar2) {
    ...
    _objc_retainAutoreleasedReturnValue();
    _objc_setAssociatedObject(uVar3,&DAT_028c91a7,puVar6,1);
