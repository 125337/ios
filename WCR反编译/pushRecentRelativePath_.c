// pushRecentRelativePath: @ 015b4c3c

/* Function Stack Size: 0x18 bytes */

void WCRefineVoicePackStore::pushRecentRelativePath_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (lVar2 == 0) {
    ...
    IVar4 = local_18;
    local_40 = IVar3;
    (*(code *)PTR__objc_msgSend_02578628)(IVar3,PTR_s_objectForKeyedSubscript__0269d098,&cf_recents)
    ;
    _objc_retainAutoreleasedReturnValue();
    ...
    while( true ) {
      ...
      if (IVar4 < 0x29) break;
      (*(code *)PTR__objc_msgSend_02578628)(local_48,PTR_s_removeLastObject_0269e830);
    }
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_setObject_forKeyedSubscript__0269d248,local_48,&cf_recents);
