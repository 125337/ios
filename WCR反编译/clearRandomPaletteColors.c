// clearRandomPaletteColors @ 01895804

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAvatarProfileCardViewController::clearRandomPaletteColors(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__b_Yr_g);
  return;
}
