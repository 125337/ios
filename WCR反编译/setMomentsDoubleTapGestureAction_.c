// setMomentsDoubleTapGestureAction: @ 0204f368

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setMomentsDoubleTapGestureAction_(ID param_1,SEL param_2,long_long param_3)

{
  ...
  if (((long)local_28 < 0) || (8 < (long)local_28)) {
    local_40 = 0;
  }
  else {
    local_40 = local_28;
