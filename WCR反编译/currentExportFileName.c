// currentExportFileName @ 00913cb8

/* Function Stack Size: 0x10 bytes */

ID LogViewerViewController::currentExportFileName(ID param_1,SEL param_2)

{
  ...
  _objc_alloc_init();
  local_28 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_setDateFormat__0269d1c8,&cf_yy_MM_ddHH_mm_ss);
  puVar1 = local_28;
