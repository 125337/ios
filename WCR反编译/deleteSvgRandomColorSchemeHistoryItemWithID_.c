// deleteSvgRandomColorSchemeHistoryItemWithID: @ 020a1af0

/* Function Stack Size: 0x18 bytes */

bool WCRefineConfig::deleteSvgRandomColorSchemeHistoryItemWithID_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (lVar1 == 0) {
    ...
    IVar2 = local_20;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_svgRandomColorSchemeHistoryItems_026c63f0);
    ...
    if ((bool)local_11) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_20,PTR_s_setSvgRandomColorSchemeHistoryIt_026ca348);
      (*(code *)PTR__objc_release_02578630)(IVar2);
    }
    local_34 = 1;
