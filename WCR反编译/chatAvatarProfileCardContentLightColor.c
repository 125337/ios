// chatAvatarProfileCardContentLightColor @ 02010cec

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::chatAvatarProfileCardContentLightColor(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    local_40 = puVar3;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_20,PTR_s_setChatAvatarProfileCardContentL_026b7320,puVar3);
    puVar3 = local_40;
