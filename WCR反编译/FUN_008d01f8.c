// FUN_008d01f8 @ 008d01f8

void FUN_008d01f8(undefined8 param_1,undefined8 param_2)

{
  ...
  if (((local_18 == (undefined *)0x0) ||
      ...
      puVar1 != (undefined *)0x2c63c)) || (uVar2 = local_20, FUN_008ced34(0), (uVar2 & 1) == 0)) {
    local_30 = 1;
  }
  else {
    puVar1 = local_18;
    _objc_getAssociatedObject(local_18,DAT_026f4ab0);
    ...
    if (((ulong)puVar1 & 1) == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (puVar3,PTR_s_initWithTarget_action__026ca718,local_20,
                 PTR_s_WCRVPHandleAttachmentLongPress__026a9ce8);
      puVar1 = local_38;
      local_38 = puVar3;
      ...
      _objc_setAssociatedObject(local_18,DAT_026f4ab0,local_38,1);
