// setSmallSignalSpecialUsers: @ 021831a8

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setSmallSignalSpecialUsers_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (puVar3 == (undefined *)0x0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_c8,PTR_s_removeObjectForKey__0269d700,&cf_WCRefineSmallSignalSpecialUsers);
  }
  else {
    puVar3 = local_d8;
    (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_copy_0269d150);
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar1,PTR_s_setObject_forKey__026ca9e8,puVar3,&cf_WCRefineSmallSignalSpecialUsers);
