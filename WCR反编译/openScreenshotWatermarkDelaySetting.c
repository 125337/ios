// openScreenshotWatermarkDelaySetting @ 017fd67c

/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefineAssistFunctionViewController::openScreenshotWatermarkDelaySetting
...

{
  ...
  local_38 = puVar2;
  (*(code *)PTR__objc_msgSend_02578628)(puVar2,PTR_s_screenshotWatermarkDelay_026a1f10);
  ...
  if (pcVar3 == (char *)0x0) {
    ...
    _objc_retainBlock();
    IVar1 = local_28;
    puVar2 = PTR_s_handleWatermarkDelayConfirm__026b5a70;
    local_90 = ppuVar4;
    _objc_retainBlock();
    _objc_setAssociatedObject(IVar1,puVar2,ppuVar4,1);
    (*(code *)PTR__objc_release_02578630)(ppuVar4);
    _objc_setAssociatedObject(local_28,PTR_s_handleWatermarkDelayCancel__026b5a78,local_60,1);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_60,PTR_s_addCancelBtnTitle_target_sel__0269d268,&cf_Sm,local_28,
               PTR_s_handleWatermarkDelayCancel__026b5a78);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_60,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx,local_28,
               PTR_s_handleWatermarkDelayConfirm__026b5a70);
