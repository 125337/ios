// FUN_000389fc @ 000389fc

void FUN_000389fc(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (((local_18 != 0) &&
    ...
    if ((uVar3 & 1) != 0) {
      (*(code *)PTR__objc_msgSend_02578628)(local_18,lVar2,local_28);
    }
  }
