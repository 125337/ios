// FUN_00336134 @ 00336134

void FUN_00336134(undefined8 param_1)

{
  ...
  if (local_b8 != 0) {
    ...
    while (local_d8 = local_d8 - 1, -1 < (long)local_d8) {
      ...
      if (((uVar1 & 1) != 0) && (uVar1 = local_e0, FUN_003382f8(), (uVar1 & 1) != 0)) {
    ...
    if (local_190 != 0) {
      ...
      do {
        do {
          ...
          if (((uVar4 & 1) != 0) && (uVar4 = local_f0, FUN_003382f8(), (uVar4 & 1) != 0)) {
            (*(code *)PTR__objc_msgSend_02578628)
