// momentsFakeCustomCommentsSummary @ 01c07664

/* Function Stack Size: 0x10 bytes */

ID WCRefineMomentsViewController::momentsFakeCustomCommentsSummary(ID param_1,SEL param_2)
    ...
    if (local_170 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          if (local_cc != 0) goto LAB_01c07a64;
