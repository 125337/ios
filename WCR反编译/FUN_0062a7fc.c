// FUN_0062a7fc @ 0062a7fc

void FUN_0062a7fc(undefined *param_1,undefined8 param_2)

{
  ...
  if (puVar3 == (undefined *)0x0) {
    local_c8 = PTR__OBJC_CLASS___UIApplication_026ce010;
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___UIApplication_026ce010,PTR_s_sharedApplication_026caaf8);
    _objc_retainAutoreleasedReturnValue();
    local_59 = 1;
  ...
  if (((ulong)puVar3 & 1) == 0) {
    ...
    if (((ulong)puVar2 & 1) != 0) {
      ...
      if (local_8c != 0) goto LAB_0062afa0;
    }
    local_a0 = (undefined *)0x0;
    puVar3 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_performSelector__026ca7b8,PTR_s_findTopViewController_026a5e08);
    _objc_retainAutoreleasedReturnValue();
    puVar2 = local_a0;
    local_a0 = puVar3;
    (*(code *)PTR__objc_release_02578630)(puVar2);
