...
ID WCRefineTelegramGroupingStore::tabForId_(ID param_1,SEL param_2,ID param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_ensureTabsLoaded_026b01d8);
  lVar3 = local_c8;
  FUN_01516994();
    ...
    if (local_140 != 0) {
      ...
      do {
        do {
          ...
          local_e0 = uVar4;
          (*(code *)PTR__objc_msgSend_02578628)(uVar4,PTR_s_tabId_026a8270);
          _objc_retainAutoreleasedReturnValue();
          uVar2 = uVar4;
          (*(code *)PTR__objc_msgSend_02578628)();
