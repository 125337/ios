// FUN_006b5e10 @ 006b5e10

byte FUN_006b5e10(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (((ulong)puVar2 & 1) == 0) {
    if (DAT_028cc150 == (code *)0x0) {
      local_74 = 1;
    }
    else {
      uVar3 = local_20;
      (*DAT_028cc150)(local_20,local_28,local_30,local_38);
      local_74 = (int)uVar3;
    }
    local_11 = local_74 != 0;
  }
