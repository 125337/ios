// FUN_002f401c @ 002f401c

/* WARNING: Removing unreachable block (ram,0x002f4104) */
/* WARNING: Removing unreachable block (ram,0x002f42a4) */

void FUN_002f401c(undefined8 param_1)
    ...
    if (((ulong)puVar2 & 1) == 0) {
      ...
      if ((puVar3 == (undefined1 *)((long)&MACH_HEADER.magic + 3)) ||
        ...
        _UIImageWriteToSavedPhotosAlbum
                  (local_28,puVar2,PTR_s_framedScreenshotSaved_didFinishS_026a1f40,0);
