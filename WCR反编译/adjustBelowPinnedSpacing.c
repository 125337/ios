// adjustBelowPinnedSpacing @ 01a7abac

/* Function Stack Size: 0x10 bytes */

void WCRefineGlobalCornerSettingsViewController::adjustBelowPinnedSpacing(ID param_1,SEL param_2)
  ...
  if (((ulong)puVar2 & 1) != 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleBelowPinnedSpacingInput__026bd668);
