// FUN_00374c98 @ 00374c98

void FUN_00374c98(long param_1)

{
  ...
  local_d8 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)(uVar1,PTR_s_tryInstallHomeLongPressHooks_026a28b8);
    ...
    if (local_1b0 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          local_f0 = *(undefined8 *)(local_128 + (long)local_1b8 * 8);
