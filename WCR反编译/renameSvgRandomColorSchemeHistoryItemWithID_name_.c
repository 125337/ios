// renameSvgRandomColorSchemeHistoryItemWithID:name: @ 020a1364

/* Function Stack Size: 0x20 bytes */

bool WCRefineConfig::renameSvgRandomColorSchemeHistoryItemWithID_name_
...

{
  ...
  if (lVar2 == 0) {
    ...
    local_48 = &cf__g_TTMr;
    uVar3 = local_38;
    FUN_020a01c4(local_38,&cf__g_TTMr);
