// webView:runJavaScriptAlertPanelWithMessage:initiatedByFrame:completionHandler: @ 01f02838
  ...
  if (puVar2 == (undefined *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___UIAlertController_026ce178,
               PTR_s_alertControllerWithTitle_message_0269dc00,&cf_Q_uc_y,local_c0,1);
    _objc_retainAutoreleasedReturnValue();
    lVar1 = local_50[0];
    ...
    local_88 = 0xc2000000;
    local_84 = 0;
    local_80 = FUN_01f02adc;
    local_78 = &DAT_02584050;
    local_68 = puVar3;
    (*(code *)PTR__objc_retain_02578638)();
    local_70 = lVar1;
    (*(code *)PTR__objc_msgSend_02578628)
              (puVar2,PTR_s_actionWithTitle_style_handler__0269dc08,&cf_nx_,0,&local_90);
    _objc_retainAutoreleasedReturnValue();
