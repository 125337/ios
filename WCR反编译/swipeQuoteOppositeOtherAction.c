// swipeQuoteOppositeOtherAction @ 020c5138

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::swipeQuoteOppositeOtherAction(ID param_1,SEL param_2)

{
  ...
  pdVar1 = local_28;
  if (((long)local_38 < 0) || (0xc < (long)local_38)) {
    local_38 = &MACH_HEADER.cputype;
