// scheduleAutoAddContactsForNewChatRoom: @ 00ee2650

/* Function Stack Size: 0x18 bytes */

void __thiscall
WCRefineChatRoomMuteHelper::scheduleAutoAddContactsForNewChatRoom_
...

{
  ...
  if (((ulong)puVar3 & 1) == 0) {
    ...
    if ((IVar5 & 1) == 0) {
      ...
      in_d0 = in_d0 - dVar8;
      if (20.0 <= in_d0) {
        local_28 = &DAT_028e2a78;
        local_30 = 0;
        _objc_storeStrong(&local_30,&PTR___NSConcreteGlobalBlock_02581f50);
        if (*local_28 + 1 != 0) {
        ...
        lVar6 = DAT_028e2a70;
        (*(code *)PTR__objc_msgSend_02578628)
                  (DAT_028e2a70,PTR_s_objectForKeyedSubscript__0269d098,local_58);
        _objc_retainAutoreleasedReturnValue();
        dVar8 = local_60;
        local_68 = lVar6;
        if ((lVar6 == 0) ||
          ...
          _objc_retainAutoreleasedReturnValue();
          (*(code *)PTR__objc_msgSend_02578628)
                    (DAT_028e2a70,PTR_s_setObject_forKeyedSubscript__0269d248,puVar2,local_58);
          (*(code *)PTR__objc_release_02578630)(puVar2);
          local_4c = 0;
        }
        else {
