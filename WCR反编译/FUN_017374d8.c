// FUN_017374d8 @ 017374d8

void FUN_017374d8(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (((uVar2 & 1) != 0) && (uVar2 = local_48, FUN_0172eae8(), uVar2 == *(ulong *)(param_1 + 0x28)))
  {
