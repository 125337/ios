// movePendingToFront @ 0194d1f0

/* Function Stack Size: 0x10 bytes */

void WCRefineEmoticonGroupManageViewController::movePendingToFront(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_moveGroupIdToFront__026a1080);
