// compatSegmentControl @ 019ef170

/* Function Stack Size: 0x10 bytes */

ID WCRefineFontConvertViewController::compatSegmentControl(ID param_1,SEL param_2)

{
  ...
  IVar3 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_compatLayer_026b1030);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_40,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_30,
             PTR_s_compatLayerChanged__026bb298,0x1000);
  puVar1 = local_40;
