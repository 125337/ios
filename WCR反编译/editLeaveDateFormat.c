// editLeaveDateFormat @ 018ad23c

/* Function Stack Size: 0x10 bytes */

void WCRefineChatRoomFunctionViewController::editLeaveDateFormat(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleLeaveDateFormatInput__026b78e8);
