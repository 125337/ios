// openChatListAvatarFrameLibrary @ 01820a28

/* Function Stack Size: 0x10 bytes */

void WCRefineAvatarCornerBeautifyViewController::openChatListAvatarFrameLibrary
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_setPreviewRole__026b62e0,0);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_setDelegate__026ca910,local_18);
  _objc_setAssociatedObject(local_18,"WCRefineAvatarFrameSelectTarget",&cf_chatList,1);
  IVar2 = local_18;
