// FUN_010af220 @ 010af220

void FUN_010af220(undefined8 param_1)

{
  ...
  if (local_70 == (cfstringStruct *)0x0) {
    ...
    pcVar2 = local_48;
    FUN_010b1960(local_48,&cf_title);
    _objc_retainAutoreleasedReturnValue();
    local_60 = pcVar2;
    (*(code *)PTR__objc_msgSend_02578628)(pcVar2,PTR_s_length_0269cca0);
    if ((pcVar2 == (cfstringStruct *)0x0) ||
       (pcVar3 = local_60,
       (*(code *)PTR__objc_msgSend_02578628)(local_60,PTR_s_hasPrefix__0269d320,&cf_<),
       pcVar2 = local_60, ((ulong)pcVar3 & 1) != 0)) {
      (*(code *)PTR__objc_retain_02578638)();
      local_18 = &cf___;
    }
    else {
