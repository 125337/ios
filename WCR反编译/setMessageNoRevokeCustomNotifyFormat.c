// setMessageNoRevokeCustomNotifyFormat @ 01a71214

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::setMessageNoRevokeCustomNotifyFormat
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_48,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMessageNoRevokeCustomNotif_026bd3c8);
