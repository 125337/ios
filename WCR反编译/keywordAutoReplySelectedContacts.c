// keywordAutoReplySelectedContacts @ 01fe6d04

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::keywordAutoReplySelectedContacts(ID param_1,SEL param_2)

{
  ...
  local_c0 = param_1;
  FUN_01fd9510(param_1,local_b8);
  _objc_retainAutoreleasedReturnValue();
  local_c8 = param_1;
  FUN_01fd1d24(param_1,200);
  _objc_retainAutoreleasedReturnValue();
  ...
  if (local_140 != 0) {
    ...
    do {
      do {
        ...
        if ((uVar4 != 0) &&
           (uVar4 = local_e0,
           (*(code *)PTR__objc_msgSend_02578628)(local_e0,PTR_s_hasSuffix__0269d018,&cf__chatroom),
           (uVar4 & 1) == 0)) {
