// beginRename: @ 01b7aa68

/* Function Stack Size: 0x18 bytes */

void WCRefineLongPressMenuViewController::beginRename_(ID param_1,SEL param_2,ID param_3)

{
  ...
  IVar1 = local_18;
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_itemWithID__026bfbc8,local_28);
  ...
  if ((local_30 == 0) || (pcVar2 == (char *)0x0)) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_setPendingItemID__026bfbd0,local_28);
    uVar3 = local_28;
    _WCRLongPressMenuItemIsCustom();
    local_3d = (undefined1)uVar3;
    pcVar2 = local_38;
    _objc_alloc();
    ...
    IVar1 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_objectForKeyedSubscript__0269d098,_kWCRefinePluginIconTitleKey);
    _objc_retainAutoreleasedReturnValue();
    local_50 = IVar1;
