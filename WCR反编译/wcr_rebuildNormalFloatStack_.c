// wcr_rebuildNormalFloatStack: @ 01f929f0

/* Function Stack Size: 0x14 bytes */

void WCRefineVoicePackPickerViewController::wcr_rebuildNormalFloatStack_
...

{
  ...
  if (param_1 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (0x404f000000000000,(double)iVar19,local_50,
               PTR_s_wcr_makeCapsuleBarWithTag_height_026c98d8,0x2c650);
    _objc_retainAutoreleasedReturnValue();
  ...
  IVar2 = local_50;
  local_78 = IVar1;
  (*(code *)PTR__objc_msgSend_02578628)(local_50,PTR_s_bindingPickMode_026c9b88);
  puVar3 = local_70;
  if ((IVar2 & 1) == 0) {
    if ((local_59 & 1) == 0) {
      IVar1 = local_50;
      (*(code *)PTR__objc_msgSend_02578628)
                (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&::cf___,
                 &cf_icons_outlined_time,&cf_clock,local_78,PTR_s_floatBarRecent_026c9c30);
      _objc_retainAutoreleasedReturnValue();
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&cf_6e,&cf_star_regular,
                 &cf_star,local_78,PTR_s_floatBarFavorite_026c9c38);
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_addArrangedSubview__026b9d98);
      (*(code *)PTR__objc_release_02578630)(IVar1);
      IVar1 = local_50;
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (0x4073e00000000000,IVar1,PTR_s_wcr_setCapsuleBar_width__026c9918);
      (*(code *)PTR__objc_release_02578630)(IVar2);
    }
    else {
      IVar1 = local_50;
      (*(code *)PTR__objc_msgSend_02578628)
                (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&cf_V,
                 &cf_icons_outlined_back,&cf_chevron_left,local_78,PTR_s_floatBarBack_026c9c28);
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_addArrangedSubview__026b9d98);
      (*(code *)PTR__objc_release_02578630)(IVar1);
      IVar1 = local_50;
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (0x4072c00000000000,IVar1,PTR_s_wcr_setCapsuleBar_width__026c9918);
      (*(code *)PTR__objc_release_02578630)(IVar2);
    }
    puVar3 = local_70;
    IVar1 = local_50;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&cf___,
               &cf_icons_outlined_link,&cf_link,local_78,PTR_s_bindFromTopBar_026c9b18);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_addArrangedSubview__026b9d98);
    (*(code *)PTR__objc_release_02578630)(IVar1);
    puVar3 = local_70;
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&cf__,
               &cf_icons_outlined_pencil,&cf_pencil,local_78,PTR_s_floatBarEdit_026c9c40);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_addArrangedSubview__026b9d98);
    (*(code *)PTR__objc_release_02578630)(IVar1);
    puVar3 = local_70;
    IVar1 = local_50;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&cf_c_,
               &cf_icons_outlined_sort,&cf_arrow_up_arrow_down,local_78,PTR_s_floatBarSort_026c9c48)
    ;
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_addArrangedSubview__026b9d98);
    (*(code *)PTR__objc_release_02578630)(IVar1);
    ...
    IVar1 = local_50;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_50,PTR_s_wcr_iconTitleButton_icon_fallbac_026c98f0,&cf_Sm,&cf_xmark_circle,
               &cf_xmark_circle,local_78,PTR_s_cancelBindingPickMode_026c9bf0);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(puVar3,PTR_s_addArrangedSubview__026b9d98);
    (*(code *)PTR__objc_release_02578630)(IVar1);
    IVar1 = local_50;
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              ((double)iVar19,IVar1,PTR_s_wcr_setCapsuleBar_width__026c9918);
    (*(code *)PTR__objc_release_02578630)(IVar2);
  }
