// FUN_0157bf04 @ 0157bf04

void FUN_0157bf04(undefined8 param_1)

{
  ...
  if (local_b8 == 0) {
    ...
    uVar3 = local_b8;
    (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_isFirstResponder_0269f488);
    uVar1 = local_b8;
    if ((uVar3 & 1) == 0) {
      ...
      if (local_138 != 0) {
        ...
        do {
          do {
            ...
            if (local_bc != 0) goto LAB_0157c130;
