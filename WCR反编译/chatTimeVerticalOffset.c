// chatTimeVerticalOffset @ 02079f20

/* Function Stack Size: 0x10 bytes */

double __thiscall
WCRefineConfig::chatTimeVerticalOffset(WCRefineConfig *this,ID param_1,SEL param_2)

{
  ...
  if (puVar3 == (undefined *)0x0) {
    if (local_30 != 0) {
      puVar4 = local_28;
      (*(code *)PTR__objc_msgSend_02578628)
                (local_28,PTR_s_objectForKey__0269e048,&cf_chatTimeVerticalOffset);
      _objc_retainAutoreleasedReturnValue();
      puVar3 = local_40;
      local_40 = puVar4;
