// FUN_00260434 @ 00260434

void FUN_00260434(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (((ulong)puVar2 & 1) != 0) {
    ...
    _NSLog(&cf__wcr__emoticon_oasendimageDataclass___len__lu);
    ...
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)
              (puVar1,PTR_s_sendOAImageDataAsEmoticon_fromVi_026a1298,uVar4);
