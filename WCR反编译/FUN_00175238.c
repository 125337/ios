// FUN_00175238 @ 00175238

void FUN_00175238(undefined8 param_1)

{
  ...
  if (local_20 == (cfstringStruct *)0x0) {
    ...
    if (((local_30 == (cfstringStruct *)0x0) ||
       ...
       (pcVar1 = local_20,
       (*(code *)PTR__objc_msgSend_02578628)
                 (local_20,PTR_s_respondsToSelector__026ca818,PTR_s_m_nsAppMediaUrl_0269f908),
       ((ulong)pcVar1 & 1) != 0)) {
      pcVar2 = local_20;
      (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_m_nsAppMediaUrl_0269f908);
      _objc_retainAutoreleasedReturnValue();
      pcVar1 = local_30;
      local_30 = pcVar2;
      (*(code *)PTR__objc_release_02578630)(pcVar1);
