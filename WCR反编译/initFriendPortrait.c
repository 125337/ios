// initFriendPortrait @ 01dcb480

/* Function Stack Size: 0x10 bytes */

ID WCRefineSessionStatsViewController::initFriendPortrait(ID param_1,SEL param_2)

{
  ...
  if (pIVar1 != (ID *)0x0) {
    ...
    *(undefined1 *)((long)local_18 + (long)_portraitMode) = 1;
    *(undefined1 *)((long)local_18 + (long)_isGroup) = 0;
    _objc_storeStrong((long)local_18 + (long)_chatUsr,&::cf___);
    _objc_storeStrong((long)local_18 + (long)_displayName,&cf__YS_uP);
  }
  pIVar1 = local_18;
