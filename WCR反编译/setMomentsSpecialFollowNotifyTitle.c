// setMomentsSpecialFollowNotifyTitle @ 01c1d258

/* Function Stack Size: 0x10 bytes */

void WCRefineMomentsViewController::setMomentsSpecialFollowNotifyTitle(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMomentsSpecialFollowNotify_026c13f8);
    (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_showTextFieldWithMaxLen__0269e5e0,0x50);
