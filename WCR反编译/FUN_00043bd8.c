// FUN_00043bd8 @ 00043bd8

byte FUN_00043bd8(undefined8 param_1,undefined8 param_2)
...
LAB_00043dec:
    ...
    if ((local_80 == (char *)0x0) || (pcVar4 == (char *)0x0)) {
      ...
      _objc_retainAutoreleasedReturnValue();
      local_a1 = false;
      bVar1 = local_138 == (char *)0x0;
      local_90 = local_138;
      if (bVar1) {
        local_138 = (char *)0x0;
      }
      else {
        (*(code *)PTR__objc_msgSend_02578628)(local_138,PTR_s_getService__0269d170,local_88);
        _objc_retainAutoreleasedReturnValue();
        local_a0 = local_138;
      }
      local_a1 = !bVar1;
    ...
    if ((uVar2 & 1) == 0) goto LAB_00043dec;
    local_31 = 0;
    local_6c = 1;
  }
