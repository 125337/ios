// setPluginFeatureHiddenItems: @ 0204835c

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setPluginFeatureHiddenItems_(ID param_1,SEL param_2,ID param_3)
  ...
  if (local_138 != 0) {
    ...
    do {
      do {
        ...
        if (((uVar6 & 1) != 0) &&
           (uVar6 = local_d8, (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_length_0269cca0),
           uVar6 != 0)) {
