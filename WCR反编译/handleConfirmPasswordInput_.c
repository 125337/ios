// handleConfirmPasswordInput: @ 01a3348c

/* Function Stack Size: 0x18 bytes */

void WCRefineGeneralFunctionViewController::handleConfirmPasswordInput_
...

{
  ...
  if (((ulong)puVar4 & 1) == 0) {
    ...
    local_58 = 0xc2000000;
    local_54 = 0;
    local_50 = FUN_01a337d8;
    local_48 = &DAT_0257a770;
    (*(code *)PTR__objc_retain_02578638)();
    local_40 = IVar1;
    (*(code *)PTR__objc_msgSend_02578628)
              (puVar3,PTR_s_showAlertWithTitle_message_btnTi_0269ccf0,&cf_WCRefine,&cf__N_keQv_xN,
               &::cf__,&local_60);
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showAlertWithTitle_message_btnTi_0269ccf0,
               &cf_WCRefine,&cf___T_u_OR_,&cf_nx_,&PTR___NSConcreteGlobalBlock_0258ad70);
    _objc_unsafeClaimAutoreleasedReturnValue();
  }
  puVar3 = PTR__OBJC_CLASS___NSUserDefaults_026ce338;
  (*(code *)PTR__objc_msgSend_02578628)
