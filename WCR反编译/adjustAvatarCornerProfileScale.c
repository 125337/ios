// adjustAvatarCornerProfileScale @ 0181e440

/* Function Stack Size: 0x10 bytes */

void WCRefineAvatarCornerBeautifyViewController::adjustAvatarCornerProfileScale
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_normalizedAvatarCornerProfileSca_026b6110);
  pcVar1 = local_28;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleAvatarCornerProfileScaleIn_026b6298);
