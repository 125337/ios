// FUN_01992684 @ 01992684

void FUN_01992684(long param_1)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(puVar1,PTR_s_setClipboard_mode__026ba590,puVar2,2);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__ReQ_4_gjRR);
