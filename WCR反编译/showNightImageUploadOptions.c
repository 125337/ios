// showNightImageUploadOptions @ 01cdf92c

/* Function Stack Size: 0x10 bytes */

void WCRefineProfileCardBeautifyViewController::showNightImageUploadOptions(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)();
  local_30 = pcVar1;
  _objc_setAssociatedObject(pcVar1,"imageType",&cf_night,1);
  pcVar1 = local_30;
  IVar2 = local_18;
