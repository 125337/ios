// setSuccessNotificationFormat @ 017488e4

/* Function Stack Size: 0x10 bytes */

void ThemeBoxAutoRedeemViewController::setSuccessNotificationFormat(ID param_1,SEL param_2)

{
  ...
  local_28 = pcVar2;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar2,PTR_s_themeBoxSuccessNotificationForma_026a8538);
  _objc_retainAutoreleasedReturnValue();
  local_a0 = pcVar2;
  ...
  if (bVar1) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_48,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_alertConfirmSuccessNotificationF_026b4118);
