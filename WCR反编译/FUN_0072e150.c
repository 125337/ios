// FUN_0072e150 @ 0072e150

/* WARNING: Restarted to delay deadcode elimination for space: stack */

byte FUN_0072e150(void)

{
  ...
  local_1a8 = &DAT_028cc470;
  local_1b0 = 0;
  _objc_storeStrong(&local_1b0,&cf_message_privacy);
  local_1b1 = 0;
  local_1b8 = 0x4e6b8a1c;
  if (local_1a8 == (undefined *)0x0) {
    ...
    if (local_13d == 0) {
      ...
      _objc_msgSend(PTR__OBJC_CLASS___NSThread_026ce0a8,PTR_s_isMainThread_0269d1e0);
      bVar2 = local_1b1;
      uVar1 = local_1b8;
      if (((ulong)puVar3 & 1) == 0) {
        local_1cd = 0;
