// setNavigationHomeOnlineAvatarHorizontalOffset: @ 0206ec40

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setNavigationHomeOnlineAvatarHorizontalOffset_
...

{
  ...
  _objc_retainAutoreleasedReturnValue();
  pcVar2 = &cf_tqqAvatarHorizontalOffset;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
