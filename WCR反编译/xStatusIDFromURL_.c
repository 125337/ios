// xStatusIDFromURL: @ 010552c4

/* Function Stack Size: 0x18 bytes */

ID WCRefineLinkParser::xStatusIDFromURL_(ID param_1,SEL param_2,ID param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR__OBJC_CLASS___NSRegularExpression_026ce2e0,
             PTR_s_regularExpressionWithPattern_opt_0269ef10,&cf__status___d__,1,0);
