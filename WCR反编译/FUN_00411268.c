// FUN_00411268 @ 00411268

void FUN_00411268(undefined8 param_1)

{
  ...
  if (uVar1 == 0) {
    ...
    if (local_1a0 != 0) {
      ...
      do {
        do {
          ...
          lVar7 = *(long *)(local_120 + local_1a8 * 8);
          local_e8 = lVar7;
          FUN_0040494c();
          _objc_retainAutoreleasedReturnValue();
          local_130 = lVar7;
    ...
    pcVar4 = local_e0;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_e0,PTR_s_componentsJoinedByString__0269d140,&cf_space_s_);
    _objc_retainAutoreleasedReturnValue();
    pcVar5 = pcVar4;
    FUN_0040494c();
    _objc_retainAutoreleasedReturnValue();
