// showPatAutoReplyMultiContentEditor @ 01a5d46c

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::showPatAutoReplyMultiContentEditor
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handlePatAutoReplyMultiInput__026bcf80);
