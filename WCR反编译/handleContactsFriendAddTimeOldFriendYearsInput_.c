// handleContactsFriendAddTimeOldFriendYearsInput: @ 01a6f698

/* Function Stack Size: 0x18 bytes */

void WCRefineGeneralFunctionViewController::handleContactsFriendAddTimeOldFriendYearsInput_
...

{
  ...
  if (pcVar2 != (cfstringStruct *)0x0) {
    ...
    if (pcVar2 == (cfstringStruct *)0x7fffffffffffffff) {
      ...
      puVar5 = (undefined1 *)((long)&local_40[-4].field3_0x18 + 4);
      if (puVar5 != (undefined1 *)0x0 && 99 < (long)local_40) {
        puVar5 = (undefined1 *)0x64;
        local_40 = (cfstringStruct *)0x64;
      }
      bVar1 = false;
    }
    else {
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_eQpeW_YuzzRN_T_u);
      puVar5 = (undefined1 *)0x1;
      bVar1 = true;
    }
    _objc_storeStrong(puVar5,&local_48,0);
    if (bVar1) goto LAB_01a6f9c8;
  }
