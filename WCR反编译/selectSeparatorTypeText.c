// selectSeparatorTypeText @ 01c64fc0

/* Function Stack Size: 0x10 bytes */

void WCRefineNavigationAvatarViewController::selectSeparatorTypeText(ID param_1,SEL param_2)

{
  undefined *puVar1;
  
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_triggerHapticFeedback_0269dc78);
  (*(code *)PTR__objc_msgSend_02578628)(param_1,PTR_s_setSeparatorType__026c1ee8,0);
