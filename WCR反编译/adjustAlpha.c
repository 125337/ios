// adjustAlpha @ 018827c0

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAttachmentBeautifyViewController::adjustAlpha(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgAlphaLight_0269f588);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgAlphaDark_0269f580);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleAlphaInput__026b6fd0);
