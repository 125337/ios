// FUN_017a7214 @ 017a7214

void FUN_017a7214(undefined8 param_1,undefined8 param_2)

{
  ...
  pcVar3 = &cf_WCRefineSearchSettingsViewController;
  local_30 = param_2;
  local_28 = param_1;
  _NSClassFromString();
    ...
    if (pcVar3 == (cfstringStruct *)0x0) {
      ...
      if (bVar2) {
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_40,PTR_s_setHidesBottomBarWhenPushed__0269db60,1);
        pcVar4 = local_50;
