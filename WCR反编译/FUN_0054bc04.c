// FUN_0054bc04 @ 0054bc04

void FUN_0054bc04(undefined8 param_1,undefined8 param_2)
      ...
      if (local_170 != 0) {
        ...
        do {
          do {
            ...
            uVar6 = *(ulong *)(local_110 + local_178 * 8);
            local_d8 = uVar6;
            ...
            if ((uVar6 & 1) != 0) {
              ...
              if (((uVar6 & 1) == 0) ||
                 (uVar4 = local_120,
                 (*(code *)PTR__objc_msgSend_02578628)
                           (local_120,PTR_s_isEqualToString__0269ccc8,local_c0), uVar6 = local_d8,
                 (uVar4 & 1) == 0)) {
                local_d0 = 0;
              }
              else {
              ...
              if (local_d0 != 0) goto LAB_0054bfe8;
            }
