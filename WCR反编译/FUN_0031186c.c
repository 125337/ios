// FUN_0031186c @ 0031186c

/* WARNING: Restarted to delay deadcode elimination for space: stack */

void FUN_0031186c(double param_1,undefined8 param_2,double param_3,double param_4,undefined8 param_5
                 ,undefined8 param_6)
      ...
      if (((ulong)puVar5 & 1) == 0) {
        ...
        if (local_b0 != local_30) {
          ...
          if (bVar3) {
            ...
            _CGRectGetMaxY(dVar7,param_3,param_2,param_1);
            dVar9 = local_60;
            param_1 = dStack_48;
            _CGRectGetMinY(local_60,uStack_58,local_50);
            param_2 = 0x3fe0000000000000;
            param_3 = dVar9 + 0.5;
            if ((dVar7 <= dVar9 + 0.5) && (dVar7 = dVar8, param_3 = local_98, local_98 < dVar8)) {
              local_98 = dVar8;
