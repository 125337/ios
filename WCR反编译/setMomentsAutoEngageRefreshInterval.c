// setMomentsAutoEngageRefreshInterval @ 01c0b0e0

/* Function Stack Size: 0x10 bytes */

void WCRefineMomentsViewController::setMomentsAutoEngageRefreshInterval(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMomentsAutoEngageRefreshIn_026c1180);
    (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_showTextFieldWithMaxLen__0269e5e0,4);
    pcVar1 = local_38;
