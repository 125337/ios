// FUN_00816cbc @ 00816cbc

void FUN_00816cbc(undefined *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (bVar1) {
    local_d8 = local_28;
    (*DAT_028cd100)(local_28,local_30,local_38,local_40);
    _objc_retainAutoreleasedReturnValue();
    local_80 = local_d8;
  }
  else {
