// FUN_00563420 @ 00563420

undefined1  [16]
FUN_00563420(double param_1,double param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5)

{
  ...
  if (((ulong)puVar2 & 1) == 0) {
    dVar3 = local_38;
    dVar4 = local_40;
    (*DAT_028cb4f8)(local_28,local_30,local_48);
    local_20 = dVar3;
    local_18 = dVar4;
  }
  else {
