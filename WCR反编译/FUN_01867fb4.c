// FUN_01867fb4 @ 01867fb4

void FUN_01867fb4(undefined8 param_1,undefined8 param_2)
...
LAB_0186808c:
    pcVar2 = local_80;
    FUN_0185efe4(local_80,local_88);
    _objc_retainAutoreleasedReturnValue();
    pcVar1 = local_78;
    local_78 = pcVar2;
    ...
    if (((ulong)pcVar1 & 1) != 0) goto LAB_0186808c;
  }
  pcVar1 = local_78;
  if (local_78 == (cfstringStruct *)0x0) {
    local_70 = (undefined *)0x0;
    ...
    puVar3 = PTR_WCRefineBatchRemarkCandidate_026cf0a0;
    _objc_alloc_init();
