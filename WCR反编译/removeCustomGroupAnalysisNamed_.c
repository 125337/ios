// removeCustomGroupAnalysisNamed: @ 009b18a0

/* Function Stack Size: 0x18 bytes */

bool WCRefineAIStore::removeCustomGroupAnalysisNamed_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (lVar8 == 0) {
    ...
    IVar2 = local_d8;
    (*(code *)PTR__objc_msgSend_02578628)(local_d8,PTR_s_customGroupAnalysisPersonas_026aac68);
    _objc_retainAutoreleasedReturnValue();
    IVar3 = IVar2;
