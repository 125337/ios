// parseTextForDouyinLinkCard:completion: @ 0102b070

/* Function Stack Size: 0x20 bytes */

void WCRefineLinkParser::parseTextForDouyinLinkCard_completion_
...

{
  ...
  if (IVar4 == 0) {
    ...
    local_88 = 0xc2000000;
    local_84 = 0;
    local_80 = FUN_0102b3d4;
    local_78 = &DAT_025846e0;
    (*(code *)PTR__objc_retain_02578638)();
    local_70 = lVar2;
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar3,PTR_s_parseURL_cardPlaybackEnough_comp_026ade10,IVar4,1,&local_90);
