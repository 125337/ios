// FUN_002ae960 @ 002ae960

void FUN_002ae960(undefined8 param_1,undefined8 param_2)

{
  ...
  if (local_150 != 0) {
    ...
    do {
      do {
        ...
        uVar5 = *(ulong *)(local_110 + local_158 * 8);
        local_d8 = uVar5;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_c0,PTR_s_sortUsingComparator__0269d168,&PTR___NSConcreteGlobalBlock_0257b918);
  puVar1 = local_c0;
