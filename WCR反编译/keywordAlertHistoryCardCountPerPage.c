// keywordAlertHistoryCardCountPerPage @ 01fe27c4

/* Function Stack Size: 0x10 bytes */

unsigned_long_long WCRefineConfig::keywordAlertHistoryCardCountPerPage(ID param_1,SEL param_2)

{
  ...
  else if (8 < (long)local_38) {
    local_38 = &MACH_HEADER.cpusubtype;
  }
  _objc_storeStrong(&local_30);
  _objc_storeStrong(&local_28,0);
  return (unsigned_long_long)local_38;
}
