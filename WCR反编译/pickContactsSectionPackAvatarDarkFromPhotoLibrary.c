// pickContactsSectionPackAvatarDarkFromPhotoLibrary @ 01b57690

/* Function Stack Size: 0x10 bytes */

void WCRefineLayoutFunctionViewController::pickContactsSectionPackAvatarDarkFromPhotoLibrary
...

{
  ...
  if (((ulong)puVar2 & 1) == 0) {
    ...
    puVar1 = local_38;
    puVar2 = PTR_s_pickContactsSectionPackAvatarDar_026bd2c0;
