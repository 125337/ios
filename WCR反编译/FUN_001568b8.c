// FUN_001568b8 @ 001568b8

undefined1  [16] FUN_001568b8(double param_1,double param_2,undefined8 param_3)

{
  ...
  uVar3 = local_38;
  _objc_getAssociatedObject(local_38,DAT_026df930);
  ...
  if ((((uVar3 & 1) == 0) ||
    ...
    if ((uVar3 & 1) != 0) {
      ...
      if (local_3c != 0) goto LAB_00156bd0;
    }
    dStack_28 = *(double *)(PTR__CGSizeZero_025782f8 + 8);
    local_30 = *(double *)PTR__CGSizeZero_025782f8;
    local_3c = 1;
