// FUN_015e5084 @ 015e5084

void FUN_015e5084(long param_1)
  ...
  if (lVar1 == 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if (((ulong)puVar5 & 1) == 0) {
        ...
        (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_wcr_onSystemScreenshot_026b1200);
        local_34 = 0;
      }
    }
    else {
