// metricSliderForTag:min:max:value: @ 01d0bb04

/* WARNING: Removing unreachable block (ram,0x01d0c150) */
/* Function Stack Size: 0x30 bytes */

ID WCRefineQuickChatSettingsViewController::metricSliderForTag_min_max_value_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_e8,PTR_s_setTag__026caa80,&UNK_00002328 + local_38);
  puVar1 = local_e8;
  ...
  IVar3 = local_28;
  (*(code *)PTR__objc_msgSend_02578628)
            (local_58,local_28,PTR_s_displayTextForTag_value__026c3d40,local_38);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_e8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_metricValueButtonTapped__026c3d48,0x40);
