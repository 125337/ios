// FUN_00907bcc @ 00907bcc

void FUN_00907bcc(long param_1)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(uVar1,PTR_s_logTextView_026a9fc0);
  ...
  (*(code *)PTR__objc_msgSend_02578628)(lVar2,PTR_s_activeLogType_026aa060);
  if (lVar2 == 3) {
