// showPatAutoReplyTextEditor @ 01a61360

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::showPatAutoReplyTextEditor(ID param_1,SEL param_2)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(pcVar3,PTR_s_initWithTitle_message__0269d260,&cf_bb);
  local_30 = pcVar3;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_OX_,local_18,
             PTR_s_handlePatAutoReplyTextInput__026bd068);
