// FUN_01584d58 @ 01584d58

void FUN_01584d58(undefined8 param_1)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    if (local_140 != 0) {
      ...
      do {
        do {
          ...
          if (((uVar5 & 1) != 0) &&
             (uVar5 = local_d0,
             (*(code *)PTR__objc_msgSend_02578628)(local_d0,PTR_s_length_0269cca0), uVar5 != 0)) {
    ...
    pcVar3 = local_c8;
    (*(code *)PTR__objc_msgSend_02578628)(local_c8,PTR_s_componentsJoinedByString__0269d140,&cf__);
    _objc_retainAutoreleasedReturnValue();
    local_bc = 1;
    local_b0 = pcVar3;
