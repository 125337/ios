// WCRefineToDo_tableView:commitEditingStyle:forRowAtIndexPath: @ 007f6d10

/* Function Stack Size: 0x28 bytes */

void WCRefineToDoHook::WCRefineToDo_tableView_commitEditingStyle_forRowAtIndexPath_
...

{
  ...
  if (((IVar3 & 1) == 0) || (local_28 != local_40)) {
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_WCRefineToDo_tableView_commitEdi_026a8890,local_28,local_30,local_38);
  }
  else {
    IVar4 = local_28;
    ...
    if (IVar5 != IVar4) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (IVar2,PTR_s_WCRefineToDo_tableView_commitEdi_026a8890,IVar3,lVar1);
