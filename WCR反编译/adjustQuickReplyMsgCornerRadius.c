// adjustQuickReplyMsgCornerRadius @ 01b9f0a8

/* Function Stack Size: 0x10 bytes */

void WCRefineMessageBannerBeautifyViewController::adjustQuickReplyMsgCornerRadius
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleQuickReplyMsgRadiusInput__026c01c8);
