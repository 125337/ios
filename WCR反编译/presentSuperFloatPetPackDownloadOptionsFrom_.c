// presentSuperFloatPetPackDownloadOptionsFrom: @ 00fc00b4

/* Function Stack Size: 0x18 bytes */

void WCRefineHelper::presentSuperFloatPetPackDownloadOptionsFrom_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (local_30 == 0) {
    ...
    ppuVar4 = &PTR___NSConcreteGlobalBlock_02583b20;
    local_50 = pcVar3;
    _objc_retainBlock();
    (*(code *)PTR__objc_msgSend_02578628)(pcVar3,puVar2,&cf_8YKQQ_v);
    (*(code *)PTR__objc_release_02578630)(ppuVar4);
    pcVar3 = local_50;
    puVar2 = PTR_s_addButtonWithTitle_eventAction__026a0f60;
    ppuVar4 = &PTR___NSConcreteGlobalBlock_02583b40;
    _objc_retainBlock();
    (*(code *)PTR__objc_msgSend_02578628)(pcVar3,puVar2,&cf__v_Q_v);
    (*(code *)PTR__objc_release_02578630)(ppuVar4);
    pcVar3 = local_50;
    (*(code *)PTR__objc_msgSend_02578628)
