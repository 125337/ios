// createBackgroundMediaFolder @ 01aed1b4

/* Function Stack Size: 0x10 bytes */

void WCRefineHomeAvatarStripSettingsViewController::createBackgroundMediaFolder
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_R_,local_18,
               PTR_s_confirmCreateBackgroundFolder_026be550);
