// alertConfirmLift: @ 00ecec58

/* Function Stack Size: 0x18 bytes */

void WCRefineChatIndentOverrideHelper::alertConfirmLift_(ID param_1,SEL param_2,ID param_3)
  ...
  if (lVar2 == 0) {
    ...
    if (bVar1) {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_18,PTR_s_saveLiftOverrideForSession_value_026ab5b0,local_30,local_48);
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__OX_USJNnm);
      (*(code *)PTR__objc_msgSend_02578628)
