// editTitleLongPressProtectionSeconds @ 01cb427c

/* Function Stack Size: 0x10 bytes */

void WCRefinePrivateFriendViewController::editTitleLongPressProtectionSeconds
  ...
  if (pcVar2 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleTitleLongPressProtectionSe_026c31f0);
