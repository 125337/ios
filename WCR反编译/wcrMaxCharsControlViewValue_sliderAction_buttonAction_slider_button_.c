// wcrMaxCharsControlViewValue:sliderAction:buttonAction:slider:button: @ 017bf628

/* WARNING: Removing unreachable block (ram,0x017bfba0) */
/* Function Stack Size: 0x38 bytes */

ID WCRefineAIFeatureViewController::
   wcrMaxCharsControlViewValue_sliderAction_buttonAction_slider_button_
             (ID param_1,SEL param_2,long_long param_3,SEL param_4,SEL param_5,ID *param_6,
             ID *param_7)

{
  ...
  local_88 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(0x41a00000,puVar1,PTR_s_setMinimumValue__026b2338);
  (*(code *)PTR__objc_msgSend_02578628)(0x44480000,local_88,PTR_s_setMaximumValue__026b2340);
  (*(code *)PTR__objc_msgSend_02578628)(local_88,PTR_s_setContinuous__026b4d68,1);
  puVar1 = local_88;
  (*(code *)PTR__objc_msgSend_02578628)((float)(long)local_38,local_88,PTR_s_setValue__026a51b0);
  FUN_017bfe4c();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_88,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,local_40,0x1000);
  ...
  local_b8 = puVar1;
  FUN_017bfe00();
  (*(code *)PTR__objc_msgSend_02578628)(uVar3,uVar4,uVar5,uVar6,local_b8,PTR_s_setFrame__026ca960);
  puVar1 = local_b8;
  ...
  (*(code *)PTR__objc_release_02578630)(puVar2);
  (*(code *)PTR__objc_msgSend_02578628)
            (local_b8,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,local_48,0x40);
