// FUN_006b07a0 @ 006b07a0

void FUN_006b07a0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (((ulong)puVar2 & 1) == 0) {
    uVar3 = local_20;
    (*DAT_028cc008)(local_20,local_28,local_30,param_4);
    _objc_retainAutoreleasedReturnValue();
    local_18 = uVar3;
  }
  else {
