// adjustAvatarCornerBorderSize @ 0181e728

/* Function Stack Size: 0x10 bytes */

void WCRefineAvatarCornerBeautifyViewController::adjustAvatarCornerBorderSize
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleAvatarCornerBorderSizeInpu_026b62a8);
