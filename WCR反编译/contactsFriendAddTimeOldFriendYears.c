// contactsFriendAddTimeOldFriendYears @ 02129ef8

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::contactsFriendAddTimeOldFriendYears(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_contactsFriendAddTimeOldFriendYears);
  _objc_retainAutoreleasedReturnValue();
  ...
  if ((param_1 & 1) == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_28,PTR_s_setObject_forKey__026ca9e8,local_30,
               &cf_contactsFriendAddTimeOldFriendYears);
