// handleTitleLongPressPassword: @ 01114c94

/* Function Stack Size: 0x18 bytes */

void WCRefinePrivateFriendManager::handleTitleLongPressPassword_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((IVar3 & 1) == 0) {
    ...
    IVar3 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_pendingTitleLongPressSuccess_026aefb8);
    _objc_retainAutoreleasedReturnValue();
    local_48 = IVar3;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_setPendingTitleLongPressSuccess__026aef88,0);
    if (local_48 != 0) {
      (**(code **)(local_48 + 0x10))();
    }
