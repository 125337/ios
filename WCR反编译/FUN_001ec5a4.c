// FUN_001ec5a4 @ 001ec5a4

void FUN_001ec5a4(void)

{
  ...
  local_30 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(puVar5,PTR_s_topbarCornerBorderColorLight_026a02e8);
  _objc_retainAutoreleasedReturnValue();
  local_d8 = local_30;
  local_38 = puVar5;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_topbarCornerBorderColorDark_026a02f0);
  _objc_retainAutoreleasedReturnValue();
  local_50[0] = local_d8;
