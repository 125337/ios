// setNavigationHomeOnlineTextColorDark: @ 02071238

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setNavigationHomeOnlineTextColorDark_(ID param_1,SEL param_2,ID param_3)

{
  ...
  pcVar2 = &cf_tqqOnlineTextColorDark;
  local_30 = IVar1;
  FUN_0206e96c();
  _objc_retainAutoreleasedReturnValue();
  lVar3 = local_28;
