// showMsgBannerDocumentPickerForImageType: @ 01b988a8

/* Function Stack Size: 0x18 bytes */

void WCRefineMessageBannerBeautifyViewController::showMsgBannerDocumentPickerForImageType_
...

{
  ...
  FUN_01b98aa8(&cf_opendocumentpickerimageType___);
