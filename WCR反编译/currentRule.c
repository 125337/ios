// currentRule @ 01bb8988

/* Function Stack Size: 0x10 bytes */

ID WCRefineMessageSyncRuleViewController::currentRule(ID param_1,SEL param_2)
  ...
  if (local_130 != (undefined *)0x0) {
    ...
    do {
      do {
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (PTR_WCRefineMessageSyncRule_026ce708,PTR_s_ruleID__026a4500,local_c8);
        _objc_retainAutoreleasedReturnValue();
        IVar4 = local_b8;
        (*(code *)PTR__objc_msgSend_02578628)(local_b8,PTR_s_ruleID_026c04a0);
        _objc_retainAutoreleasedReturnValue();
        puVar5 = puVar3;
