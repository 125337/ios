// createMessageNoRevokeDualColorPreviewWithLightHex:darkHex:defaultHex: @ 01a71c40

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x28 bytes */

ID WCRefineGeneralFunctionViewController::
   createMessageNoRevokeDualColorPreviewWithLightHex_darkHex_defaultHex_
...

{
  ...
  if (bVar1) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (uVar3,uVar2,0,0x3ff0000000000000,PTR__OBJC_CLASS___UIColor_026cdf78,
