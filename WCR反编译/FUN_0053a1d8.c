// FUN_0053a1d8 @ 0053a1d8

/* WARNING: Restarted to delay deadcode elimination for space: ram */

void FUN_0053a1d8(void)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(DAT_028cb270,PTR_s_setLocale__0269d1c0);
  (*(code *)PTR__objc_release_02578630)(puVar2);
  puVar2 = PTR__OBJC_CLASS___NSTimeZone_026ce360;
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR__OBJC_CLASS___NSTimeZone_026ce360,PTR_s_localTimeZone_0269f9d0);
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(DAT_028cb270,PTR_s_setTimeZone__0269f9d8);
  (*(code *)PTR__objc_release_02578630)(puVar2);
  return;
}
