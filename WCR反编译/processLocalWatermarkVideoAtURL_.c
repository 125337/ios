// processLocalWatermarkVideoAtURL: @ 006efc00

/* Function Stack Size: 0x18 bytes */

void WCRefineScreenRecordingFrameProcessor::processLocalWatermarkVideoAtURL_
...

{
  ...
  if ((local_28 == 0) ||
    ...
    IVar2 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_wcr_videoWatermarkLayers_026a6fe8);
    _objc_retainAutoreleasedReturnValue();
    local_40 = IVar2;
    (*(code *)PTR__objc_msgSend_02578628)(IVar2,PTR_s_count_0269cfe0);
    if (IVar2 == 0) {
      (*(code *)PTR__objc_msgSend_02578628)
                (local_18,PTR_s_wcr_showToast__026a6ef8,&cf_HQbU_O_4lpS_j_g);
      local_38 = 1;
    }
    else {
      IVar2 = local_18;
      ...
      if ((IVar2 & 1) == 0) {
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_18,PTR_s_wcr_showToast__026a6ef8,&cf__g0WU_O_4lpSYt_N_);
        (*(code *)PTR__objc_msgSend_02578628)
                  (DAT_02323e38,local_18,PTR_s_wcr_showProgressHUDStage_progres_026a7008,&cf_4lpS_,1
                  );
        ...
        local_48 = puVar4;
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_18,PTR_s_wcr_runPipelineWithAVAsset_audio_026a7058,puVar4,0,0,0,0,1,
                   local_40,0,0);
