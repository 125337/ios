// sessionStatsCustomEnd @ 0212d388

/* Function Stack Size: 0x10 bytes */

double __thiscall WCRefineConfig::sessionStatsCustomEnd(WCRefineConfig *this,ID param_1,SEL param_2)

{
  ...
  local_30 = param_1;
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_objectForKey__0269e048,&cf_sessionStatsCustomEnd);
  _objc_retainAutoreleasedReturnValue();
