// FUN_0086627c @ 0086627c

void FUN_0086627c(void)
        ...
        do {
          do {
            ...
            while (puVar3 = local_2a0,
              ...
              puVar3 = local_2a8;
              (*(code *)PTR__objc_msgSend_02578628)
                        (local_2a8,PTR_s_isMemberOfClass__026a2030,local_248);
              if (((ulong)puVar3 & 1) != 0) {
                FUN_0087a168(local_2a8);
              }
              ...
              if (((ulong)puVar3 & 1) == 0) {
                ...
                if (((ulong)puVar4 & 1) != 0) {
                  ...
                  local_530 = local_518;
                  (*(code *)PTR__objc_msgSend_02578628)
                            (local_518,PTR_s_countByEnumeratingWithState_obje_0269cd58,auStack_390,
                             auStack_228,0x10);
                    ...
                    do {
                      do {
                        if (*local_380 - lVar6 != 0) {
                          _objc_enumerationMutation(*local_380 - lVar6,local_518);
                        }
                        local_350 = *(undefined8 *)(local_388 + (long)local_538 * 8);
                        (*(code *)PTR__objc_msgSend_02578628)
                      ...
                      local_530 = local_518;
                      (*(code *)PTR__objc_msgSend_02578628)
                                (local_518,PTR_s_countByEnumeratingWithState_obje_0269cd58,
                                 auStack_390,auStack_228,0x10);
                      local_538 = (undefined *)0x0;
