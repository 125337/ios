// createKeywordFilterCell @ 01d21460

/* Function Stack Size: 0x10 bytes */

ID WCRefineRedEnvelopViewController::createKeywordFilterCell(ID param_1,SEL param_2)

{
  ...
  if (puVar1 == (undefined *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(local_50,PTR_s_stringWithFormat__0269cca8,&cf__n_);
    _objc_retainAutoreleasedReturnValue();
    local_40 = local_50;
  }
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineHelper_026ce000,PTR_s_normalCellWithSel_target_title_r_0269e3f0,
             PTR_s_showKeywordFilter_026c4240,local_18,&cf_sQ_Gln,local_38,0);
  _objc_retainAutoreleasedReturnValue();
