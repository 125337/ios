// openGroupSwitchSpacingCustomization @ 01c874a4

/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefinePluginContainerSettingsViewController::openGroupSwitchSpacingCustomization
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30[0],PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_saveGroupSwitchSpacing__026c29b8);
