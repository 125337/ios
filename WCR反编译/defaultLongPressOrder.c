// defaultLongPressOrder @ 010fbab0

/* Function Stack Size: 0x10 bytes */

ID WCRefinePluginIconCatalog::defaultLongPressOrder(ID param_1,SEL param_2)

{
  ...
  IVar2 = local_b0;
  (*(code *)PTR__objc_msgSend_02578628)(local_b0,PTR_s_defaultLongPressEntries_026aecf8);
  _objc_retainAutoreleasedReturnValue();
  local_130 = IVar2;
  (*(code *)PTR__objc_msgSend_02578628)();
  if (local_130 != 0) {
