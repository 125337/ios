// beginEditURLAtIndex: @ 01e338d8

/* Function Stack Size: 0x18 bytes */

void WCRefineSuperFloatURLSchemeViewController::beginEditURLAtIndex_
...

{
  ...
  if ((-1 < (long)local_28) &&
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar2,PTR_s_presentTextAlertTitle_message_pl_026c6350,&cf_URLScheme,&cf_S_u,local_60,
               300,PTR_s_handleSaveURLOnly__026c6360);
