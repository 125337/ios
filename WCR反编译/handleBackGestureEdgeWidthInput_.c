// handleBackGestureEdgeWidthInput: @ 01a4fa68

/* Function Stack Size: 0x18 bytes */

void WCRefineGeneralFunctionViewController::handleBackGestureEdgeWidthInput_
...

{
  ...
  if ((((pcVar1 == (cfstringStruct *)0x0) ||
      ...
      ((ulong)puVar2 & 1) == 0)) || ((local_40 < 10 || (0x78 < local_40)))) {
    (*(code *)PTR__objc_msgSend_02578628)
