// setKeywordAlertNotifyForwardSession: @ 01fe0b68

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setKeywordAlertNotifyForwardSession_(ID param_1,SEL param_2,ID param_3)

{
  ...
  _cmdString();
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)(IVar2,PTR_s_setObject_forKey__026ca9e8,local_a0);
