// FUN_014e8180 @ 014e8180

void FUN_014e8180(undefined8 param_1,undefined8 param_2,ulong param_3)

{
  ...
  if (((local_20 == 0) || (param_3 == 0)) ||
     (uVar1 = local_20,
     (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_commonGroupCount_026af808), uVar1 == 0)) {
    lVar4 = 1;
  }
  else {
    local_38 = local_18;
    ...
    for (local_40 = 0; uVar1 = local_18,
        ...
        local_40 = local_40 + 1) {
      uVar1 = local_20;
      (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_commonGroupCount_026af808);
      uVar2 = local_18;
