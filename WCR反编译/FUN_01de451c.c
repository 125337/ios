// FUN_01de451c @ 01de451c

void FUN_01de451c(long param_1)

{
  ...
  if (lVar2 == 0) {
    local_60 = &cf_sQlvN_nzz;
  }
  else {
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_count_0269cfe0);
    (*(code *)PTR__objc_msgSend_02578628)(local_60,PTR_s_stringWithFormat__0269cca8,&cf__sQl);
    _objc_retainAutoreleasedReturnValue();
    local_38 = local_60;
  }
