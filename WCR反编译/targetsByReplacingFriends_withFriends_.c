// targetsByReplacingFriends:withFriends: @ 014b9658

/* Function Stack Size: 0x20 bytes */

ID WCRefineScheduledTask::targetsByReplacingFriends_withFriends_
  ...
  if (local_208 != 0) {
    ...
    do {
      do {
        ...
        if (((IVar3 & 1) != 0) ||
           (IVar3 = local_130,
           (*(code *)PTR__objc_msgSend_02578628)(local_130,PTR_s_isGroupTarget__026af4a8,local_158),
           (IVar3 & 1) != 0)) {
