// FUN_0078cce4 @ 0078cce4

byte FUN_0078cce4(undefined8 param_1)
    ...
    if (uVar2 == 0) {
      ...
      if (puVar3 == (undefined *)0x0) {
        ...
        if (uVar2 == 0) {
          ...
          (*(code *)PTR__objc_msgSend_02578628)
                    (uVar2,PTR_s_respondsToSelector__026ca818,PTR_s_clickEditRevokeContent__026a4368
                    );
          if ((uVar2 & 1) == 0) {
            local_21 = 0;
            local_34 = 1;
            ...
            puVar3 = PTR_WCRefineSwipeReusePayload_026ce930;
            _objc_alloc_init();
            local_68 = puVar3;
            (*(code *)PTR__objc_msgSend_02578628)
            ...
            ;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_68,PTR_s_setReEditAtUserList__026a4288,&cf___);
