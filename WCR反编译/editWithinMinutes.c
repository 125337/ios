// editWithinMinutes @ 01bc047c

/* Function Stack Size: 0x10 bytes */

void WCRefineMessageSyncRuleViewController::editWithinMinutes(ID param_1,SEL param_2)

{
  ...
  if (IVar2 != 0) {
    ...
    local_70 = 0xc2000000;
    local_6c = 0;
    local_68 = FUN_01bc067c;
    local_60 = &DAT_0257c558;
    _objc_copyWeak(auStack_58,auStack_40);
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar1,PTR_s_showTextInputWithTitle_message_i_026c0570,&cf_NTekeHeQ,&cf_STek,puVar3,5,
               1,&local_78,puVar4);
