// showUploadOptionsForVariant: @ 01aed808

/* Function Stack Size: 0x18 bytes */

void WCRefineHomeAvatarStripSettingsViewController::showUploadOptionsForVariant_
  ...
  if (pcVar2 == (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar2,PTR_s_addBtnTitle_target_sel__0269d278,&cf_NvQbVGr_,local_18,
               PTR_s_pickBackgroundFromPhotos_026be578);
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_NeNbVGr_,local_18,
               PTR_s_pickBackgroundFromFiles_026be580);
    (*(code *)PTR__objc_msgSend_02578628)
