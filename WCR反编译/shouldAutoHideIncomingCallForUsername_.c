// shouldAutoHideIncomingCallForUsername: @ 00f22964

/* Function Stack Size: 0x18 bytes */

bool WCRefineDoNotDisturbSupport::shouldAutoHideIncomingCallForUsername_
...

{
  ...
  local_32 = (byte)IVar2;
  puVar3 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_doNotDisturbAutoHideCallsEnabled_026abe10);
  local_33 = (byte)puVar3;
  puVar3 = local_30;
  (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_doNotDisturbHangupCallsEnabled_026abe08);
  local_34 = (byte)puVar3;
  puVar3 = local_30;
  ...
  FUN_00f21ee4();
  local_4b = false;
  if (((((local_31 & 1) != 0) && ((local_32 & 1) != 0)) && ((local_34 & 1) == 0)) &&
     (((local_33 & 1) != 0 && ((uVar4 & 1) == 0)))) {
    uVar4 = local_48;
