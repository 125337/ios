// systemNoticeColorLight @ 020dd050

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::systemNoticeColorLight(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    _objc_retainAutoreleasedReturnValue();
    local_40 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setSystemNoticeColorLight__026b9298,puVar2)
    ;
    puVar2 = local_40;
