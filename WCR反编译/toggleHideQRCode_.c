// toggleHideQRCode: @ 01f405f4

/* Function Stack Size: 0x18 bytes */

void WCRefineUICleanViewController::toggleHideQRCode_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if ((uVar2 & 1) != 0) {
    ...
    local_30 = pcVar3;
    (*(code *)PTR__objc_msgSend_02578628)
              (pcVar3,PTR_s_addBtnTitle_target_sel__0269d278,&cf_wSN,local_18,
