// smallSignalNotify31MaxCountPerTenSeconds @ 02182914

/* Function Stack Size: 0x10 bytes */

unsigned_long_long WCRefineConfig::smallSignalNotify31MaxCountPerTenSeconds(ID param_1,SEL param_2)

{
  ...
  local_38 = local_40;
  if (((long)local_40 < 1) || (0x1e < (long)local_40)) {
    local_38 = 5;
  }
  if ((local_30 == 0) ||
