// hideWeToastAndShowErrorWithText:fromToast: @ 00f9a1e0

/* Function Stack Size: 0x20 bytes */

void WCRefineHelper::hideWeToastAndShowErrorWithText_fromToast_
...

{
  ...
  if (local_30 == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_showWeToastErrorWithText__0269ced8,local_58);
  }
  else {
    ...
    uVar3 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_respondsToSelector__026ca818,PTR_s_showErrorToastWithText__026a9930);
    if ((uVar3 & 1) == 0) {
      if (local_28 == (cfstringStruct *)0x0) {
        local_a0 = &cf_1Y_;
      }
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_30,PTR_s_performSelector_withObject__026ca7c0,
                 PTR_s_showErrorToastWithText__026a9930,local_88);
    }
  }
