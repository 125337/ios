// FUN_0056379c @ 0056379c

undefined1  [16]
FUN_0056379c(double param_1,double param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5)

{
  ...
  if (((ulong)puVar2 & 1) == 0) {
    dVar3 = local_38;
    (*DAT_028cb508)(local_28,local_30,local_40);
    local_20 = dVar3;
    local_18 = param_2;
  }
  else {
