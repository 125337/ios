// toggleMsgBannerQuickSettingsEnabled: @ 01b91144

/* Function Stack Size: 0x18 bytes */

void WCRefineMessageBannerBeautifyViewController::toggleMsgBannerQuickSettingsEnabled_
  ...
  if (((uVar3 & 1) != 0) && (((ulong)puVar2 & 1) == 0)) {
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showAlertWithTitle_message_btnTi_0269ccf0,
               &cf_WCRefine,&cf_J_YueQ,&cf_wSN,0);
