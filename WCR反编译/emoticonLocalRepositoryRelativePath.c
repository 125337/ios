// emoticonLocalRepositoryRelativePath @ 02194438

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::emoticonLocalRepositoryRelativePath(ID param_1,SEL param_2)

{
  ...
  if ((((ulong)pcVar4 & 1) == 0) ||
    ...
    _objc_storeStrong(&local_30,&cf_Library_Preferences_WCRefine_localemotions);
    pcVar1 = local_28;
    pcVar4 = local_30;
    SVar2 = local_20;
    _cmdString();
  ...
  if (pcVar4 == (cfstringStruct *)0x0) {
    local_78 = &cf_Library_Preferences_WCRefine_localemotions;
  }
