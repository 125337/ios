// showNativeSheetTitle:actions: @ 019573d4

/* WARNING: Type propagation algorithm not settling */
/* Function Stack Size: 0x20 bytes */

void WCRefineFakeLocationSettingsViewController::showNativeSheetTitle_actions_
...

{
  ...
  if ((local_d0 == (char *)0x0) || (pcVar3 == (char *)0x0)) {
    ...
    _objc_storeStrong(local_b0 + (long)_sheetActions,local_c8[0]);
    pcVar2 = local_d0;
    _objc_alloc();
    (*(code *)PTR__objc_msgSend_02578628)();
