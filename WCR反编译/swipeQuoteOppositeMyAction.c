// swipeQuoteOppositeMyAction @ 020c553c

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::swipeQuoteOppositeMyAction(ID param_1,SEL param_2)

{
  ...
  if (((long)local_38 < 0) || (0xc < (long)local_38)) {
    local_38 = (undefined *)((long)&MACH_HEADER.cputype + 2);
    puVar4 = PTR__OBJC_CLASS___NSNumber_026ce038;
    (*(code *)PTR__objc_msgSend_02578628)
