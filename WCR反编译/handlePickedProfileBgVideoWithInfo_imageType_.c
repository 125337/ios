// handlePickedProfileBgVideoWithInfo:imageType: @ 01cdfaa4

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x20 bytes */

void WCRefineProfileCardBeautifyViewController::handlePickedProfileBgVideoWithInfo_imageType_
...

{
  ...
  if ((local_d0 == 0) ||
    ...
    if (bVar1) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_b0,PTR_s_copyProfileBgImageFromURL_forIma_026c3948,local_1b0,local_c8,0);
    }
    ...
    if (local_1f8 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          if (local_13c != 3) goto LAB_01cdfe24;
...
LAB_01cdfe24:
    ...
    if (local_e0 == (cfstringStruct *)0x0) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (puVar3,PTR_s_stringWithFormat__0269cca8,&cf_wcr_profilebg_________);
      _objc_retainAutoreleasedReturnValue();
      local_148 = puVar3;
