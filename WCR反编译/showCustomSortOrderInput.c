// showCustomSortOrderInput @ 01ca51fc

/* Function Stack Size: 0x10 bytes */

void WCRefinePluginManagementViewController::showCustomSortOrderInput(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    if ((pcVar1 != (char *)0x0) &&
       ...
       ((ulong)pcVar1 & 1) != 0)) {
      (*(code *)PTR__objc_msgSend_02578628)(local_48,PTR_s_setKeyboardType__026aec58,4);
    }
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_40,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_customSortOrderConfirm__026c2e50);
