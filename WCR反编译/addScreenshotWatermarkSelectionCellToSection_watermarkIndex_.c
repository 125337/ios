// addScreenshotWatermarkSelectionCellToSection:watermarkIndex: @ 017f057c

/* Function Stack Size: 0x20 bytes */

void WCRefineAssistFunctionViewController::
     addScreenshotWatermarkSelectionCellToSection_watermarkIndex_
...

{
  ...
  IVar7 = local_18;
  (*(code *)PTR__objc_msgSend_02578628)
            (local_18,PTR_s_screenshotWatermarkSelectionStat_026b5850,local_30);
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)
