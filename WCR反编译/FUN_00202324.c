// FUN_00202324 @ 00202324

void FUN_00202324(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (((local_40 == 0) || (local_48 == 0)) ||
    ...
    if (uVar2 == 0) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)(local_78,PTR_s_setSelector__0269e1b0,local_48);
      (*(code *)PTR__objc_msgSend_02578628)
                (local_78,PTR_s_setArgument_atIndex__0269eae8,&local_38,2);
      (*(code *)PTR__objc_msgSend_02578628)
                (local_78,PTR_s_setArgument_atIndex__0269eae8,&local_50,3);
      (*(code *)PTR__objc_msgSend_02578628)
                (local_78,PTR_s_setArgument_atIndex__0269eae8,&local_58,4);
      (*(code *)PTR__objc_msgSend_02578628)(local_78,PTR_s_invoke_0269e1b8);
      local_80 = 0;
      (*(code *)PTR__objc_msgSend_02578628)(local_78,PTR_s_getReturnValue__0269e1c0,&local_80);
      uVar1 = local_80;
