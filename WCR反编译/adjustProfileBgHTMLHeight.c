// adjustProfileBgHTMLHeight @ 01cdd458

/* Function Stack Size: 0x10 bytes */

void __thiscall
WCRefineProfileCardBeautifyViewController::adjustProfileBgHTMLHeight
          (WCRefineProfileCardBeautifyViewController *this,ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)();
  local_28 = pcVar1;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_showTextFieldWithMaxLen__0269e5e0,8);
  ...
  (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_setTextFieldDefaultText__0269fd98,local_60);
  if (1.0 <= in_d0) {
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleHTMLHeightInput__026c3920);
