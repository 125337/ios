// FUN_01562158 @ 01562158

undefined8 FUN_01562158(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (uVar3 < local_3c) {
    ...
    uVar1 = local_30;
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_objectForKeyedSubscript__0269d098,&cf_memberTitle);
    _objc_retainAutoreleasedReturnValue();
    uVar2 = uVar1;
    FUN_01528c84();
    _objc_retainAutoreleasedReturnValue();
