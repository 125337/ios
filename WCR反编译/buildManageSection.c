// buildManageSection @ 01e4e4b0

/* Function Stack Size: 0x10 bytes */

void WCRefineTelegramGroupingViewController::buildManageSection(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineHelper_026ce000,PTR_s_cellWithSel_target_title_rightVa_026a0a98,
             PTR_s_openTabsManager_026c67c0,local_18,&cf_R__t,&::cf___,1);
  _objc_retainAutoreleasedReturnValue();
