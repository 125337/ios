// showDocumentPickerWithType: @ 0187fce4

/* Function Stack Size: 0x18 bytes */

void WCRefineChatAttachmentBeautifyViewController::showDocumentPickerWithType_
...

{
  ...
  _objc_setAssociatedObject(local_58,"wcr_attach_type",local_50,1);
  (*(code *)PTR__objc_msgSend_02578628)
