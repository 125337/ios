// editIntervalHours @ 01d3f654

/* Function Stack Size: 0x10 bytes */

void WCRefineScheduledTaskViewController::editIntervalHours(ID param_1,SEL param_2)
  ...
  if (IVar2 != 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineScheduledTask_026ce850,PTR_s_integerInTask_forKey__026a6cc8,IVar2,
               _kWCRScheduledTaskKeyIntervalHours);
    local_38 = puVar3;
    ...
    local_70 = 0xc2000000;
    local_6c = 0;
    local_68 = FUN_01d3f854;
    local_60 = &DAT_0257c558;
    _objc_copyWeak(auStack_58,auStack_40);
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar1,PTR_s_showTextInputWithTitle_message_i_026c0570,&cf__e,&cf_kX,puVar3,2,1,
               &local_78,puVar4);
