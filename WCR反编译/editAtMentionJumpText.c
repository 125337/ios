// editAtMentionJumpText @ 018a7938

/* Function Stack Size: 0x10 bytes */

void WCRefineChatRoomFunctionViewController::editAtMentionJumpText(ID param_1,SEL param_2)
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleAtMentionJumpTextInput__026b7780);
