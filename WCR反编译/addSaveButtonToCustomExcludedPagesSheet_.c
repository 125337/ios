// addSaveButtonToCustomExcludedPagesSheet: @ 01a7eeec

/* Function Stack Size: 0x18 bytes */

void WCRefineGlobalCornerSettingsViewController::addSaveButtonToCustomExcludedPagesSheet_
...

{
  ...
  if (bVar2) {
    ...
    if (lVar3 == 0) {
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)(IVar4,PTR_s_findPageSheetProviderViewInView__026b3fa8);
      _objc_retainAutoreleasedReturnValue();
      local_70 = IVar4;
      (*(code *)PTR__objc_release_02578630)(lVar3);
      if (local_70 == 0) {
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_70,PTR_s_respondsToSelector__026ca818,PTR_s_navigationBar_0269ea30);
        if ((IVar4 & 1) != 0) {
          IVar5 = local_70;
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_70,PTR_s_performSelector__026ca7b8,PTR_s_navigationBar_0269ea30);
          _objc_retainAutoreleasedReturnValue();
          IVar4 = local_78;
          local_78 = IVar5;
        ...
        if (bVar2) {
          ...
          _objc_retainAutoreleasedReturnValue();
          local_80 = puVar6;
          (*(code *)PTR__objc_msgSend_02578628)(puVar6,PTR_s_setTitle_forState__026caab8,&cf_OX_);
          ...
          _objc_retainAutoreleasedReturnValue();
          (*(code *)PTR__objc_msgSend_02578628)
                    (puVar6,PTR_s_setTitleColor_forState__026caac0,puVar7,0);
          (*(code *)PTR__objc_release_02578630)(puVar7);
          puVar6 = local_80;
          ...
          FUN_01a7eb98();
          (*(code *)PTR__objc_msgSend_02578628)
                    (uVar13,uVar12,uVar14,uVar15,local_80,PTR_s_setContentEdgeInsets__0269ebd0);
          (*(code *)PTR__objc_msgSend_02578628)
          ...
          (*(code *)PTR__objc_msgSend_02578628)
                    (local_80,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_40,
                     PTR_s_handleCustomExcludedPagesSave__026bd708,0x40);
          ...
          puVar8 = puVar7;
          (*(code *)PTR__objc_msgSend_02578628)
                    (0xc02e000000000000,puVar7,PTR_s_constraintEqualToAnchor_constant_0269ce18);
          _objc_retainAutoreleasedReturnValue();
          puVar9 = local_80;
          local_38 = puVar8;
