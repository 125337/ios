// adjustTopbarCornerRadius @ 019204d4

/* Function Stack Size: 0x10 bytes */

void WCRefineCornerViewController::adjustTopbarCornerRadius(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleTopbarRadiusInput__026b9010);
