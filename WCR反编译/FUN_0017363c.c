// FUN_0017363c @ 0017363c

/* WARNING: Type propagation algorithm not settling */

void FUN_0017363c(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  lVar3 = local_28;
  local_40 = puVar2;
  FUN_00174c1c(local_28,&local_68);
  _objc_retainAutoreleasedReturnValue();
  ...
  if (uVar4 != 0) {
    ...
    if (((ulong)puVar2 & 1) != 0) {
      FUN_001744e4(local_28,0,local_70);
      local_80 = 1;
      goto LAB_001742e0;
    }
  }
  FUN_001749c8(uVar7,local_28,0,&cf_ck_WN_eN_);
  if (local_60 == 0) {
    local_170 = 0;
    uVar7 = local_38;
    (*(code *)PTR__objc_msgSend_02578628)
    ...
    if (((uVar7 == 0) || (local_188 == (cfstringStruct *)0x0)) ||
       ...
       ((ulong)pcVar5 & 1) == 0)) {
      FUN_00174748(local_28,0,&cf_N_1Y___N_ec);
      local_80 = 1;
    }
    else {
      pcVar5 = local_188;
      ...
      if (local_198 == (cfstringStruct *)0x0) {
        FUN_00174748(local_28,0,&cf_N_1Y_elR_N_c6RhV);
        local_80 = 1;
      }
      else {
        pcVar5 = local_198;
        ...
        local_1dc = 0x30;
        local_1d8 = FUN_00175600;
        local_1d0 = FUN_00175654;
        local_1e8 = &local_1f0;
        ...
        local_21c = 0;
        local_218 = FUN_00175a0c;
        local_210 = &DAT_0257a8a0;
    ...
    if ((local_c8 == (cfstringStruct *)0x0) ||
       ...
       ((ulong)pcVar6 & 1) == 0)) {
      FUN_00174748(local_28,0,&cf_N_1Y_elSN__thV);
      local_80 = 1;
    }
    else {
      ...
      local_fc = 0x30;
      local_f8 = FUN_00175600;
      local_f0 = FUN_00175654;
      local_108 = &local_110;
      (*(code *)PTR__objc_retain_02578638)();
      puVar2 = PTR__OBJC_CLASS___NSTimer_026ce210;
      local_e8 = uVar7;
      ...
      local_15c = 0;
      local_158 = FUN_00175680;
      local_150 = &DAT_0257a8a0;
      local_128 = &local_130;
