// wcr_reapplyAvatarFramesForAllCells @ 01af60d8

/* Function Stack Size: 0x10 bytes */

void WCRefineHomeAvatarStripView::wcr_reapplyAvatarFramesForAllCells(ID param_1,SEL param_2)
  ...
  if (local_120 != 0) {
    ...
    do {
      do {
        ...
        (*(code *)PTR__objc_msgSend_02578628)
                  (local_c0,PTR_s_forceAvatarGeometryReapplyFrame__026be610,1);
