// movePendingUp @ 0194d2d0

/* Function Stack Size: 0x10 bytes */

void WCRefineEmoticonGroupManageViewController::movePendingUp(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (puVar3,PTR_s_moveGroupId_byDelta__026a1088,IVar2,0xffffffffffffffff);
