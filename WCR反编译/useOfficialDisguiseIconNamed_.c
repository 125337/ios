// useOfficialDisguiseIconNamed: @ 01cbbbc4

/* Function Stack Size: 0x18 bytes */

void WCRefinePrivateFriendViewController::useOfficialDisguiseIconNamed_
...

{
  ...
  if (((ulong)puVar2 & 1) == 0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___NSString_026cdfe8,PTR_s_stringWithFormat__0269cca8,&cf__g_b0R_);
    _objc_retainAutoreleasedReturnValue();
