// setRepeatChatSinkEnabled: @ 0201e3cc

/* Function Stack Size: 0x14 bytes */

void WCRefineConfig::setRepeatChatSinkEnabled_(ID param_1,SEL param_2,bool param_3)

{
  ...
  if ((local_21 & 1) != 0) {
    ...
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)
              (IVar1,PTR_s_setObject_forKey__026ca9e8,puVar2,&cf_repeatChatLiftEnabled);
    (*(code *)PTR__objc_release_02578630)(puVar2);
  }
