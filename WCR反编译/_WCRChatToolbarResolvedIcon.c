// _WCRChatToolbarResolvedIcon @ 00ef37b8

void _WCRChatToolbarResolvedIcon(undefined8 param_1,undefined8 param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_20,PTR_s_objectForKeyedSubscript__0269d098,&cf__wcrCustomIcon);
  ...
  if (pcVar2 == (cfstringStruct *)0x0) {
    ...
    if ((local_74 & 1) == 0) {
      ...
      uVar4 = local_28;
      FUN_00ef51a0();
      local_18 = &cf_icons_filled_video_phone;
      if ((uVar4 & 1) == 0) {
        local_18 = &cf_icons_filled_videocall;
      }
