// showRadiusSettings: @ 01c631e8

/* WARNING: Type propagation algorithm not settling */
/* Function Stack Size: 0x18 bytes */

void __thiscall
WCRefineNavigationAvatarViewController::showRadiusSettings_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_avatarRadius_026c1f88);
  in_d0 = in_d0 * 100.0;
  ...
  local_48 = 0xc2000000;
  local_44 = 0;
  local_40 = FUN_01c63368;
  local_38 = &DAT_025872d8;
  (*(code *)PTR__objc_retain_02578638)();
  local_30[0] = IVar2;
  (*(code *)PTR__objc_msgSend_02578628)
            (IVar1,PTR_s_showInputAlertWithTitle_message__026c24d8,&cf_4YPW,&cf_eQWz_,puVar3,
