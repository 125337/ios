// clearSvgRandomPaletteColors @ 01f377dc

/* Function Stack Size: 0x10 bytes */

void WCRefineUIBeautifyViewController::clearSvgRandomPaletteColors(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf__nzzr_g);
  return;
}
