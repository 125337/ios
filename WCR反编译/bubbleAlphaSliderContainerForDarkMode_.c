// bubbleAlphaSliderContainerForDarkMode: @ 01f2f510

/* WARNING: Removing unreachable block (ram,0x01f2fc08) */
/* Function Stack Size: 0x14 bytes */

ID __thiscall
WCRefineUIBeautifyViewController::bubbleAlphaSliderContainerForDarkMode_
          (WCRefineUIBeautifyViewController *this,ID param_1,SEL param_2,bool param_3)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(0x42c80000,local_90,PTR_s_setMaximumValue__026b2340);
  (*(code *)PTR__objc_msgSend_02578628)((float)(local_40 * 100.0),local_90,PTR_s_setValue__026a51b0)
  ;
  (*(code *)PTR__objc_msgSend_02578628)(local_90,PTR_s_setContinuous__026b4d68,0);
  uVar3 = 0xe00d0;
  if ((local_31 & 1) == 0) {
    uVar3 = 0xe00cf;
  }
  puVar1 = local_90;
  (*(code *)PTR__objc_msgSend_02578628)(local_90,PTR_s_setTag__026caa80,uVar3);
  FUN_01f2e7c4();
  _objc_retainAutoreleasedReturnValue();
  ...
  _objc_retainAutoreleasedReturnValue();
  local_b8 = puVar1;
  (*(code *)PTR__objc_msgSend_02578628)(local_90,PTR_s_setThumbImage_forState__026b4d78,puVar1,0);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_90,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_bubbleAlphaSliderChanged__026c87f0,0x1000);
  ...
  local_c0 = puVar1;
  FUN_01f2e778();
  (*(code *)PTR__objc_msgSend_02578628)(uVar3,uVar4,uVar5,uVar6,local_c0,PTR_s_setFrame__026ca960);
  uVar3 = 0xe00d2;
  if ((local_31 & 1) == 0) {
    uVar3 = 0xe00d1;
  }
  (*(code *)PTR__objc_msgSend_02578628)(local_c0,PTR_s_setTag__026caa80,uVar3);
  puVar1 = local_c0;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_c0,PTR_s_addTarget_action_forControlEvent_026ca4c8,local_28,
             PTR_s_bubbleAlphaValueButtonTapped__026c87f8,0x40);
