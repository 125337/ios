// appendScreenRecordingFrameProcessedId: @ 020fc1f0

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::appendScreenRecordingFrameProcessedId_(ID param_1,SEL param_2,ID param_3)

{
  ...
  if (lVar1 == 0) {
    ...
    puVar2 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_screenRecordingFrameProcessedIds_026a6f88);
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_18,PTR_s_setScreenRecordingFrameProcessed_026ca380,local_38);
