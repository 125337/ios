// FUN_0172c424 @ 0172c424

void FUN_0172c424(undefined8 param_1,long param_2)

{
  ...
  if (((uVar2 & 1) != 0) &&
    ...
    _objc_storeStrong(&local_190,local_240);
  ...
  if (((uVar2 & 1) == 0) ||
    ...
    if (local_198 == 0) {
      ...
      if (((ulong)pcVar3 & 1) == 0) goto LAB_0172c870;
      pcVar3 = local_1a0;
      (*(code *)PTR__objc_msgSend_02578628)
      ...
      (*(code *)PTR__objc_release_02578630)(pcVar3);
      if ((local_2e0 == (cfstringStruct *)section_000000b8.segname) ||
         (pcVar3 = local_1b8,
         (*(code *)PTR__objc_msgSend_02578628)(local_1b8,PTR_s_containsString__0269d0b0,&cf_01xDD),
         ((ulong)pcVar3 & 1) != 0)) {
        local_a8 = &cf_success;
        puVar1 = PTR__OBJC_CLASS___NSNumber_026ce038;
        (*(code *)PTR__objc_msgSend_02578628)
        ...
        pcVar3 = local_1b8;
        (*(code *)PTR__objc_msgSend_02578628)(local_1b8,PTR_s_containsString__0269d0b0,&cf_01xDA);
        if (((ulong)pcVar3 & 1) == 0) {
          pcVar3 = local_1b8;
          (*(code *)PTR__objc_msgSend_02578628)(local_1b8,PTR_s_containsString__0269d0b0,&cf_01xDC);
          if (((ulong)pcVar3 & 1) == 0) {
            pcVar3 = local_1b8;
            (*(code *)PTR__objc_msgSend_02578628)
                      (local_1b8,PTR_s_containsString__0269d0b0,&cf_01xDE);
            if (((ulong)pcVar3 & 1) == 0) {
              pcVar3 = local_1b8;
              (*(code *)PTR__objc_msgSend_02578628)
                        (local_1b8,PTR_s_containsString__0269d0b0,&cf_01xDF);
              if (((ulong)pcVar3 & 1) == 0) {
                pcVar3 = local_1b8;
                (*(code *)PTR__objc_msgSend_02578628)
                          (local_1b8,PTR_s_containsString__0269d0b0,&cf_01xDB);
                if (((ulong)pcVar3 & 1) == 0) {
...
LAB_0172c870:
      ...
      local_78 = puVar1;
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR__OBJC_CLASS___NSString_026cdfe8,PTR_s_stringWithFormat__0269cca8,&cf_T_N_fgHev)
      ;
      _objc_retainAutoreleasedReturnValue();
      puVar4 = PTR__OBJC_CLASS___NSDictionary_026ce090;
      local_70 = puVar6;
