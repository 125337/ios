// wcr_clipDelete: @ 0094fd40

/* WARNING: Type propagation algorithm not settling */
/* Function Stack Size: 0x18 bytes */

void WCRClipboardHistoryPanelController::wcr_clipDelete_(ID param_1,SEL param_2,ID param_3)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  local_38 = IVar2;
  (*(code *)PTR__objc_msgSend_02578628)(IVar2,PTR_s_isEqualToString__0269ccc8,&cf___current__);
  bVar1 = (IVar2 & 1) == 0;
  if (bVar1) {
    local_58 = PTR_WCRClipboardHistoryStore_026ce680;
    ...
    local_48 = PTR_WCRClipboardHistoryStore_026ce680;
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRClipboardHistoryStore_026ce680,PTR_s_shared_0269cad0);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)();
  ...
  if (local_60 == 0) {
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR_WCRefineHelper_026ce000,PTR_s_showModernToast__0269ce78,&cf_HQSm6e);
  }
