// FUN_006d4df8 @ 006d4df8

void FUN_006d4df8(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((lVar2 == 0) ||
    ...
    if (local_28 != 0) {
      _NSLog(&cf__wcr__ai_redpacketreplyerror___);
    }
  }
  else {
    ...
    (*(code *)PTR__objc_msgSend_02578628)(uVar4,PTR_s_sessionUserName_026a6a48);
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)
