// FUN_01673618 @ 01673618

void FUN_01673618(void)

{
  ...
  if (puVar2 != (undefined *)0x0) {
    ...
    if (local_d0 != 0) goto LAB_01673ae0;
  }
        ...
        if ((puVar5 != (undefined *)0x0) && (puVar5 != DAT_028e3c70)) {
          ...
          if (((ulong)puVar3 & 1) == 0) {
            ...
            while( true ) {
              puVar3 = local_128;
              (*(code *)PTR__objc_msgSend_02578628)
                        (local_128,PTR_s_presentedViewController_0269d448);
              _objc_retainAutoreleasedReturnValue();
            ...
            if (local_d0 != 0) goto LAB_01673aa0;
          }
        }
