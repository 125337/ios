// WCRefineToDo_insertSessionCellAtIndexes:scrollToCell: @ 007fa40c

/* WARNING: Removing unreachable block (ram,0x007fa6c4) */
/* WARNING: Removing unreachable block (ram,0x007fa6a4) */
/* Function Stack Size: 0x1c bytes */

void WCRefineToDoHook::WCRefineToDo_insertSessionCellAtIndexes_scrollToCell_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_18,PTR_s_WCRefineToDo_insertSessionCellAt_026a8638,local_28,local_29 & 1);
  if ((IVar1 & 1) != 0) {
    IVar1 = local_18;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_respondsToSelector__026ca818,pcVar3);
    if ((IVar1 & 1) != 0) {
    ...
    FUN_007fa220(local_50,uStack_48,local_18,local_38);
  }
