// adjustOffsetY @ 018820d4

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAttachmentBeautifyViewController::adjustOffsetY(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgOffsetYLight_0269f5b8);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgOffsetYDark_0269f5b0);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleOffsetYInput__026b6fa0);
