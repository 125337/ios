// handleMsgBannerPickedVideoWithInfo:imageType: @ 01b98ae8

/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Function Stack Size: 0x20 bytes */

void WCRefineMessageBannerBeautifyViewController::handleMsgBannerPickedVideoWithInfo_imageType_
...

{
  ...
  if ((local_d0 == 0) ||
    ...
    if (bVar1) {
      ...
      (*(code *)PTR__objc_msgSend_02578628)
                (local_b0,PTR_s_copyMsgBannerBackgroundImageFrom_026c0118,local_1b8,local_c8);
    }
    ...
    if (local_200 != (undefined *)0x0) {
      ...
      do {
        do {
          ...
          uVar11 = *(ulong *)(local_128 + (long)local_208 * 8);
          local_f0 = uVar11;
          ...
          if (local_13c != 3) goto LAB_01b98e78;
...
LAB_01b98e78:
    ...
    if (local_e0 == (cfstringStruct *)0x0) {
      ...
      if (lVar10 == 0) {
        ...
        _objc_storeStrong(&local_e8,local_248);
      ...
      _objc_retainAutoreleasedReturnValue();
      (*(code *)PTR__objc_msgSend_02578628)
                (puVar3,PTR_s_stringWithFormat__0269cca8,&cf_wcr_msgbanner_________);
      _objc_retainAutoreleasedReturnValue();
      local_148 = puVar3;
      ...
      puVar3 = PTR__OBJC_CLASS___NSURL_026ce328;
      (*(code *)PTR__objc_msgSend_02578628)
                (PTR__OBJC_CLASS___NSURL_026ce328,PTR_s_fileURLWithPath__0269f540,local_150);
      _objc_retainAutoreleasedReturnValue();
      ...
      _objc_initWeak(auStack_168,local_b0);
      ...
      local_1a4 = 0;
      local_1a0 = FUN_01b99988;
      local_198 = &DAT_02589c78;
