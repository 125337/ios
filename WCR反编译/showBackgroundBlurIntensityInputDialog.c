// showBackgroundBlurIntensityInputDialog @ 01a3522c

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::showBackgroundBlurIntensityInputDialog
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleBackgroundBlurIntensityInp_026bc3e8);
    (*(code *)PTR__objc_msgSend_02578628)(local_30,PTR_s_showTextFieldWithMaxLen__0269e5e0,3);
    pcVar1 = local_30;
    puVar2 = PTR__OBJC_CLASS___NSString_026cdfe8;
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_getBackgroundBlurIntensity_026bbba0);
