// FUN_00ee9250 @ 00ee9250

void FUN_00ee9250(undefined8 param_1)
    ...
    if (local_150 != 0) {
      ...
      do {
        do {
          ...
          uVar3 = local_118;
          (*(code *)PTR__objc_msgSend_02578628)(local_118,PTR_s_lowercaseString_0269d9c0);
          _objc_retainAutoreleasedReturnValue();
          uVar5 = local_118;
          local_120 = uVar3;
          ...
          if ((uVar5 == 0) ||
             ((uVar3 = local_120,
              (*(code *)PTR__objc_msgSend_02578628)
                        (local_120,PTR_s_hasSuffix__0269d018,&cf__chatroom), (uVar3 & 1) == 0 &&
              (uVar3 = local_120,
              (*(code *)PTR__objc_msgSend_02578628)
                        (local_120,PTR_s_hasSuffix__0269d018,&cf__im_chatroom), (uVar3 & 1) == 0))))
          {
            local_bc = 3;
          }
          else {
