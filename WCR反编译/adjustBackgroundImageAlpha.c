// adjustBackgroundImageAlpha @ 01896414

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAvatarProfileCardViewController::adjustBackgroundImageAlpha(ID param_1,SEL param_2)

{
  ...
  _objc_retainAutoreleasedReturnValue();
  (*(code *)PTR__objc_msgSend_02578628)();
  (*(code *)PTR__objc_msgSend_02578628)(puVar4,PTR_s_stringWithFormat__0269cca8,&cf___2f___2f);
  _objc_retainAutoreleasedReturnValue();
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleBackgroundImageAlphaInput__026b73a8);
