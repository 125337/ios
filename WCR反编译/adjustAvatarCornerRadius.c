// adjustAvatarCornerRadius @ 018968cc

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAvatarProfileCardViewController::adjustAvatarCornerRadius(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)();
  local_28 = pcVar1;
  (*(code *)PTR__objc_msgSend_02578628)(pcVar1,PTR_s_showTextFieldWithMaxLen__0269e5e0,3);
  pcVar1 = local_28;
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_28,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleAvatarCornerRadiusInput__026b6280);
