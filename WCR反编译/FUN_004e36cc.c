// FUN_004e36cc @ 004e36cc

byte FUN_004e36cc(undefined8 param_1,long param_2)

{
  ...
  if ((local_30 == 0) || (param_2 == 0)) {
    ...
    local_60 = 0;
    uVar3 = local_30;
    FUN_004e67b4(local_30,param_2,&local_58,&local_60,local_3d);
