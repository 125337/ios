// FUN_003feda4 @ 003feda4

void FUN_003feda4(undefined8 param_1)
    ...
    if (local_168 != 0) {
      ...
      do {
        do {
          ...
          local_d8 = uVar4;
          (*(code *)PTR__objc_msgSend_02578628)(uVar4,PTR_s_customView_0269ea28);
          _objc_retainAutoreleasedReturnValue();
          ...
          if (((uVar4 & 1) == 0) ||
             (uVar4 = local_120, (*(code *)PTR__objc_msgSend_02578628)(local_120,PTR_s_tag_026cab98)
             , uVar4 != 0x57435249)) {
