// adjustScale @ 01882448

/* Function Stack Size: 0x10 bytes */

void WCRefineChatAttachmentBeautifyViewController::adjustScale(ID param_1,SEL param_2)

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgScaleLight_0269f598);
  (*(code *)PTR__objc_msgSend_02578628)(local_28,PTR_s_msgAttachmentBgScaleDark_0269f590);
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (local_30,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
             PTR_s_handleScaleInput__026b6fb8);
