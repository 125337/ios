// setMessageNoRevokeDateFormat @ 01a71938

/* Function Stack Size: 0x10 bytes */

void WCRefineGeneralFunctionViewController::setMessageNoRevokeDateFormat(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    if (pcVar3 == (cfstringStruct *)0x0) {
      local_50 = &cf_yyyy_MM_ddHH_mm_ss;
    }
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_handleMessageNoRevokeDateFormatI_026bd3e8);
    (*(code *)PTR__objc_msgSend_02578628)(local_38,PTR_s_showTextFieldWithMaxLen__0269e5e0,0x32);
