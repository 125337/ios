// groupIdsContainingMember: @ 01ad8728

/* Function Stack Size: 0x18 bytes */

ID WCRefineGroupManager::groupIdsContainingMember_(ID param_1,SEL param_2,ID param_3)
    ...
    if (local_158 != 0) {
      ...
      do {
        do {
          ...
          lVar5 = *(long *)(local_118 + local_160 * 8);
          local_e0 = lVar5;
          (*(code *)PTR__objc_msgSend_02578628)(lVar5,PTR_s_kind_026a27e8);
          local_17c = 0;
          if (lVar5 == 0) {
            lVar5 = local_e0;
            (*(code *)PTR__objc_msgSend_02578628)(local_e0,PTR_s_members_0269ea98);
            _objc_retainAutoreleasedReturnValue();
            lVar3 = lVar5;
            (*(code *)PTR__objc_msgSend_02578628)();
            local_17c = (uint)lVar3;
