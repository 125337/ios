// setHomeAvatarStripBackgroundMediaScaleDark: @ 02162884

/* Function Stack Size: 0x18 bytes */

void WCRefineConfig::setHomeAvatarStripBackgroundMediaScaleDark_
...

{
  ...
  (*(code *)PTR__objc_msgSend_02578628)
            (param_1,PTR_s_setObject_forKey__026ca9e8,puVar1,
             &cf_homeAvatarStripBackgroundMediaScaleDark);
