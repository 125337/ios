// autoDownloadHistoryMaxAgeDays @ 01fd37a0

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::autoDownloadHistoryMaxAgeDays(ID param_1,SEL param_2)

{
  ...
  if ((long)local_38 < 1) {
    ...
    _cmdString();
    _objc_retainAutoreleasedReturnValue();
    (*(code *)PTR__objc_msgSend_02578628)(pdVar1,PTR_s_setObject_forKey__026ca9e8,puVar4);
    (*(code *)PTR__objc_release_02578630)(SVar2);
    (*(code *)PTR__objc_release_02578630)(puVar4);
    (*(code *)PTR__objc_msgSend_02578628)(local_18,PTR_s_class_0269cd60);
    (*(code *)PTR__objc_msgSend_02578628)();
  }
  else if (0x2d0 < (long)local_38) {
    local_38 = &section_00000298.reloff;
    puVar4 = PTR__OBJC_CLASS___NSNumber_026ce038;
    (*(code *)PTR__objc_msgSend_02578628)
              (PTR__OBJC_CLASS___NSNumber_026ce038,PTR_s_numberWithInteger__0269e080,0x2d0);
    _objc_retainAutoreleasedReturnValue();
    SVar2 = local_20;
    _cmdString();
    _objc_retainAutoreleasedReturnValue();
