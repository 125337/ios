// FUN_006c1dbc @ 006c1dbc

void FUN_006c1dbc(undefined8 param_1)

{
  ...
  if (local_40 == 0) {
    ...
    local_30[0] = PTR_s_referHostMsg_026a6928;
    local_30[1] = PTR_s_referingMessageWrap_0269d110;
    local_30[2] = PTR_s_replyingMessageWrap_0269d380;
    for (local_50 = 0; local_50 < 3; local_50 = local_50 + 1) {
      ...
      if ((uVar1 & 1) != 0) {
        ...
        if (local_44 != 0) goto LAB_006c1f98;
      }
    }
    local_38 = 0;
    local_44 = 1;
