// chatTopBarMoreButtonLongPressAction @ 02006c50

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::chatTopBarMoreButtonLongPressAction(ID param_1,SEL param_2)

{
  ...
  puVar3 = local_28;
  if (((long)local_48 < 0) || (7 < (long)local_48)) {
