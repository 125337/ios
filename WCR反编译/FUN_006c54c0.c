// FUN_006c54c0 @ 006c54c0

byte FUN_006c54c0(undefined8 param_1,ulong *param_2,ulong *param_3)

{
  ...
  pcVar5 = local_68;
  if (local_138 < (cfstringStruct *)0x6) {
    ...
    if (puVar2 == (undefined1 *)0x0) {
      ...
      if ((pcVar5 == (cfstringStruct *)0x0) ||
         ...
         pcVar5 = local_a0, pcVar3 == (cfstringStruct *)0x0)) {
        pcVar5 = local_68;
        if (local_58 != (ulong *)0x0) {
          _objc_retainAutorelease();
          *local_58 = (ulong)pcVar5;
