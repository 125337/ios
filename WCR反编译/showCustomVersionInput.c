// showCustomVersionInput @ 01ca60a8

/* Function Stack Size: 0x10 bytes */

void WCRefinePluginManagementViewController::showCustomVersionInput(ID param_1,SEL param_2)

{
  ...
  if (pcVar1 != (char *)0x0) {
    ...
    if (pcVar2 == (cfstringStruct *)0x0) {
      ...
      _objc_storeStrong(&local_30,local_70);
      (*(code *)PTR__objc_release_02578630)(pcVar3);
      (*(code *)PTR__objc_release_02578630)(pcVar2);
    }
    pcVar1 = local_28;
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_38,PTR_s_addBtnTitle_target_sel__0269d278,&cf_nx_,local_18,
               PTR_s_customVersionConfirm__026c2e70);
