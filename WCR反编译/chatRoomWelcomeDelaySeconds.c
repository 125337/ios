// chatRoomWelcomeDelaySeconds @ 02086eb8

/* Function Stack Size: 0x10 bytes */

long_long WCRefineConfig::chatRoomWelcomeDelaySeconds(ID param_1,SEL param_2)

{
  ...
  if ((long)local_78 < 2) {
    local_78 = (undefined *)((long)&MACH_HEADER.magic + 1);
  }
