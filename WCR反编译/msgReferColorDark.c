// msgReferColorDark @ 020da190

/* Function Stack Size: 0x10 bytes */

ID WCRefineConfig::msgReferColorDark(ID param_1,SEL param_2)

{
  ...
  if (local_38 == 0) {
    ...
    _objc_retainAutoreleasedReturnValue();
    local_40 = puVar2;
    (*(code *)PTR__objc_msgSend_02578628)(local_20,PTR_s_setMsgReferColorDark__026b9208,puVar2);
    puVar2 = local_40;
