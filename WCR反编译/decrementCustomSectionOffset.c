// decrementCustomSectionOffset @ 01ec7734

/* Function Stack Size: 0x10 bytes */

void WCRefineToDoListSettingsViewController::decrementCustomSectionOffset(ID param_1,SEL param_2)

{
  ...
  if ((long)puVar1 < -4) {
    ...
    (*(code *)PTR__objc_msgSend_02578628)
              (local_28,PTR_s_setToDoCardCustomSectionOffset__026c7af0,puVar1 + -1);
